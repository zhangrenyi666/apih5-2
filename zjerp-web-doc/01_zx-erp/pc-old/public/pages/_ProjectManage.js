...
window._ProjectManage = {
    fetchConfig: {
        ...
        otherParams: (obj) => { 
            let { departmentId = '' } = obj.loginAndLogoutInfo.loginInfo.userInfo.curCompany;
            return {
    ...
    actionBtns: [
        ...
        {
            //willExecute:()=>void //点击前
            name: 'edit',//【add, addRow,  del, edit, detail, Component, form】
            icon: 'edit',
            type: 'primary',
            label: '修改',
            drawerTitle: '修改',
        ...
        },
        {
            ...
            icon: 'delete',
            fetchConfig: {//ajax配置
                apiName: 'batchDeleteUpdateSysProjectByRelation',
            },
            type: 'danger',
            label: '删除',
        },
        ...
        },
        {
            ...
            form: {
                ...
                treeSelectOption: {
                    ...
                    selectType: "1",
                    //配置参照oa拉人组件配置
                    fetchConfig: { apiName: 'getSysDepartmentCurrentTreeAll', otherParams: {}, paramsKey: 'departmentParentId' },
                },
                condition: [
                    {
                        regex: {
