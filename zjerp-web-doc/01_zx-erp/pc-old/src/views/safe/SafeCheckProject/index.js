            ...
            },
            {
              ...
              onClick: (obj) => {
                ...
                if (obj.selectedRows[0].isReported === '3' || (obj.selectedRows[0].isSend === '1' || obj.selectedRows[0].isSend === '2')) {
                  ...
                  if (obj.selectedRows[0].checkAgainStatus) {//项目自己建立的数据-复查后不可以修改
                    Msg.warn('请选择未复查的数据！');
                    this.table.closeDrawer();
                  } else {
            ...
            },
            {
              ...
              formBtns: [
                ...
                },
                {
                  ...
                  label: '保存',
                  fetchConfig: {
                    apiName: 'updateZxSfCheckCheckAgainStatus'
                  }
                }
              ]
            },
            {
              ...
              onClick: (obj) => {
                ...
                if (obj.selectedRows.length === 1) {
                  if (obj.selectedRows[0].isSend === '1' || obj.selectedRows[0].isSend === '2') {
                    if (obj.selectedRows[0].checkAgainStatus === '3') {
                      confirm({
                        content: '确定上报选中的数据吗?',
                        onOk: () => {
                          myFetch('updateZxSfCheckIsReported', obj.selectedRows[0]).then(
                            ({ data, success, message }) => {
                              if (success) {
                                Msg.success(message)
                                this.table.refresh();
