...
class operation extends Component {
    ...
    componentDidMount() {
        ...
        if (workId) {
            this.props.myFetch(apiName, { apiName: 'getZxEqEquipLimitPriceDetails', apiType: 'POST', flowId: 'zxEqEquipLimitPrice', title: title, workId: workId }).then(({ success, message, data }) => {
                if (success) {
                    this.setState({
