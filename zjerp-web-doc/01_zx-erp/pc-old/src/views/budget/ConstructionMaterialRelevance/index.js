                ...
                <Spin spinning={loading}>
                                    ...
                                    formConfig={[
                                        {
                                            ...
                                            onChange: (val, rowData) => {
                                                ...
                                                // console.log(this.tableWZForm)
                                                this.props.myFetch('getZxBuStockPriceItemResAll', {orgID: val}).then(
                                                    ({ data, success, message }) => {
                                                        console.log(data)
                                                        if (success) {
                                                            this.tableWZForm.form.setFieldsValue({
                                                                qnntableWZ: data
                                                            })
                                                        } else {
                                                            Msg.error(message)
                    ...
                    <div>
                        <Row>
                            ...
                            <Col span={12} style={{ paddingLeft: '10px'}} className={'qnnTableWZ'}>
                                {
                                    <QnnForm
                                        fetch={this.props.myFetch}
                                        upload={this.props.myUpload}
