...
class index extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            budgetBookID: props.match.params.zxBuBudgetBookId,
            projectName: ''
        }
    }
                                    ...
                                    render: (val,rowData) => {
                                            ...
                                            || rowData.budgetElement === '标后预算切块比例(%)')
                                        {
                                            ...
                                            return <a onClick ={(obj) => {
                                                ...
                                                this.props.dispatch(
                                                    push(`${mainModule}AfterBudgetingProjectCost/${orgID}/${zxBuBudgetBookId}`)
                                                )
                                            }}>编辑</a>;
                                            ...
                                            return <a onClick ={(obj) => {
                                                ...
                                                const zxBuBudgetBookId = budgetBookID;
                                                this.props.dispatch(
                                                    push(`${mainModule}AfterBudgetingSiteCost/${orgID}/${zxBuBudgetBookId}`)
                                                )
                                            }}>编辑</a>;
                                            ...
                                            return <a onClick ={(obj) => {
                                                ...
                                                const zxBuBudgetBookId = budgetBookID;
                                                this.props.dispatch(
                                                    push(`${mainModule}AfterBudgetingFacilityCost/${orgID}/${zxBuBudgetBookId}`)
                                                )
                                            }}>编辑</a>;
                                            ...
                                            return <a onClick ={(obj) => {
                                                ...
                                                const zxBuBudgetBookId = budgetBookID;
                                                this.props.dispatch(
                                                    push(`${mainModule}AfterBudgetingIntendanceCost/${orgID}/${zxBuBudgetBookId}`)
                                                )
                                            }}>编辑</a>;
