...
class index extends Component {
  render() {
    console.log(this.props.props.qnnFormProps.form.getFieldsValue());
    return (
      <div style={{ padding: '10px', overflow: 'hidden' }}>
        <QnnTable
          fetch={this.props.fetch}
          upload={this.props.upload}
          headers={{ token: this.props.headers.token }}
          ...
          fetchConfig={{
            ...
            otherParams: {
              ...
              comID: this.props.props.qnnFormProps.form.getFieldValue('comID')
            }
          }}
          formConfig={[
            {
