...
let config = {
    ...
    workFlowConfig: {
        ...
        apiNameByAdd: "updateZxCtOtherSupplyAgreement",
                ...
                <Form
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            ...
                            type: 'number',
                            qnnDisabled: true,
                            initialValue: flowData?.applyAmount,
                            span: 12,
                            formItemLayout: {
                                labelCol: {
                                    xs: { span: 9 },
                        ...
                        },
                        {
                            ...
                            type: 'number',
                            qnnDisabled: true,
                            initialValue: flowData?.applyAmountNoTax,
                            span: 12,
                            formItemLayout: {
                                labelCol: {
                                    xs: { span: 9 },
                        ...
                        },
                        {
                            ...
                            type: 'number',
                            qnnDisabled: true,
                            initialValue: flowData?.applyAmountTax,
                            span: 12,
                            formItemLayout: {
                                labelCol: {
                                    xs: { span: 9 },
                        ...
                        },
                        {
                            ...
                            qnnTableConfig: {
                                fetchConfig: (obj) => {
                                    if (flowData?.zxCtOtherSupplyAgreementId) {
                                        return {
                                    ...
                                    } else if (obj?.qnnFormProps?.qnnformData?.initialValues?.apiBody?.zxCtOtherSupplyAgreementId) {
                                        return {
                                            apiName: 'getZxCtOtherSupplyAgreementWorksList',
                                            otherParams: {
                                                zxCtOtherSupplyAgreementId: obj.qnnFormProps.qnnformData.initialValues.apiBody.zxCtOtherSupplyAgreementId,
                                            }
                                        }
                                    }
