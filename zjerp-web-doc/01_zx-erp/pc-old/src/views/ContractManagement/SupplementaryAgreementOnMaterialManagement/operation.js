...
class operation extends Component {
    ...
    componentDidMount() {
        ...
        if (workId) {
            this.props.myFetch(apiName, { apiName: 'getZxCtSuppliesContrReplenishFlowDetail', apiType: 'POST', flowId: 'ZxCtSuppliesContrReplenish', title: title, workId: workId }).then(({ success, message, data }) => {
                if (success) {
                    this.setState({
