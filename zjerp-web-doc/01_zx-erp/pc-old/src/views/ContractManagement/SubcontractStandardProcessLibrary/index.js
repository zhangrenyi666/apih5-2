...
class index extends Component {
    ...
    refresh = () => {
        ...
        this.props.myFetch('getZxCtContrProcessTree', {}).then(
                ...
                <div className={s.root}>
                    ...
                    <div className={s.rootr}>
                        {parentID ? <QnnTable
                            ...
                            fetchConfig={{
                                apiName:'getZxCtContrProcessItemList',
                                otherParams:{
                                    treeNode:parentID
                                }
                            }}
                                ...
                                },
                                {
                                    ...
                                    formBtns: [
                                        ...
                                        },
                                        {
                                            ...
                                            label: '保存',//提交数据并且关闭右边抽屉 
                                            fetchConfig: {//ajax配置
                                                apiName: 'updateZxCtContrProcess',
                                            },
                                            onClick: (obj) => {
                                ...
                                // },
                                {
                                    ...
                                    onClick: (obj) => {
                                        confirm({
                                            content: '确定删除此数据吗?',
                                            onOk: () => {
                                                this.props.myFetch('batchDeleteUpdateZxCtContrProcess', obj.selectedRows).then(({ success, message, data }) => {
                                                    if (success) {
                                                        this.setState({
                                                            treeData: null
                                                        }, () => {
