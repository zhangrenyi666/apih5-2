...
const pageComs = {
    ...
    StockTransferRpt: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/StockTransferRpt"))
    },
    TurnResAmoItem: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/TurnResAmoItem"))
    },
    WornOutList: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/WornOutList"))
    },
    // TurnWriteOff:{
    //     mustLogin: true,
    ...
    QuarterlyCreditEvaluationJu: {
        mustLogin: true,
        Com: lazy(() => import("./CreditEvaluation/QuarterlyCreditEvaluationJu/indexTwo"))
    },
    HighwayEngine: {
        mustLogin: true,
    ...
    MonthlyProjectVarianceReport: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/MonthlyProjectVarianceReport"))
    },
    ...
    SeasonProjectVarianceReport: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/SeasonProjectVarianceReport"))
    },
    MainMaterReport: {
        mustLogin: true,
    ...
    MaterStockTransferRptNewReport: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/MaterStockTransferRptNewReport"))
    },
    ...
    MaterContractContrastRptReport: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/MaterContractContrastRptReport"))
    },
    MaterUseReport: {
        mustLogin: true,
    ...
    // },
    MaterTurnoverTotalRptReport: {
        mustLogin: true,
        Com: lazy(() => import("./MaterialsManagement/aReport/MaterTurnoverTotalRptReport"))
    },
    MaterRuKuReport: {
        mustLogin: true,
...
const routerInfo = [
    ...
    //                         {
    //                             label: "项目月度量差表",
    //                             defaultPath: "MonthlyProjectVarianceReport",
    //                             pathName: "MonthlyProjectVarianceReport",
    //                             comKey: "MonthlyProjectVarianceReport"
    //                         },
    //                         {
    //                             label: "项目季度量差表",
    //                             defaultPath: "SeasonProjectVarianceReport",
    //                             pathName: "SeasonProjectVarianceReport",
    //                             comKey: "SeasonProjectVarianceReport"
    //                         },
