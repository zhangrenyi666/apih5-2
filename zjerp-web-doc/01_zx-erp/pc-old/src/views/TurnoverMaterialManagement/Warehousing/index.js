                                                    ...
                                                    if (colVal >= 0) {
                                                        ...
                                                        this.tdEditedTimer = setTimeout(async () => {
                                                            ...
                                                            if (rowData.inPriceNoTax) {//购入单价
                                                                newRowData.inPriceTax = Number(this.FloatMulTwo(rowData.inPriceNoTax, shuilv).toFixed(2)); // 购入单价税额
                                                                newRowData.inPrice = Number(rowData.inPriceNoTax + newRowData.inPriceTax);// 购入单价合计
