        ...
        <QnnTable
          ...
          actionBtns={[
              ...
              formBtns: [
                ...
                },
                {
                  ...
                  onClick: (val) => {
                    ...
                    myFetch('addZxCtContrDqjz', val._formData).then(
              ...
              formBtns: [
                ...
                },
                {
                  ...
                  onClick: (val) => {
                    ...
                    myFetch('updateZxCtContrDqjz', val._formData).then(
                      ({ success, message }) => {
                        if (success) {
            ...
            },
            {
              ...
              fetchConfig: {
                apiName: 'batchDeleteUpdateZxCtContrDqjz',
              },
            },
            {
              Component: "CurrentBuildForm",
