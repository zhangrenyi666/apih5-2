      ...
      <div style={{ padding: '10px' }}>
        <QnnForm
          ...
          fetchConfig={{
            ...
            otherParams: { zxSaFsSettlementId: flowData?.zxSaFsSettlementId }
          }}
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算单吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:zxFsSellementDetail.ureport.xml&url=${domain}&zxSaFsSettlementId=${flowData?.zxSaFsSettlementId}`);
                        }
                      })
                    }}
                  >{flowData?.billNo} - 附属类结算单</p>
                </div>
              },
              span: 24,
            },
