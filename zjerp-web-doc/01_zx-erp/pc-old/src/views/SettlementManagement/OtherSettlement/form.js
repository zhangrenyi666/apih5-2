        ...
        <Form
          ...
          formConfig={[
            ...
            },
            {
              ...
              type: 'string',
              initialValue: flowData?.zxSaOtherEquipSettleId,
              hide: true,
            },
            {
            ...
            },
            {
              ...
              Component: obj => {
                ...
                if (flowData?.zxSaOtherEquipSettleId) {
                  ...
                  zxSaOtherEquipSettleId = obj.qnnFormInitialValues.apiBody.zxSaOtherEquipSettleId
                }
                return <div
                  style={{
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算单吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:zxSaOtherEquipSettleList.xml&url=${domain}&zxSaOtherEquipSettleId=${zxSaOtherEquipSettleId}`);
                        }
                      })
                    }}
                  >{billNo} - 其他类结算单</p>
            ...
            },
            {
              ...
              qnnTableConfig: {
                fetchConfig: (obj) => {
                  ...
                  } else if (obj?.qnnFormProps?.qnnformData?.initialValues?.apiBody?.zxSaOtherEquipSettleId) {
                    return {
                      apiName: 'getZxSaOtherEquipSettleItemList',
                      otherParams: {
                        zxSaOtherEquipSettleId: obj.qnnFormProps.qnnformData.initialValues.apiBody.zxSaOtherEquipSettleId
                      }
                    }
                  }
                },
