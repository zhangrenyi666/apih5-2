                ...
                actionBtns: [
                  {
                    ...
                    onClick: () => {
                      confirm({
                        content: '确定导出数据吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:zxSaOtherEquipSettleList_ygz.xml&url=${domain}&zxSaOtherEquipSettleId=${flowData?.zxSaOtherEquipSettleId}&zxCtOtherManageId=${flowData?.zxCtOtherManageId}`);
                        }
                      })
                    },
                  },
