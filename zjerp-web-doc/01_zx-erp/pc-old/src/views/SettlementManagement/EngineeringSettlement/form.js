            ...
            },
            {
              ...
              Component: obj => {
                ...
                if (flowData?.id) {
                  ...
                  id = obj.qnnFormInitialValues.apiBody.id
                }
                return <div
                  style={{
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算会签单吗?',
                        onOk: () => {
                          this.props.myFetch('exportZxSaProjectSettleAuditCountersignature', { projectSettleAuditId: id })
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算单吗?',
                        onOk: () => {
                          this.props.myFetch('exportZxSaProjectSettleAuditItemList', { projectSettleAuditId: id })
                            .then(({ data, success, message }) => {
                              if (success) {
                                window.open(`${data}`);
                              } else {
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算表吗?',
                        onOk: () => {
                          this.props.myFetch('exportZxSaProjectSettleAuditGcjsjsb', { settleauditId: id })
                            .then(({ data, success, message }) => {
                              if (success) {
                                window.open(`${data}`);
                              } else {
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算表吗?',
                        onOk: () => {
                          this.props.myFetch('exportZxSaProjectSettleAuditGcjsjsbDyb', { settleauditId: id })
                          .then(({ data, success, message }) => {
                            if (success) {
                              window.open(`${data}`);
                            } else {
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算表吗?',
                        onOk: () => {
                          this.props.myFetch('exportZxSaProjectSettleAuditGcjsjsdYgz', { settleauditId: id })
                            .then(({ data, success, message }) => {
                              if (success) {
                                window.open(`${data}`);
                              } else {
            ...
            },
            {
              ...
              qnnTableConfig: {
                fetchConfig: (obj) => {
                  ...
                  } else if (obj?.qnnFormProps?.qnnformData?.initialValues?.apiBody?.id) {
                    return {
                      apiName: 'getZxSaProjectSettleAuditItemList',
                      otherParams: {
                        projectSettleAuditId: obj.qnnFormProps.qnnformData.initialValues.apiBody.id
                      }
                    }
                  }
                },
