      ...
      <div style={{ padding: '10px' }}>
        <QnnForm
          ...
          fetchConfig={{
            ...
            otherParams: { zxSaEquipSettleAuditId: flowData?.zxSaEquipSettleAuditId }
          }}
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算单吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:zxSaEquipResSettleItemList.xml&url=${domain}&zxSaEquipSettleAuditId=${flowData?.zxSaEquipSettleAuditId}`);
                        }
                      })
                    }}
                  >{flowData?.billNo} - 设备租赁类结算单</p>
                </div>
              },
              span: 24,
            },
