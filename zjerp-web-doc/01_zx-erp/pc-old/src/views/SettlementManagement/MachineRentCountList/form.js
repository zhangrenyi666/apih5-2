        ...
        <Form
          ...
          formConfig={[
            ...
            },
            {
              ...
              type: 'string',
              initialValue: flowData?.zxSaEquipSettleAuditId,
              hide: true,
            },
            {
              field: 'billNo',
            ...
            },
            {
              ...
              Component: obj => {
                ...
                if (flowData?.zxSaEquipSettleAuditId) {
                  ...
                  zxSaEquipSettleAuditId = obj.qnnFormInitialValues.apiBody.zxSaEquipSettleAuditId
                }
                return <div
                  style={{
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算表吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:zxSaEquipResSettleItemList.xml&url=${domain}&zxSaEquipSettleAuditId=${zxSaEquipSettleAuditId}`);
                        }
                      })
                    }}
                  >{billNo} - 设备租赁类结算表</p>
            ...
            },
            {
              ...
              qnnTableConfig: {
                fetchConfig: (obj) => {
                  ...
                  } else if (obj?.qnnFormProps?.qnnformData?.initialValues?.apiBody?.zxSaEquipSettleAuditId) {
                    return {
                      apiName: 'getZxSaEquipSettleAuditItemList',
                      otherParams: {
                        zxSaEquipSettleAuditId: obj.qnnFormProps.qnnformData.initialValues.apiBody.zxSaEquipSettleAuditId
                      }
                    }
                  }
                },
