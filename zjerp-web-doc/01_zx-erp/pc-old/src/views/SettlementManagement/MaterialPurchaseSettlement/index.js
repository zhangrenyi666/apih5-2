        ...
        <QnnTable
          ...
          componentsKey={{
            MaterialPurchaseSettlementForm: (obj) => {
              ...
              return <MaterialPurchaseSettlementForm {...this.props} btnCallbackFn={obj.btnCallbackFn} isInQnnTable={obj.isInQnnTable} flowData={obj.selectedRows[0]} />
            },
            ManageView: (obj) => {
          ...
          actionBtns={[
            {
              ...
              label: '新增',
              onClick: (obj) => { obj.btnCallbackFn.setBtnsDisabled('remove', 'diySubmit'); },
              formBtns: [
                {
                  name: 'cancel', //关闭右边抽屉
                ...
                },
                {
                  ...
                  onClick: (obj) => {
                    ...
                    this.props.myFetch('addZxCtSuppliesShopSettlementListByOrgId', obj._formData).then(
            ...
            },
            {
              ...
              formBtns: [
                ...
                },
                {
                  ...
                  type: 'primary',
                  label: '保存',
                  hide: (obj) => { if (obj.btnCallbackFn.getActiveKey() !== "0") return true },
                  fetchConfig: { apiName: 'updateZxCtSuppliesShopSettlementListByOrgId' },
                  onClick: (obj) => {
                    if (obj.response.success) obj.btnCallbackFn.setActiveKey('1');
                  },
                },
                {
                  name: 'diySubmit_1',
                  type: 'primary',
                  hide: (obj) => { if (obj.btnCallbackFn.getActiveKey() !== "1") return true },
                  label: <div onClick={async (e) => {
                    e.stopPropagation();
                    let params = await this.child.getVals()
                    this.props.myFetch('addZxCtSuppliesShopResSettleItemList', params)
            ...
            },
            {
              ...
              field: "del",
              fetchConfig: {//ajax配置
                apiName: 'batchDeleteUpdateZxCtSuppliesShopSettlementList',
              },
              disabled: (obj) => {
                let SelectedRowsData = obj.btnCallbackFn.getSelectedRows()
            ...
            {
              Component: "MaterialPurchaseSettlementForm",
          ...
          tabs={[
              ...
              content: {
                formConfig: [
                  ...
                  },
                  {
                    ...
                    condition: [
                      {
                        regex: { zxCtSuppliesShopSettlementId: ['!', /(''|null|undefined)/ig] },
                        action: 'disabled',
                      }
                    ],
                    onChange: (val, obj) => {
                  ...
                  },
                  {
                    ...
                    onChange: (val, obj) => {
                      if (val) {
                        ...
                        let billNo = ''
                        let signedNo = ''
                        let initSerialNumber = selectItem.initSerialNumber.toString().split('').length === 1 ? '0' + (selectItem.initSerialNumber + 1) : '' + (selectItem.initSerialNumber + 1);
            ...
            },
            {
              ...
              content: obj => {
                ...
                paramsData.periodDate = moment(obj.btnCallbackFn.form.getFieldValue('periodDate')).valueOf()
            ...
            },
            {
              ...
              content: {
                ...
                rowDisabledCondition: (rowData) => {
                  return rowData.zxCtSuppliesShopSettlementItemId !== this.state.lineEdit
                },
                wrappedComponentRef: (me) => {
                  this.tableFour = me;
                },
                ...
                formConfig: [
                  ...
                  },
                  {
                    ...
                    table: {
                      ...
                      align: 'center',
                      render: (data, rowData) => {
                        if ((rowData.zxCtSuppliesShopSettlementItemId === this.state.lineEdit) && rowData.sort === 2) {
                          return <a>保存</a>;
                      ...
                      onClick: (obj) => {
                        if (this.state.lineEdit === obj.rowData.zxCtSuppliesShopSettlementItemId) {
                          ...
                          obj.btnCallbackFn.getEditedRowData().then((data) => {
                            ...
                            this.props.myFetch('updateZxCtSuppliesShopSettlementItem', body).then(
                              ({ success, message }) => {
                                if (success) {
                                  Msg.success(message);
                                  Toast.hide();
                          ...
                          for (var i = 0; i < data.length; i++) {
                            if (data[i].zxCtSuppliesShopSettlementItemId === this.state.lineEdit) {
                              Msg.error('有未保存数据，请保存后重试。')
                              return
                            }
                          }
                          this.setState({
                            lineEdit: obj.rowData.zxCtSuppliesShopSettlementItemId
                          })
                        }
                      }
                    }
