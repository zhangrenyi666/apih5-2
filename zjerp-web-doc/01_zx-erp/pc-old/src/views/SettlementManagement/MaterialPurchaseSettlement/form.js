        ...
        <Form
          ...
          formConfig={[
            ...
            },
            {
              ...
              type: 'string',
              initialValue: flowData?.zxCtSuppliesShopSettlementId,
              hide: true,
            },
            {
              field: 'billNo',
            ...
            },
            {
              ...
              Component: obj => {
                ...
                if (flowData?.zxCtSuppliesShopSettlementId) {
                  ...
                  zxCtSuppliesShopSettlementId = obj.qnnFormInitialValues.apiBody.zxCtSuppliesShopSettlementId
                }
                return <div
                  style={{
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算单吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:物资采购类本期结算金额计算表.xml&url=${domain}&zxCtSuppliesShopSettlementId=${zxCtSuppliesShopSettlementId}`);
                        }
                      })
                    }}
                  >{flowData?.billNo} - 物资采购类本期结算金额计算表</p>
                  <p
                    style={{ color: 'rgb(24,144,255)' }}
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算单吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:物资采购类本期结算金额汇总表.xml&url=${domain}&zxCtSuppliesShopSettlementId=${zxCtSuppliesShopSettlementId}`);
                        }
                      })
                    }}
                  >{billNo} - 物资采购类本期结算金额汇总表</p>
                </div>
              },
              span: 24,
            },
            {
              ...
              type: 'files',
              qnnDisabled: true,
              initialValue: flowData?.settlementFileList,
              fetchConfig: {
                apiName: 'upload'
              },
              formItemLayout: {
            ...
            },
            {
              ...
              qnnTableConfig: {
                fetchConfig: (obj) => {
                  ...
                  } else if (obj?.qnnFormProps?.qnnformData?.initialValues?.apiBody?.zxCtSuppliesShopSettlementId) {
                    return {
                      apiName: 'getZxCtSuppliesShopSettlementItemListByConID',
                      otherParams: {
                        zxCtSuppliesShopSettlementId: obj.qnnFormProps.qnnformData.initialValues.apiBody.zxCtSuppliesShopSettlementId
                      }
                    }
                  }
                },
