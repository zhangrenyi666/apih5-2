      ...
      <div style={{ padding: '10px' }}>
        <QnnForm
          ...
          fetchConfig={{
            ...
            otherParams: { zxCtSuppliesShopSettlementId: flowData?.zxCtSuppliesShopSettlementId }
          }}
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该计算单吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:物资采购类本期结算金额计算表.xml&url=${domain}&zxCtSuppliesShopSettlementId=${flowData?.zxCtSuppliesShopSettlementId}`);
                        }
                      })
                    }}
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该计算单吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:物资采购类本期结算金额汇总表.xml&url=${domain}&zxCtSuppliesShopSettlementId=${flowData?.zxCtSuppliesShopSettlementId}`);
                        }
                      })
                    }}
                  >{flowData?.billNo} - 物资采购类本期结算金额汇总表</p>
                </div>
              },
              span: 24,
            },
