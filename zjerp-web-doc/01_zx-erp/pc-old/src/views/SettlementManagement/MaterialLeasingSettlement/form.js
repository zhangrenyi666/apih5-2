          ...
          formConfig={[
            ...
            },
            {
              ...
              Component: obj => {
                ...
                if (flowData?.zxCtSuppliesLeaseSettlementListId) {
                  ...
                  zxCtSuppliesLeaseSettlementListId = obj.qnnFormInitialValues.apiBody.zxCtSuppliesLeaseSettlementListId
                }
                return <div
                  style={{
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算表吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:物资租赁类结算表.xml&url=${domain}&zxCtSuppliesLeaseSettlementListId=${zxCtSuppliesLeaseSettlementListId}`);
                        }
                      })
                    }}
                  >{billNo} - 物资租赁类结算表</p>
            ...
            },
            {
              ...
              qnnTableConfig: {
                fetchConfig: (obj) => {
                  ...
                  } else if (obj?.qnnFormProps?.qnnformData?.initialValues?.apiBody?.zxCtSuppliesLeaseSettlementListId) {
                    return {
                      apiName: 'getZxCtSuppliesLeaseSettlementItemListByConID',
                      otherParams: {
                        zxCtSuppliesLeaseSettlementListId: obj.qnnFormProps.qnnformData.initialValues.apiBody.zxCtSuppliesLeaseSettlementListId
                      }
                    }
                  }
                },
