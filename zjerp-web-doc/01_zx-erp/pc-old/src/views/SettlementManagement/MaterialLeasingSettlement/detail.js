      ...
      <div style={{ padding: '10px' }}>
        <QnnForm
          ...
          fetchConfig={{
            ...
            otherParams: { zxCtSuppliesLeaseSettlementListId: flowData?.zxCtSuppliesLeaseSettlementListId }
          }}
                  ...
                  <p
                    ...
                    onClick={() => {
                      confirm({
                        content: '确定下载该结算表吗?',
                        onOk: () => {
                          window.open(`${ureport}excel?_u=file:物资租赁类结算表.xml&url=${domain}&zxCtSuppliesLeaseSettlementListId=${flowData?.zxCtSuppliesLeaseSettlementListId}`);
                        }
                      })
                    }}
                  >{flowData?.billNo} - 物资租赁类结算表</p>
                </div>
              },
              span: 24,
            },
