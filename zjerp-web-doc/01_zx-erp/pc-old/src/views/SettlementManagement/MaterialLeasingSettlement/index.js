        ...
        <QnnTable
          ...
          componentsKey={{
            MaterialLeasingSettlementForm: (obj) => {
              ...
              return <MaterialLeasingSettlementForm {...this.props} btnCallbackFn={obj.btnCallbackFn} isInQnnTable={obj.isInQnnTable} flowData={obj.selectedRows[0]} />
            },
            ManageView: (obj) => {
          ...
          actionBtns={[
              ...
              formBtns: [
                ...
                },
                {
                  ...
                  onClick: (obj) => {
                    ...
                    this.props.myFetch('addZxCtSuppliesLeaseSettlementListByOrgId', obj._formData).then(
              ...
              formBtns: [
                ...
                },
                {
                  ...
                  onClick: (obj) => {
                    obj.btnCallbackFn.clearSelectedRows();
                    obj.btnCallbackFn.setBtnsLoading('add', 'diySubmit');
                    this.props.myFetch('updateZxCtSuppliesLeaseSettlementListByOrgId', obj._formData).then(
                      ({ data, success, message }) => {
                        if (success) {
                          obj.btnCallbackFn.setBtnsLoading('remove', 'diySubmit');
                          Msg.success(message);
            ...
            },
            {
              ...
              field: "del",
              fetchConfig: {//ajax配置
                apiName: 'batchDeleteUpdateZxCtSuppliesLeaseSettlementList',
              },
              disabled: (obj) => {
                let SelectedRowsData = obj.btnCallbackFn.getSelectedRows()
            ...
            {
              Component: "MaterialLeasingSettlementForm",
          ...
          tabs={[
              ...
              content: {
                formConfig: [
                  ...
                  },
                  {
                    ...
                    condition: [
                      {
                        regex: { zxCtSuppliesLeaseSettlementListId: ['!', /(''|null|undefined)/ig] },
                        action: 'disabled',
                      }
                    ],
                    onChange: (val, obj) => {
            ...
            },
            {
              ...
              content: obj => {
                ...
                paramsData.zxCtSuppliesLeaseSettlementListId = obj.btnCallbackFn.form.getFieldValue('zxCtSuppliesLeaseSettlementListId')
            ...
            },
            {
              ...
              content: {
                ...
                rowDisabledCondition: (rowData) => {
                  return rowData.zxCtSuppliesLeaseSettlementItemId !== this.state.lineEdit
                },
                wrappedComponentRef: (me) => {
                  this.tableFour = me;
                },
                ...
                formConfig: [
                  ...
                  },
                  {
                    ...
                    table: {
                      ...
                      align: 'center',
                      render: (data, rowData) => {
                        if ((rowData.zxCtSuppliesLeaseSettlementItemId === this.state.lineEdit) && rowData.sort === 2) {
                          return <a>保存</a>;
                      ...
                      onClick: (obj) => {
                        if (this.state.lineEdit === obj.rowData.zxCtSuppliesLeaseSettlementItemId) {
                          ...
                          obj.btnCallbackFn.getEditedRowData().then((data) => {
                            ...
                            this.props.myFetch('updateZxCtSuppliesLeaseSettlementItemByConID', body).then(
                              ({ success, message }) => {
                                if (success) {
                                  Msg.success(message);
                                  Toast.hide();
                          ...
                          for (var i = 0; i < data.length; i++) {
                            if (data[i].zxCtSuppliesLeaseSettlementItemId === this.state.lineEdit) {
                              Msg.error('有未保存数据，请保存后重试。')
                              return
                            }
                          }
                          this.setState({
                            lineEdit: obj.rowData.zxCtSuppliesLeaseSettlementItemId
                          })
                        }
                      }
                    }
