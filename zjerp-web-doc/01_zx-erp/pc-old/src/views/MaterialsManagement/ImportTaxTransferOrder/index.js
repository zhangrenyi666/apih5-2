                ...
                <QnnTable
                                            ...
                                            form: {
                                                ...
                                                onChange: (colVal, thisProps, tableBtnCallbackFn) => {
                                                    if (colVal) {
                                                        ...
                                                        // 设置编辑行值方法
                                                        let all = Number(this.FloatMulTwo(itemData.itemData[0].stockPrice, itemData.itemData[0].stockQty).toFixed(2));
                                                        tableBtnCallbackFn.setEditedRowData({
                                                            ...
                                                            stockQtyNu: itemData.itemData[0].stockQty,
                    ...
                    actionBtns={[
                            ...
                            onClick: (obj) => {
                                ...
                                if (obj.selectedRows[0].inOrOut === '0') {
                                    if (obj.selectedRows[0].companyId === companyId) {
                                        if (obj.selectedRows[0].outOrgID === departmentId) {
                        ...
                        },
                        {
                            ...
                            label: '调入方收料',
                            disabled: "bind:_actionBtnNoSelected",
                            onClick: (obj) => {//需要传-账号的项目信息
                                const { myFetch } = this.props;
                                if (obj.selectedRows.length === 1) {
                                    if (obj.selectedRows[0].inOrOut === '0') {
                                        if (obj.selectedRows[0].companyId === companyId) {
                                            if (obj.selectedRows[0].inOrgID === departmentId) {
