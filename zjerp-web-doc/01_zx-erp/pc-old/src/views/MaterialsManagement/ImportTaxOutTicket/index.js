                                            ...
                                            form: {
                                                ...
                                                onChange: (colVal, thisProps, tableBtnCallbackFn) => {
                                                    ...
                                                    if (colVal) {
                                                        ...
                                                        // 下拉的计算值都要加上---数量最大值，库存
                                                        if (thisProps.itemData[0].inQty && thisProps.itemData[0].inPrice) {
                                                            alltol = ((this.FloatMulTwo(thisProps.itemData[0].inQty, thisProps.itemData[0].inPrice)) / Number(1 + shuilv)).toFixed(2);//不含税金额
                                                            alltol1 = this.FloatMulTwo(thisProps.itemData[0].inQty, thisProps.itemData[0].inPrice).toFixed(2);//含税金额
                                                        }
                                                        if (thisProps.itemData[0].inPrice) {
                                                            alltol2 = (thisProps.itemData[0].inPrice / Number(1 + shuilv)).toFixed(2);//不含税单价
                                                        }
                                                        ...
                                                        //     isOutNumber: thisProps.itemData[0].isOutNumber,
                                                        //     isOutNumberStock: thisProps.itemData[0].isOutNumberStock,
                                                        // })
                                                        // }
                                                        tableBtnCallbackFn.setEditedRowData({
                                                            resName: thisProps.itemData[0].resName,
                                                            resUnit: thisProps.itemData[0].resUnit,
                                                            spec: thisProps.itemData[0].spec,
                                                            inPrice: thisProps.itemData[0].inPrice,
                                                            resID: thisProps.itemData[0].resID,
                                                            id: thisProps.itemData[0].id,
                                                            resCode: thisProps.itemData[0].resCode,
                                                            inQty: (thisProps.itemData[0].isOutNumber > thisProps.itemData[0].isOutNumberStock) ? thisProps.itemData[0].isOutNumberStock : thisProps.itemData[0].isOutNumber,
                                                            isOutNumber: thisProps.itemData[0].isOutNumber,
                                                            isOutNumberStock: thisProps.itemData[0].isOutNumberStock,
                                                            ...
                                                            inAmt: alltol4,
                                                            mainIdAndItemId: thisProps.itemData[0].mainIdAndItemId
                                                        });
                                                        this.table.qnnForm.form.setFieldsValue({
                                                            cantEdit: 'no'
                                                        })
