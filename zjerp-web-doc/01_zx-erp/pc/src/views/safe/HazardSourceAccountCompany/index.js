                                        ...
                                        return (
                                            <div style={{ textAlign: 'start', padding: '10px' }}><Button type="primary" onClick={() => {
                                                ...
                                                <Button type="primary" style={{ marginLeft: '10px' }} onClick={() => {
                                                    ...
                                                    var URL = `${ureport}excel?_u=minio:zxSfHazardRoomAttCom.ureport.xml&access_token=${access_token}&_n=危险源台账（公司）.xlsx&delFlag=0&companyId=${value.companyId ? value.companyId : null}&riskLevel=${ value.riskLevel ? value.riskLevel : ''}`;
                                                    if (value.companyId) {
                                                        window.open(URL);
                                                    } else {
                                                        Msg.warn('请选择项目名称！')
