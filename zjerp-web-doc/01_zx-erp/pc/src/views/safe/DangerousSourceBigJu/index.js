    ...
    return (
      <div>
        <QnnTable
          ...
          {...config}
          fetchConfig={{
            apiName: 'getZxSfHazardmainJuList',
            otherParams: {
              orgID2: jurisdiction
            }
          }}
          ...
          //         label: '保存',
          //         fetchConfig: {
          //           apiName: 'updateZxSfHazardmainJu'
          //         }
          //       }
          //     ]
          //   },
          ...
          //     field: "del",
          //     fetchConfig: {
          //       apiName: 'batchDeleteUpdateZxSfHazardmainJu',
          //     },
          //   },
          // ]}
          actionBtns={{
            ...
            otherParams: (obj) => {
              ...
              return {
                ...
                tableField: "DangerousSourceBigJu"
              }
            }
          }}
          formConfig={[
