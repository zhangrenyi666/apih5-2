                                        ...
                                        return (
                                            <div style={{ textAlign: 'start', padding: '10px' }}><Button type="primary" onClick={() => {
                                                ...
                                                <Button type="primary" style={{ marginLeft: '10px' }} onClick={() => {
                                                    ...
                                                    var URL = `${ureport}excel?_u=minio:zxSfCheckForm.ureport.xml&access_token=${access_token}&_n=项目安全检查汇总表.xlsx&orgID=${value.orgID ? value.orgID : null}&startDate=${value.startDate ? new Date().getTime(value.startDate) : null}&endDate=${value.endDate ? new Date().getTime(value.endDate) : null}`;
                                                    if (value.orgID) {
