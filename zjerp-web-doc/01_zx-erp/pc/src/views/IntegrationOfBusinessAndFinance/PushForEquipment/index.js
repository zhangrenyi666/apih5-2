                        ...
                        fetchForPush: (obj) => {
                            confirm({
                                ...
                                onOk: () => {
                                    let data = obj.btnCallbackFn.getSelectedRows();
                                    data[0].isSend = '2'
                                    this.props.myFetch('pushZxSaEquipSettleAudit', data[0])
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            table: {
                                ...
                                render: (h, obj) => {
                                    if (h) {
                                        return (h * 10000).toFixed(2)
                                    } else if (obj.contractAmt) {
                                        return (obj.contractAmt * 10000).toFixed(2)
                                    }
                                    return 0
                                }
                            }
                            ...
                            table: {
                                ...
                                render: (h, obj2) => {
                                    return <a onClick={() => {
                                        this.setState({
                                            showModel: true,
                                            opdjnm: obj2.zxSaEquipSettleAuditId
                                        })
                                    }}> {h}</a>
                                }
                            }
                                ...
                                formConfig: [
                                    ...
                                    },
                                    {
                                        ...
                                        Component: obj => {
                                            ...
                                            let zxSaEquipSettleAuditId = drawerData.zxSaEquipSettleAuditId
                                            this.props.myFetch('getZxCtEqContractDetail', { contractID, zxSaEquipSettleAuditId })
                                                .then(({ data, success }) => {
                                                    if (success) {
                                                        obj.form.setFieldsValue({
                                                            ...
                                                            changeAmt: drawerData.changeAmt ? drawerData.changeAmt * 10000 : drawerData.contractAmt ? Number((drawerData.contractAmt * 10000).toFixed(2)) : 0
                                                        })
                                                    }
                                                })
                                            this.props.myFetch('getZxSaEquipSettleAuditAmtAndTax', { zxSaEquipSettleAuditId })
                                                .then(({ data, success }) => {
                                                    if (success) {
                                                        obj.form.setFieldsValue({
                                                        ...
                                                        if (!drawerData.bqtchjsnotax && drawerData.bqtchjsnotax !== 0) {
                                                            obj.form.setFieldsValue({
                                                                bqtchjsnotax: Number(data?.thisAmtNoTax.toFixed(2)),
                                                            })
                                                        }
