                ...
                fetchConfig: () => {
                  if (params.tabIndex === '1') {
                    return {
                      ...
                      otherParams: { mainID: params.baseData.zxSaEquipSettleAuditId }
                    }
                  }
                  return {}
                },
                  ...
                  },
                  {
                    ...
                    onClick: async (obj) => {
                      ...
                      if (emptyData.length > 0) {
                        ...
                        this.props.myFetch('batchSaveZxSaSettleAuditInvoice', params)
                          .then(({ success, message }) => {
                            if (success) {
                              ...
                              Msg.success(message)
                              //保存后刷新基础信息
                              this.props.myFetch('getZxSaEquipSettleAuditDetail', { zxSaEquipSettleAuditId: params.zxSaEquipSettleAuditId })
                                .then(({ data }) => {
                  ...
                  return <Button
                    ...
                    onClick={async () => {
                      ...
                      if (fileList && fileList.length > 0) {
                        ...
                        this.props.myFetch("importZxSaSettleAuditInvoice", params)
                          .then(({ success, message }) => {
                            if (success) {
                              this.setState({ showModel: false }, () => {
                                this.tableOne.refresh()
