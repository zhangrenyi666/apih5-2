                                ...
                                fetchConfig: () => {
                                    if (params.tabIndex === '4') {
                                        return {
                                            ...
                                            otherParams: {
                                                jsxId: params.baseData.zxCtSuppliesLeaseSettlementListId
                                            }
                                        }
                                    }
                                    return {}
                                    ...
                                    },
                                    {
                                        ...
                                        onClick: async (obj) => {
                                            ...
                                            await meterList.map((item) => {
                                                item.jsxId = this.props.baseData.zxCtSuppliesLeaseSettlementListId
                                                return item
                                            })
                                            ...
                                            this.props.myFetch('batchSaveSpZxSaSettleAuditMetering', params)
