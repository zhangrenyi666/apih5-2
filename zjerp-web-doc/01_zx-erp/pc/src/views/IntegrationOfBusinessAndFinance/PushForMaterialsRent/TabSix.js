                                ...
                                fetchConfig: () => {
                                    if (params.tabIndex === '5') {
                                        return {
                                            ...
                                            otherParams: {
                                                mainID: params.baseData.zxCtSuppliesLeaseSettlementListId
                                            }
                                        }
                                    }
                                    return {}
                                    ...
                                    },
                                    {
                                        ...
                                        onClick: async (obj) => {
                                            ...
                                            if (emptyData.length > 0) {
                                                ...
                                                await costaccountList.map((item) => {
                                                    item.mainID = this.props.baseData.zxCtSuppliesLeaseSettlementListId
                                                    return item
                                                })
                                                ...
                                                this.props.myFetch('batchSaveSpZxSaSettleAuditCostaccount', params)
