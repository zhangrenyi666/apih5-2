      ...
      <div style={{ padding: '10px' }}>
        <QnnForm
          ...
          fetchConfig={{
            ...
            otherParams: { jsxId: params.baseData.zxCtSuppliesLeaseSettlementListId }
          }}
                ...
                return (
                  <div style={{ textAlign: 'right', padding: '12px' }}>
                    <Button type="primary" onClick={() => {
                      ...
                      params.jsxId = this.props.baseData.zxCtSuppliesLeaseSettlementListId
                      this.props.myFetch('updateSpZxSaSettleAuditDatacheck', params)
                        .then(({ success, message }) => {
                          if (success) {
                            obj.btnCallbackFn.refresh()
                            Msg.success(message)
                            //保存后刷新基础信息
                            this.props.myFetch('getZxCtSuppliesLeaseSettlementListDetail', { zxCtSuppliesLeaseSettlementListId: this.props.baseData.zxCtSuppliesLeaseSettlementListId })
                              .then(({ data }) => {
