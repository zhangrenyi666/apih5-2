                ...
                fetchConfig: () => {
                  if (params.tabIndex === '1') {
                    return {
                      ...
                      otherParams: { mainID: params.baseData.id }
                    }
                  }
                  return {}
                },
                  ...
                  },
                  {
                    ...
                    onClick: async (obj) => {
                      ...
                      if (emptyData.length > 0) {
                        ...
                        this.props.myFetch('batchUpdateGcZxSaSettleAuditInvoice', params)
                          .then(({ success, message }) => {
                            if (success) {
                              ...
                              Msg.success(message)
                              //保存后刷新基础信息
                              this.props.myFetch('getZxSaProjectSettleAuditDetail', { id: params.id })
                                .then(({ data }) => {
                  ...
                  return <Button
                    ...
                    onClick={async () => {
                      ...
                      if (fileList && fileList.length > 0) {
                        ...
                        this.props.myFetch("importGcZxSaSettleAuditInvoice", params)
                          .then(({ success, message }) => {
                            if (success) {
                              this.setState({ showModel: false }, () => {
                                this.tableOne.refresh()
