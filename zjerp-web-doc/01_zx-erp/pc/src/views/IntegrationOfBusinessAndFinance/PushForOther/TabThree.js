      ...
      <div style={{ padding: '10px' }}>
        <QnnForm
          ...
          fetchConfig={{
            ...
            otherParams: { jsxId: params.baseData.zxSaOtherEquipSettleId }
          }}
                ...
                return (
                  <div style={{ textAlign: 'right', padding: '12px' }}>
                    <Button type="primary" onClick={() => {
                      ...
                      params.jsxId = this.props.baseData.zxSaOtherEquipSettleId
                      this.props.myFetch('updateOtherZxSaSettleAuditDatacheck', params)
                        .then(({ success, message }) => {
                          if (success) {
                            obj.btnCallbackFn.refresh()
                            Msg.success(message)
                            //保存后刷新基础信息
                            this.props.myFetch('getZxSaOtherEquipSettleDetail', { zxSaOtherEquipSettleId: this.props.baseData.zxSaOtherEquipSettleId })
                              .then(({ data }) => {
