                                ...
                                fetchConfig: () => {
                                    if (params.tabIndex === '5') {
                                        return {
                                            ...
                                            otherParams: {
                                                mainID: params.baseData.zxSaOtherEquipSettleId
                                            }
                                        }
                                    }
                                    return {}
                                    ...
                                    },
                                    {
                                        ...
                                        onClick: async (obj) => {
                                            ...
                                            if (emptyData.length > 0) {
                                                ...
                                                await costaccountList.map((item) => {
                                                    item.mainID = this.props.baseData.zxSaOtherEquipSettleId
                                                    return item
                                                })
                                                obj.btnCallbackFn.setBtnsLoading('add', 'diyButton');
                                                let params = {}
                                                params.zxSaOtherEquipSettleId = this.props.baseData.zxSaOtherEquipSettleId
                                                params.costaccountList = costaccountList
                                                this.props.myFetch('batchSaveOtherZxSaSettleAuditCostaccount', params)
