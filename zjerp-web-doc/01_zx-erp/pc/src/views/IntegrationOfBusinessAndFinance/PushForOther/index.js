                        ...
                        fetchForPush: (obj) => {
                            confirm({
                                ...
                                onOk: () => {
                                    let data = obj.btnCallbackFn.getSelectedRows();
                                    data[0].isSend = '2'
                                    this.props.myFetch('pushZxSaOtherEquipSettleToLc', data[0])
                            ...
                            table: {
                                ...
                                render: (h, obj2) => {
                                    return <a onClick={() => {
                                        this.setState({
                                            showModel: true,
                                            opdjnm: obj2.zxSaOtherEquipSettleId
                                        })
                                    }}> {h}</a>
                                }
                            }
                                ...
                                formConfig: [
                                    ...
                                    },
                                    {
                                        ...
                                        Component: obj => {
                                            ...
                                            let zxCtOtherManageId = drawerData.zxCtOtherManageId
                                            let zxSaOtherEquipSettleId = drawerData.zxSaOtherEquipSettleId
                                            this.props.myFetch('getZxCtOtherManageDetail', { zxCtOtherManageId: zxCtOtherManageId })
                                                .then(({ data, success }) => {
                                                    if (success) {
                                            ...
                                            this.props.myFetch('getZxSaOtherSettleAuditAmtAndTax', { zxSaOtherEquipSettleId })
                                                .then(({ data, success }) => {
                                                    if (success) {
                                                        obj.form.setFieldsValue({
