                                ...
                                fetchConfig: () => {
                                    if (params.tabIndex === '4') {
                                        return {
                                            ...
                                            otherParams: {
                                                jsxId: params.baseData.zxSaOtherEquipSettleId
                                            }
                                        }
                                    }
                                    return {}
                                    ...
                                    },
                                    {
                                        ...
                                        onClick: async (obj) => {
                                            ...
                                            await meterList.map((item) => {
                                                item.jsxId = this.props.baseData.zxSaOtherEquipSettleId
                                                return item
                                            })
                                            ...
                                            this.props.myFetch('batchSaveOtherZxSaSettleAuditMetering', params)
