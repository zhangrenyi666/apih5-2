                                ...
                                fetchConfig: () => {
                                    if (params.tabIndex === '3') {
                                        return {
                                            ...
                                            otherParams: {
                                                jsxZbid: params.baseData.zxSaOtherEquipSettleId
                                            }
                                        }
                                    }
                                    return {}
                                    ...
                                    },
                                    {
                                        ...
                                        onClick: async (obj) => {
                                            ...
                                            if (exceedData) {
                                                ...
                                                await articleList.map((item) => {
                                                    item.jsxZbid = this.props.baseData.zxSaOtherEquipSettleId
                                                    return item
                                                })
                                                ...
                                                this.props.myFetch('batchSaveOtherZxSaSettleAuditArticle', params)
