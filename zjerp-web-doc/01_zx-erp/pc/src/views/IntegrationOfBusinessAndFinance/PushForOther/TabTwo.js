                ...
                fetchConfig: () => {
                  if (params.tabIndex === '1') {
                    return {
                      ...
                      otherParams: { mainID: params.baseData.zxSaOtherEquipSettleId }
                    }
                  }
                  return {}
                },
                  ...
                  },
                  {
                    ...
                    onClick: async (obj) => {
                      ...
                      if (emptyData.length > 0) {
                        ...
                        this.props.myFetch('batchUpdateOtherZxSaSettleAuditInvoice', params)
                          .then(({ success, message }) => {
                            if (success) {
                              ...
                              Msg.success(message)
                              //保存后刷新基础信息
                              this.props.myFetch('getZxSaOtherEquipSettleDetail', { zxSaOtherEquipSettleId: params.zxSaOtherEquipSettleId })
                                .then(({ data }) => {
                  ...
                  return <Button
                    ...
                    onClick={async () => {
                      ...
                      if (fileList && fileList.length > 0) {
                        ...
                        this.props.myFetch("importOtherZxSaSettleAuditInvoice", params)
                          .then(({ success, message }) => {
                            if (success) {
                              this.setState({ showModel: false }, () => {
                                this.tableOne.refresh()
