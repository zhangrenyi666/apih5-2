...
class operation extends Component {
    ...
    componentDidMount() {
        ...
        if (workId) {
            this.props.myFetch(apiName, { apiName: 'getZxSaOtherEquipSettleDetail', apiType: 'POST', flowId: 'zxSaOtherEquipSettleReviewApply', title: title, workId: workId }).then(({ success, message, data }) => {
                if (success) {
                    this.setState({
