...
class index extends Component {
  ...
  componentDidMount() {
    ...
    if (flowData && flowData.zxCtOtherManageId) {
      this.setState({ zxCtOtherManageId: flowData.zxCtOtherManageId })
    } else {
      this.setState({ zxCtOtherManageId: this.props.apibody ? JSON.parse(this.props.apibody).zxCtOtherManageId :''})
    }
  }
  render() {
    const { activeKey, zxCtOtherManageId} = this.state;
    return (
              ...
              fetchConfig={{
                ...
                otherParams: () => {
                  ...
                  if (this.props.apibody) {
                    zxCtOtherManageId = this.props.apibody ? JSON.parse(this.props.apibody).zxCtOtherManageId : ''
                  } else if (flowData && flowData.zxCtOtherManageId) {
                    zxCtOtherManageId = flowData.zxCtOtherManageId
                  }
                  return { zxCtOtherManageId }
                }
              }}
