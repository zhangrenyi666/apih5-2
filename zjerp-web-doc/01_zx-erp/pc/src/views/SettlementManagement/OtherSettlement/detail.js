...
let config = {
  ...
  workFlowConfig: {
    title: ['其他类结算单', 'contractName', 'billNo'],
    apiNameByAdd: "zxSaOtherEquipSettleReviewApply",
    apiNameByUpdate: "zxSaOtherEquipSettleReviewApply",
    apiNameByGet: "getZxSaOtherEquipSettleDetail",
    flowId: 'zxSaOtherEquipSettleReviewApply',
    todo: "TodoList",
    hasTodo: "HasTodoList"
  },
  isHaveDoc: true,
...
class index extends Component {
  ...
  opinionFields = [
    ...
    { label: "项目校对", field: "opinionField20" },
  ];
  componentWillMount() {
    ...
    let paramsArry = {
      ...
      apiType: "POST",
      flowId: "zxSaOtherEquipSettleReviewApply",
      title: "其他类结算单-" + flowData.contractNo
    };
          ...
          formConfig={[
            {
              field: 'flowId',
              type: 'string',
              initialValue: 'zxSaOtherEquipSettleReviewApply',
              hide: true,
            },
            {
              field: 'contractName',
            ...
            },
            {
              ...
              type: 'string',
              initialValue: list?.zxSaOtherEquipSettleId,
              hide: true,
            },
            {
                ...
                fetchConfig: {
                  ...
                  otherParams: () => {
                    if (this.flowForm.rootBody?.workId) {
                      return {
                        zxSaOtherEquipSettleId: this.flowForm?.qnnForm?.form?.getFieldValue('apiBody').zxSaOtherEquipSettleId
                      }
                    } else if (flowData?.zxSaOtherEquipSettleId) {
                      return {
              ...
              Component: obj => {
                ...
                >
                  <p
                    ...
                    onClick={() => {
                      let filter = [
                        '&zxSaOtherEquipSettleId=' + zxSaOtherEquipSettleId,
                      ]
                      let Url = `${ureport}preview?_u=minio:zxSaOtherEquipSettleList.ureport.xml&_t=1,4,5,6&access_token=${access_token}&delFlag=0${filter.join('')}`
                      ...
                      confirm({
                        content: '确定下载该结算单吗?',
                        onOk: () => {
                          var URL = `${ureport}excel?_u=minio:zxSaOtherEquipSettleList.xml&access_token=${access_token}&zxSaOtherEquipSettleId=${zxSaOtherEquipSettleId}&_n=${billNo}-其他类结算单`;
                          window.open(URL);
                        }
                      })
                    }}
