...
let config = {
  ...
  workFlowConfig: {
    ...
    apiNameByAdd: "zxSaOtherEquipSettleReviewFlowBegin",
                ...
                fetchConfig: {
                  ...
                  otherParams: () => {
                    if (this.flowForm.rootBody?.workId) {
                      return {
                        zxSaOtherEquipSettleId: this.state.apibody ? JSON.parse(this.state.apibody).zxSaOtherEquipSettleId : ''
                      }
                ...
                > 
                  <p
                    ...
                    onClick={() => {
                      ...
                      let Url = `${ureport}preview?_u=minio:zxSaOtherEquipSettleList.xml&_t=1,4,5,6&access_token=${access_token}&delFlag=0${filter.join('')}`
