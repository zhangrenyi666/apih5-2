        ...
        return (
            <div>
                                        ...
                                        <Button type="primary" style={{ marginLeft: '10px' }} onClick={() => {
                                            confirm({
                                                ...
                                                onOk: () => {
                                                    ...
                                                    let URL = `${ureport}excel?_u=minio:ZxSaEquipSettleAuditCompP5.ureport.xml&access_token=${access_token}&delFlag=0${stringData}&_n=物资租赁结算台账(公司)报表`;
                                                    window.open(URL);
                                                }
                                            })
                                        }}>导出</Button></div>
                ...
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'exportZxSaEquipSettleAuditCompP5',
