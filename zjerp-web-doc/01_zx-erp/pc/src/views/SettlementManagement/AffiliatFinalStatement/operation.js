...
class operation extends Component {
    ...
    componentDidMount() {
        ...
        if (workId) {
            this.props.myFetch(apiName, { apiName: 'getZxSaFsSettlementDetail', apiType: 'POST', flowId: 'FsSelementWorkFlow', title: title, workId: workId }).then(({ success, message, data }) => {
                if (success) {
                    this.setState({
