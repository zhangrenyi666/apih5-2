...
class index extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.apibody) {
      this.setState({ zxCtFsContractId: this.props.apibody ? JSON.parse(this.props.apibody).zxCtFsContractId : '' })
    } else if (flowData && flowData.zxCtFsContractId) {
      this.setState({ zxCtFsContractId: flowData.zxCtFsContractId })
    }
  }
  render() {
    const { activeKey, zxCtFsContractId } = this.state;
    return (
            ...
            <QnnForm
              ...
              fetchConfig={{
                ...
                otherParams: () => {
                  ...
                  if (this.props.apibody) {
                    zxCtFsContractId = this.props.apibody ? JSON.parse(this.props.apibody).zxCtFsContractId : ''
                  } else if (flowData && flowData.zxCtFsContractId) {
