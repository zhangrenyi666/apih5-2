...
class index extends Component {
  ...
  componentWillMount() {
    ...
    let paramsArry = {
      ...
      apiName: "getZxSaFsSettlementDetail",
      apiType: "POST",
      flowId: "FsSelementWorkFlow",
      title: "附属类结算单-" + flowData.contractNo
    };
        ...
        {list ? <Form
          ...
          formConfig={[
            ...
            },
            {
              ...
              type: 'string',
              initialValue: list?.zxSaFsSettlementId,
              hide: true,
            },
            {
            ...
            },
            {
              ...
              label: '结算时限：',
              span: 12,
              initialValue: moment(list?.beginDate).format("YYYY-MM-DD") + ' 至 ' + moment(list?.endDate).format("YYYY-MM-DD")
            },
            {
              field: 'beginDate33',
              type: 'string',
                ...
                fetchConfig: {
                  ...
                  otherParams: () => {
                    if (this.flowForm.rootBody?.workId) {
                      return {
                        zxSaFsSettlementId: this.flowForm?.qnnForm?.form?.getFieldValue('apiBody').zxSaFsSettlementId
                      }
                    } else {
                      return {
