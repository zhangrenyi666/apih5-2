...
import ProjectConstructionContractManagement from '../CentralizedSettlementControl/indexHT';
import EngineeringSettlement from '../CentralizedSettlementControl/indexJS';
const { confirm } = Modal;
const config = {
    antd: {
        rowKey: 'id',
        ...
        return (
            <div className={s.root}>
                ...
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'getZxSaStaticSettleList',
