        ...
        return (
            <div>
                                        ...
                                        <Button type="primary" style={{ marginLeft: '10px' }} onClick={() => {
                                            confirm({
                                                ...
                                                onOk: () => {
                                                    ...
                                                    let URL = `${ureport}excel?_u=minio:ZxSaEquipSettleAuditComp21Rpt.ureport.xml&access_token=${access_token}&delFlag=0${stringData}&_n=其它结算台账(公司)报表`;
                                                    window.open(URL);
                                                }
                                            })
                                        }}>导出</Button></div>
                ...
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'exportZxSaEquipSettleAuditComp21Rpt',
