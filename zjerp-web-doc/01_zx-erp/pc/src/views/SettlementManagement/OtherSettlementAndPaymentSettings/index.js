                    ...
                    actionBtns={{
                        ...
                        otherParams: (obj) => {
                            ...
                            return {
                                ...
                                tableField: "OtherSettlementAndPaymentSettings"
                            }
                        }
                    }}
                    method={{
                            ...
                            if (obj?._formData?.itemList?.length) {
                                ...
                                if (nullRows.length) {
                                    ...
                                    obj._formData.itemList.map((item) => {
                                        if (!item.quoteFlag4 || String(item.quoteFlag4) === '0') {
                                            itemList.push(item);
                                        }
                                        return item;
                                    })
                                    ...
                                    getRowSelection: function (obj) {
                                        return {
                                            ...
                                            getCheckboxProps: record => ({
                                                name:record.name,
                                                disabled: String(record.quoteFlag4) !== '0'
                                            }),
                                        }
                                    },
                                    formConfig: [
