...
class index extends Component {
  ...
  componentWillMount() {
    ...
    let paramsArry = {
      ...
      apiName: "getZxCtSuppliesLeaseSettlementListFlowDetail",
      apiType: "POST",
      flowId: "ZxCtSuppliesLeaseSettlement",
      title: "物资租赁类结算单-" + flowData.contractNo
    };
        ...
        {list ? <Form
          ...
          formConfig={[
            ...
            },
            {
              ...
              type: 'string',
              initialValue: list?.zxCtSuppliesLeaseSettlementListId,
              hide: true,
            },
            {
              field: 'contractID',
                ...
                fetchConfig: {
                  ...
                  otherParams: () => {
                    if (this.flowForm.rootBody?.workId) {
                      return {
                        zxCtSuppliesLeaseSettlementListId: this.flowForm?.qnnForm?.form?.getFieldValue('apiBody').zxCtSuppliesLeaseSettlementListId
                      }
