                    ...
                    onClick: () => {
                      confirm({
                        ...
                        onOk: () => {
                          ...
                          var URL = `${ureport}excel?_u=minio:物资采购类结算营改增一览.xml&access_token=${access_token}&zxCtSuppliesShopSettlementId=${flowData?.zxCtSuppliesShopSettlementId}&_n=${flowData?.billNo}-物资采购类营改增一览`;
                          window.open(URL);
                        }
                      })
                    },
