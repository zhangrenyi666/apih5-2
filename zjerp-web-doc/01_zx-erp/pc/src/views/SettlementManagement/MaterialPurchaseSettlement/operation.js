...
class operation extends Component {
    ...
    componentDidMount() {
        ...
        if (workId) {
            this.props.myFetch(apiName, { apiName: 'getZxCtSuppliesShopSettlementListFlowDetail', apiType: 'POST', flowId: 'ZxCtSuppliesShopSettlement', title: title, workId: workId }).then(({ success, message, data }) => {
                if (success) {
                    this.setState({
