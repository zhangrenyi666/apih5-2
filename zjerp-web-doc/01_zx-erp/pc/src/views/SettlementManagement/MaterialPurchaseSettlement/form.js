                ...
                fetchConfig: {
                  ...
                  otherParams: () => {
                    if (this.flowForm.rootBody?.workId) {
                      return {
                        zxCtSuppliesShopSettlementId: this.state.apibody ? JSON.parse(this.state.apibody).zxCtSuppliesShopSettlementId : ''
                      }
                    } else if (flowData?.zxCtSuppliesShopSettlementId) {
                      return {
