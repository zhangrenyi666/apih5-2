                    ...
                    actionBtns={{
                        ...
                        otherParams: (obj) => {
                            ...
                            return {
                                ...
                                tableField: "EngineeringSettlementAndPaymentSetting"
                            }
                        }
                    }}
                    method={{
                            ...
                            if (obj?._formData?.itemList?.length) {
                                ...
                                if (nullRows.length) {
                                    ...
                                    obj._formData.itemList.map((item) => {
                                        if (!item.quoteFlag1 || String(item.quoteFlag1) === '0') {
                                            itemList.push(item);
                                        }
                                        return item;
                                    })
                                    ...
                                    getRowSelection: function (obj) {
                                        return {
                                            ...
                                            getCheckboxProps: record => ({
                                                name: record.name,
                                                disabled: String(record.quoteFlag1) !== '0'
                                            }),
                                        }
                                    },
                                    formConfig: [
