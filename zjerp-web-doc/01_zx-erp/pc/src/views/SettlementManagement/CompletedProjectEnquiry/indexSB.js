                          ...
                          .then(({ data, success }) => {
                            if (success) {
                              obj.form.setFieldsValue({
                                pp4: data.totalAmt,
                                pp4_pp5: data.totalAmt - obj.form.getFieldValue('pp5') >= 0 ? data.totalAmt - obj.form.getFieldValue('pp5') : 0
                              })
                            }
                          })
                      }
                  ...
                  },
                  {
                    ...
                    qnnTableConfig: {
                      ...
                      fetchConfig: {
                        ...
                        otherParams: () => {
                          return {
                            lswldwWldwmc: this.table?.form?.getFieldValue('secondName')
                          }
                        }
                      },
