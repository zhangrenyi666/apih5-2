                                        ...
                                        formConfig={[
                                            ...
                                            //从这开始
                                            {
                                                ...
                                                form: {
                                                    ...
                                                    // disabled: 'bind:disabledFunc',
                                                    // condition: [{
                                                    //     action: async (obj) => {
                                                    //         console.log(await obj.tableFns.getSelectedRows()[0].leaf)
                                                    //         if (await obj.tableFns.getSelectedRows()[0].leaf === 0) {
                                                    //             return false
                                                    //         }
                                                    //     }
                                                    // }],
                                                    ...
                                                    onChange: () => {
                                                        ...
                                                        if (this.tableList.qnnForm.form.getFieldsValue().count && this.tableList.qnnForm.form.getFieldsValue().taxPrice) {
                                                            this.tableList.qnnForm.form.setFieldsValue({
                                                                jxtax: this.FloatMulTwo(this.tableList.qnnForm.form.getFieldsValue().count, this.tableList.qnnForm.form.getFieldsValue().taxPrice)
                                                            })
                                                        }
                                                    }
                                                }
