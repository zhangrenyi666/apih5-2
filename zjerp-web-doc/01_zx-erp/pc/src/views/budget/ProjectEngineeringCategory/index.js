...
class index extends Component {
    ...
    getYZHTXXFun(val) {
        ...
        myFetch('getZxCtContractList', {
            ...
            ({ data, success, message }) => {
                console.log(data)
                if (success) {
                    let month = this.getAllDate(data[0].planStartDate, data[0].planEndDate)
                    if (month === 0) {
                        month = 1;
                    }
                    ...
                    this.table.btnCallbackFn.qnnForm.setValues({
                        rate: 1,
                        //合同中标价(亿元)
                        contractCost: data[0].contractCost / 10000,
                        //总工期(月)
                        duration: month,
                    })
                } else {
        ...
        myFetch('getZxBuProjectTypeCheckTreeList', {
            ...
            ({ data, success, message }) => {
                if (success) {
                    ...
                    this.tableBu.setTableData(data)
                    //折算总合同金额(亿元)
                    ...
                    this.table.btnCallbackFn.qnnForm.setValues({
                        ...
                        //折算总合同金额(亿元)
                        // codeID1:,
                        codeNum1: this.FloatMulTwo(contractCost, 1),
                        // 折算平均年产值(亿元)
                        // codeID2:,
                        codeNum2: this.FloatMulTwo((contractCost / duration), 12).toFixed(6)
                    })
    ...
    calculation(val) {
        //折算系数
        let coe = 1;
        this.tableBu.getTableData().map((item) => {
            if (item.rate !== 0) {
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            table: {
                                ...
                                onClick: (obj) => {
                                    this.setState({
                                        tabTableListData: obj.rowData.zxBuProjectTypeItemList
                                    }, () => {
                            ...
                            form: {
                                ...
                                allowClear: false,
                                fetchConfig: {
                                    apiName: 'getZxBuProjectTypeProjectList',
                                    otherParams: {
                                        orgID: departmentId
                                    }
                                },
                                ...
                                onChange: (val, rowData) => {
                                    this.tableBu.setTableData([])
                                    this.getYZHTXXFun(rowData.itemdata.orgID);
                                }
                            }
                        },
                        {
                                    ...
                                    return (
                                        ...
                                        >
                                            <QnnTable
                                                ...
                                                data={this.state.tabTableListData}
                                                formConfig={[
                                                    {
                                                        isInTable: false,
                                                        form: {
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        form: {
                                                            ...
                                                            onChange: (val, obj) => {
                                                                let datas = this.tableBu.getTableData().map((item) => {
                                                                ...
                                                                this.tableBu.setTableData(datas)
                                                                // this.setState({
                                                                //     data: datas
                                                                // })
                                                                //并且计算一下
                                                        ...
                                                        table: {
                                                            ...
                                                            tdEditCb: (obj) => {
                                                                ...
                                                                if (obj.newRowData.checkLevel3ID != null) {
                                                                    ...
                                                                    datas = this.tableBu.getTableData().map((item) => {
                                                                ...
                                                                this.tableBu.setTableData(datas == null ? this.tableBu.getTableData() : datas)
                                                            }
                                                        },
                                                        form: {
                                                            type: 'number',
                    ...
                    actionBtns={[
                        {
                            ...
                            formBtns: [
                                ...
                                },
                                {
                                    ...
                                    field: 'addsubmit',
                                    onClick: (val) => {
                                        val._formData.zxBuProjectTypeItemList = this.tableBu.getTableData();
                                        const { myFetch } = this.props;
                        ...
                        },
                        {
                            ...
                            onClick: (obj) => {
                                if (obj.selectedRows[0].status === '1') {
                                    ...
                                    this.setState({
                                        tabTableListData: obj.selectedRows[0].zxBuProjectTypeItemList
                                    })
                                    // this.tableBu.setTableData(obj.selectedRows[0].zxBuProjectTypeItemList)
                                    // this.setState({
                                    //     data: 
                                    // })
                                }
