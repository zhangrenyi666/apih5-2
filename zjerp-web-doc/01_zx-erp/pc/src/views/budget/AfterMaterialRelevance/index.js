...
class index extends Component {
    ...
    leftTableSelectData = null
    resGjLossCoefficientJoin = {}
    resGjConCoefficientJoin = {}
    rightTableData = null
                            ...
                            <QnnTable
                                ...
                                rowSelection={{
                                    ...
                                    onChange: async (selectedRowKey, selectedData, delKey) => {
                                        ...
                                        this.tableQD.clearSelectedRows()
                                        this.leftTableSelectData = selectedData[0]
                                        // 设置 右侧表格选中
                                            ...
                                            list.map((item, index) => {
                                                ...
                                                if (selectedData[0].resGjLossCoefficientJoin && selectedData[0].resGjConCoefficientJoin) {
                                                    if (selectedData[0].resGjLossCoefficientJoin.split(',')[index] && selectedData[0].resGjConCoefficientJoin.split(',')[index]) {
                                                        ...
                                                        if (this.resGjLossCoefficientJoin[this.tableOne.getSelectedRowsKey()] && this.resGjConCoefficientJoin[this.tableOne.getSelectedRowsKey()]) {
                                                            rowData = {
                                                                ...rowData,
                                                                gjLossCoefficient1: this.resGjLossCoefficientJoin[this.tableOne.getSelectedRowsKey()][index],
                                                                gjConCoefficient1: this.resGjConCoefficientJoin[this.tableOne.getSelectedRowsKey()][index],
                                                                scenePrice1: (+this.resGjLossCoefficientJoin[this.tableOne.getSelectedRowsKey()][index] * +this.resGjConCoefficientJoin[this.tableOne.getSelectedRowsKey()][index] * +rowData['scenePrice']).toFixed(2)
                                                            }
                                                        }
                                                    }
                                                } else {
                                ...
                                formConfig={[
                                    ...
                                    },
                                    {
                                        isInTable: false,
                                        form: {
                                            field: 'resGjLossCoefficientJoin',
                                            type: 'string',
                                            hide: true,
                                        }
                                    },
                                            ...
                                            fieldConfig: {
                                                ...
                                                onChange: async (value, obj) => {
                                                    ...
                                                    if (this.leftTableChangeVal && isCheck) {
                                                        this.resGjLossCoefficientJoin[this.tableOne.getSelectedRowsKey()] || (this.resGjLossCoefficientJoin[this.tableOne.getSelectedRowsKey()] = [])

                                                        this.tableOne.getSelectedRows()[0].voidJoin.split(',').map((item, index) => {
                                                            if (item === rowData.stockVOID) {
                                                                this.resGjLossCoefficientJoin[this.tableOne.getSelectedRowsKey()][index] = value
                                                            }
                                                            return true
                                                        })
                                                        ...
                                                        if (rowData.gjLossCoefficient1 && rowData.gjConCoefficient1) {
                                                           ...
                                                           await this.props.myFetch('updateZxBuWorksToStockPriceCoe', params)
                                                            // await this.tableOne.setTableData(newTableData)
                                        ...
                                        table: {
                                            ...
                                            fieldConfig: {
                                                ...
                                                onChange: async (value, obj) => {
                                                    ...
                                                    // 判断左右表格 是否选中
                                                    if (this.leftTableChangeVal && isCheck) {
                                                        this.resGjConCoefficientJoin[this.tableOne.getSelectedRowsKey()] || (this.resGjConCoefficientJoin[this.tableOne.getSelectedRowsKey()] = [])

                                                        this.tableOne.getSelectedRows()[0].voidJoin.split(',').map((item, index) => {
                                                            if (item === rowData.stockVOID) {
                                                                this.resGjConCoefficientJoin[this.tableOne.getSelectedRowsKey()][index] = value
                                                            }
                                                            return true
                                                        })
