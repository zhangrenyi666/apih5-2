                    ...
                    formConfig={[
                        ...
                        },
                        {
                            ...
                            form: {
                                ...
                                hide: (obj) => {
                                    return obj.clickCb.rowInfo.name === 'detail' ? true : false
                                },
                            },
                        },
                        {
                            ...
                            form: {
                                ...
                                hide: (obj) => {
                                    return obj.clickCb.rowInfo.name === 'detail' ? false : true
                                },
                            },
                        },
                        {
                                            ...
                                            form: {
                                                ...
                                                onChange: (colVal, thisProps, tableBtnCallbackFn) => {
                                                    if (colVal) {
                                                        ...
                                                        const alltol = Number((itemData.itemData.stockPrice * itemData.itemData.stockQty).toFixed(2));
                                                        ...
                                                        tableBtnCallbackFn.getEditedRowData(false).then((editRow) => {
                                                            editRow.resName = itemData.itemData.resName;
                                                            editRow.resUnit = itemData.itemData.unit;
                                                            editRow.spec = itemData.itemData.spec;
                                                            editRow.stdPrice = itemData.itemData.stockPrice;
                                                            editRow.stockQty = itemData.itemData.stockQty;
                                                            editRow.outQty = itemData.itemData.stockQty;
                                                            editRow.resID = itemData.itemData.resID;
                    ...
                    actionBtns={{
                        ...
                        otherParams: (obj) => {
                            ...
                            return {
                                ...
                                tableField: "ImportTaxMaterialRequisition"
                            }
                        }
                    }}
                />
                ...
                >
                    {
                        idPreview ? <Spin spinning={loading}>
                            ...
                            }} src={`${ureport}preview?_u=minio:ZxSkStockTransferMaterialRequisition.preview.xml&_t=1,6&_n=${name}&access_token=${access_token}&id=${idPreview}
                            `}title="byLm"></iframe>
                        </Spin> : ''
                    }
