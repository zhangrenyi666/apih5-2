                                            ...
                                            form: {
                                                ...
                                                onChange: (colVal, thisProps, tableBtnCallbackFn) => {
                                                    if (colVal) {
                                                        ...
                                                        let alltol = 0;
                                                        if (itemData.itemData.stdPrice && itemData.itemData.isOutNumber) {
                                                            alltol = Number((itemData.itemData.stdPrice * itemData.itemData.isOutNumber).toFixed(2));
                                                        }
                                                        ...
                                                        tableBtnCallbackFn.setEditedRowData({
                                                            ...
                                                            stdPrice: itemData.itemData.stdPrice,
                                                            outQty: itemData.itemData.isOutNumber,
                                                            resID: itemData.itemData.resID,
                                                            id: itemData.itemData.id,
                                                            resCode: itemData.itemData.resCode,
                                                            outAmt: alltol,
                                                            isOutNumber: itemData.itemData.isOutNumber,
                                                            mainIdAndItemId: itemData.itemData.mainIdAndItemId
                                                        });
                                                ...
                                                onChange: async (colVal, thisProps, tableBtnCallbackFn) => {
                                                    if (colVal >= 0 && typeof (colVal) === 'number') {
                                                        ...
                                                        if (colVal > rowData.isOutNumber) {
                                                            ...
                                                            if (rowData.stdPrice) {
                                                                newRowData.outAmt = Number(this.FloatMulTwo(rowData.stdPrice, newRowData.outQty).toFixed(2));
                                                            }
                    ...
                    actionBtns={{
                        ...
                        otherParams: (obj) => {
                            ...
                            return {
                                ...
                                tableField: "ImportTaxWithdrawal"
                            }
                        }
                    }}
                />
                ...
                >
                    {
                        idPreview ? <Spin spinning={loading}>
                            ...
                            }} src={`${ureport}preview?_u=minio:ZxSkStockTransferWithdrawal.preview.xml&_t=1,6&_n=${name}&access_token=${access_token}&id=${idPreview}&zxSkStockTransItemWithdrawalId=${idPreview}
                            `}title="byLm"></iframe>
                        </Spin> : ''
                    }
