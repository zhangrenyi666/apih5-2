...
class index extends Component {
  ...
  componentWillMount() {
    ...
    let paramsArry = {
      ...
      apiName: "getZxCtSuppliesContrReplenishFlowDetail",
      apiType: "POST",
      flowId: "ZxCtSuppliesContrReplenish"
    };
    ...
    return (
      <div style={{ height: isInQnnTable ? "" : "100vh" }} className={s.root}>
        ...
        {list ? <Form
          ...
          initialValueByFiles={list?.replenishAgreementFileList}
          formConfig={[
            {
              field: 'workId',
              type: 'string',
            ...
            },
            {
              ...
              type: 'string',
              initialValue: list?.replenishAgreementId,
              hide: true,
            },
            {
            ...
            },
            {
              ...
              type: 'string',
              initialValue: list?.zxCtSuppliesContractChangeId,
              hide: true,
            },
            {
              field: 'pp6',
              type: 'string',
              initialValue: list?.pp6,
              hide: true,
            },
            {
              field: 'beginPer',
            ...
            },
            {
              ...
              qnnDisabled: true,
              hide: true,
              initialValue: list?.alterContractSum,
              placeholder: '请输入',
              span: 12,
              precision: 6,
              formItemLayout: {
            ...
            },
            {
              ...
              qnnDisabled: true,
              hide: true,
              initialValue: list?.alterContractSumNoTax,
              placeholder: '请输入',
              span: 12,
              precision: 6,
              formItemLayout: {
            ...
            },
            {
              ...
              type: 'number',
              initialValue: list?.alterContractSumTax,
              placeholder: '请输入',
              span: 12,
              precision: 6,
              qnnDisabled: true,
          ...
          <QnnForm
            ...
            formConfig={[
              ...
              },
              {
                ...
                required: true,
                disabled: true,
                initialValue: list?.alterContent,
                placeholder: '请输入',
                formItemLayout: {
                  labelCol: {
                    xs: { span: 4 },
              ...
              },
              {
                ...
                initialValue: list?.replenishShopDetailedList || [],
                qnnTableConfig: {
                  antd: {
                    size: "small",
              ...
              },
              {
                ...
                incToForm: true,
                hide: list?.code7 === 'WL' ? false : true,
                initialValue: list?.replenishLeaseDetailedList || [],
                qnnTableConfig: {
                  antd: {
                    size: "small",
                  ...
                  formConfig: [
                    ...
                    },
                    {
                      table: {
                        ...
                        render: (data, rowData) => {
                          if (rowData.changeQty || rowData.changeQty === 0) {
                            return rowData.changeQty.toFixed(6)
                          }
                        }
                      },
                      form: {
