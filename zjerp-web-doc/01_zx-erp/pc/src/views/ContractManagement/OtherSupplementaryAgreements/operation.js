...
class operation extends Component {
    ...
    componentDidMount() {
        ...
        if (workId) {
            this.props.myFetch(apiName, { apiName: 'getZxCtOtherSupplyAgreementDetail', apiType: 'POST', flowId: 'zxCtOtherSupplyAgreementReviewAp', title: title, workId: workId }).then(({ success, message, data }) => {
                if (success) {
                    this.setState({
