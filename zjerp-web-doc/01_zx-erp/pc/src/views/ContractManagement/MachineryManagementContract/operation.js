...
class operation extends Component {
    ...
    componentDidMount() {
        ...
        if (workId) {
            this.props.myFetch(apiName, { apiName: 'getZxCtEqContrApplyDetail', apiType: 'POST', flowId: 'zxCtEqContrApplyId', title: title, workId: workId }).then(({ success, message, data }) => {
                if (success) {
                    this.setState({
