...
import tabByCaiWuXinXi from "./tabByCaiWuXinXi"
...
export default {
    ...
    actionBtns: {
        ...
        otherParams: (obj) => {
            ...
            return {
                ...
                tableField: "ProjectConstructionContractManagement"
            }
        }
    },
    // actionBtns: [
    ...
    //         "type": "primary",
    //         "label": "导出",
    //         "onClick": "bind:exportData::glExportZxGcsgCtContractExcel",
    //     },
    ...
    //              
                ...
                //     "isValidate":"curTab",
                //     "label": "保存",
                //     "fetchConfig": "bind:cbForCWXXFetch",
                //     "hide": "bind:editSaveBtnHideByCaiWuXinXi"
                // }
    //         ]
    //     },
    //     {
    ...
    //         "type": "danger",
    //         "label": "删除",
    //          "willExecute":"bind:delWillExecute",
    //         "fetchConfig": {
    //             "apiName": "batchDeleteUpdateZxGcsgCtContract"
    //         }
    //     },
    //     {
    //         "tableField": "ProjectConstructionContractManagement",
    ...
    formConfig: [
        ...
        },
        {
			...
			table: {
				title: "附件",
				dataIndex: "commonAttachmentList", 
				width: 100,
				align: "center",
				render: (val, rowData) => { 
					if (rowData?.commonAttachmentList?.length || rowData?.docAttachmentList?.length) {
						return <FilesForSupplementaryAgreements dataList={rowData?.commonAttachmentList} ZWFiles={rowData?.docAttachmentList} />;
					} else {
						return "无附件";
					}
				},
