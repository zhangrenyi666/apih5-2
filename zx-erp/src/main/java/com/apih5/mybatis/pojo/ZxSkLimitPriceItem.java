...
public class ZxSkLimitPriceItem extends BasePojo {
    private String id;
    ...
    private String limitPriceAdjustItemID;
    ...
    public String getLimitPriceAdjustItemID() {
        return limitPriceAdjustItemID == null ? "" : limitPriceAdjustItemID.trim();
    }

    public void setLimitPriceAdjustItemID(String limitPriceAdjustItemID) {
        this.limitPriceAdjustItemID = limitPriceAdjustItemID == null ? null : limitPriceAdjustItemID.trim();
    }
