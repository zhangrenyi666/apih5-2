...
public class ZxSkStockTransItemWithdrawal extends BasePojo {
    private String zxSkStockTransItemWithdrawalId;
    ...
    public String getMainIdAndItemId() {
        return mainIdAndItemId;
    }

    public void setMainIdAndItemId(String mainIdAndItemId) {
        this.mainIdAndItemId = mainIdAndItemId;
    }

    public ZxSkStockTransItemWithdrawal() { }

    public ZxSkStockTransItemWithdrawal(String resID, String resCode, String resName, String spec, String resUnit, BigDecimal outQty, BigDecimal outAmt) {
        this.resID = resID;
    ...
    public String getZxSkStockTransItemWithdrawalId() {
        return zxSkStockTransItemWithdrawalId == null ? "" : zxSkStockTransItemWithdrawalId.trim();
    }

    public void setZxSkStockTransItemWithdrawalId(String zxSkStockTransItemWithdrawalId) {
        this.zxSkStockTransItemWithdrawalId = zxSkStockTransItemWithdrawalId == null ? null : zxSkStockTransItemWithdrawalId.trim();
    }
