...
public class ZxSkTtReqPlan extends BasePojo {
    private String id;
    ...
    private List<ZxSkTtReqPlanItem> zxSkTtReqPlanItemList;
    ...
    public List<ZxSkTtReqPlanItem> getZxSkTtReqPlanItemList() {
        return zxSkTtReqPlanItemList;
    }

    public void setZxSkTtReqPlanItemList(List<ZxSkTtReqPlanItem> zxSkTtReqPlanItemList) {
        this.zxSkTtReqPlanItemList = zxSkTtReqPlanItemList;
    }
