...
public class ZxSkStockTransferMaterialRequisition extends BasePojo {
    private String id;
    ...
    private List<ZxSkStockTransItemMaterialRequisition> zxSkStockTransItemMaterialRequisitionList;
    ...
    public List<ZxSkStockTransItemMaterialRequisition> getZxSkStockTransItemMaterialRequisitionList() {
        return zxSkStockTransItemMaterialRequisitionList;
    }

    public void setZxSkStockTransItemMaterialRequisitionList(List<ZxSkStockTransItemMaterialRequisition> zxSkStockTransItemMaterialRequisitionList) {
        this.zxSkStockTransItemMaterialRequisitionList = zxSkStockTransItemMaterialRequisitionList;
    }
