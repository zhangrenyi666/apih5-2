...
public class ZxSkMmReqPlan extends BasePojo {
    ...
    private List<ZxSkMmReqPlanItem> zxSkMmReqPlanItemList;
    ...
    public List<ZxSkMmReqPlanItem> getZxSkMmReqPlanItemList() {
        return zxSkMmReqPlanItemList;
    }

    public void setZxSkMmReqPlanItemList(List<ZxSkMmReqPlanItem> zxSkMmReqPlanItemList) {
        this.zxSkMmReqPlanItemList = zxSkMmReqPlanItemList;
    }
