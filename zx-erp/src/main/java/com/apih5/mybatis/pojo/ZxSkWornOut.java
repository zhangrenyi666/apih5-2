...
public class ZxSkWornOut extends BasePojoFlow {
    // 主键
    private String zxSkWornOutId;
    ...
    private List<ZxSkWornOutItem> zxSkWornOutItemList;

    public List<ZxSkWornOutItem> getZxSkWornOutItemList() {
        return zxSkWornOutItemList;
    }

    public void setZxSkWornOutItemList(List<ZxSkWornOutItem> zxSkWornOutItemList) {
        this.zxSkWornOutItemList = zxSkWornOutItemList;
    }

    public String getZxSkWornOutId() {
        return zxSkWornOutId == null ? "" : zxSkWornOutId.trim();
    }

    public void setZxSkWornOutId(String zxSkWornOutId) {
        this.zxSkWornOutId = zxSkWornOutId == null ? null : zxSkWornOutId.trim();
    }
    ...
    public String getApplyOrgName() {
        return applyOrgName == null ? "" : applyOrgName.trim();
    }
    ...
    public String getApplyOrgID() {
        return applyOrgID == null ? "" : applyOrgID.trim();
    }
