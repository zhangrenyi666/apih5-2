...
public class ZxSkStockTransferInitialReceipt extends BasePojo {
    private String id;
    ...
    private String isSelect;//判断是否选中 0：未选中；1：已选中（物资合同结算）

    private String contractID;//合同ID（物资合同结算）

    private String zxCtSuppliesShopSettlementId;//结算单ID（物资合同结算）

    private List<ZxSkStockTransItemInitialReceipt> zxSkStockTransItemInitialReceiptList;
    ...
    public List<ZxSkStockTransItemInitialReceipt> getZxSkStockTransItemInitialReceiptList() {
        return zxSkStockTransItemInitialReceiptList;
    }

    public void setZxSkStockTransItemInitialReceiptList(List<ZxSkStockTransItemInitialReceipt> zxSkStockTransItemInitialReceiptList) {
        this.zxSkStockTransItemInitialReceiptList = zxSkStockTransItemInitialReceiptList;
    }
