...
public class ZxGcsgCcWorks extends BasePojo {
	// 主键
	...
	// 业主合同清单编号
	private String yzWorkNo;

	// 业主合同清单名称
	private String yzWorkName;
	...
	public String getYzWorkNo() {
		return yzWorkNo == null ? "" : yzWorkNo.trim();
	}

	public void setYzWorkNo(String yzWorkNo) {
		this.yzWorkNo = yzWorkNo == null ? null : yzWorkNo.trim();
	}

	public String getYzWorkName() {
		return yzWorkName == null ? "" : yzWorkName.trim();
	}

	public void setYzWorkName(String yzWorkName) {
		this.yzWorkName = yzWorkName == null ? null : yzWorkName.trim();
	}
