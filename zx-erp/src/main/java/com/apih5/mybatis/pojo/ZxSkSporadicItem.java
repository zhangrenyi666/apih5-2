...
public class ZxSkSporadicItem extends BasePojo {
    private String id;

    private String sporadicID;
    ...
    public String getSporadicID() {
        return sporadicID == null ? "" : sporadicID.trim();
    }

    public void setSporadicID(String sporadicID) {
        this.sporadicID = sporadicID == null ? null : sporadicID.trim();
    }
