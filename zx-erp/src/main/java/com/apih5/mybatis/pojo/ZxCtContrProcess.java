...
public class ZxCtContrProcess extends BasePojo {
	private String id;
	...
	private List<ZxCtContrProcess> childrenList;

	private List<ZxCtContrProcess> children;
	...
	public List<ZxCtContrProcess> getChildrenList() {
		return childrenList;
	}

	public void setChildrenList(List<ZxCtContrProcess> childrenList) {
		this.childrenList = childrenList;
	}

	public List<ZxCtContrProcess> getChildren() {
		return children;
	}

	public void setChildren(List<ZxCtContrProcess> children) {
