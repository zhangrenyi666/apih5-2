...
public class ZxSkStockTransItemMaterialRequisition extends BasePojo {
    private String id;
    ...
    private String joinCodePrice;

    private BigDecimal oldOutQty;
    ...
    public ZxSkStockTransItemMaterialRequisition() { }

    public ZxSkStockTransItemMaterialRequisition(String resID, String resCode, String resName, String spec, String resUnit, BigDecimal stdPrice, BigDecimal outQty, BigDecimal outAmt) {
        this.resID = resID;
    ...
    public BigDecimal getOldOutQty() {
        return oldOutQty;
    }

    public void setOldOutQty(BigDecimal oldOutQty) {
    ...
    public String getJoinCodePrice() {
        return joinCodePrice;
    }

    public void setJoinCodePrice(String joinCodePrice) {
        this.joinCodePrice = joinCodePrice;
    }
