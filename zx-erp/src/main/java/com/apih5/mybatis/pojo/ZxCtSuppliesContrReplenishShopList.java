...
public class ZxCtSuppliesContrReplenishShopList extends BasePojo {
    // 主键
    private String zxCtSuppliesContrReplenishShopListId;
    ...
    public String getZxCtSuppliesContrReplenishShopListId() {
        return zxCtSuppliesContrReplenishShopListId == null ? "" : zxCtSuppliesContrReplenishShopListId.trim();
    }

    public void setZxCtSuppliesContrReplenishShopListId(String zxCtSuppliesContrReplenishShopListId) {
        this.zxCtSuppliesContrReplenishShopListId = zxCtSuppliesContrReplenishShopListId == null ? null : zxCtSuppliesContrReplenishShopListId.trim();
    }
