...
public class ZxEqEquipFactReal extends BasePojo {
    private String id;
    ...
    private List<ZxEqEquipFactRealItem> itemList;
    ...
    public String getFactID() {
        return factID == null ? "" : factID.trim();
    }
    ...
    public List<ZxEqEquipFactRealItem> getItemList() {
        return itemList;
    }

    public void setItemList(List<ZxEqEquipFactRealItem> itemList) {
