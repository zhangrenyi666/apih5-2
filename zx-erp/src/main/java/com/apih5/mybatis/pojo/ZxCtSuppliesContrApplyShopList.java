...
public class ZxCtSuppliesContrApplyShopList extends BasePojo {
    // 主键
    private String applyShopListId;
    ...
    public String getApplyShopListId() {
        return applyShopListId == null ? "" : applyShopListId.trim();
    }

    public void setApplyShopListId(String applyShopListId) {
        this.applyShopListId = applyShopListId == null ? null : applyShopListId.trim();
    }
