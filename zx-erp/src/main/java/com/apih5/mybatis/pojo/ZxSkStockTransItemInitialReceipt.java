...
public class ZxSkStockTransItemInitialReceipt extends BasePojo {
    private String id;
    ...
    public ZxSkStockTransItemInitialReceipt(){};

    public ZxSkStockTransItemInitialReceipt(String resID, String resCode, String resName, String spec, String resUnit, BigDecimal inQty, BigDecimal inAmt) {
        this.resID = resID;
