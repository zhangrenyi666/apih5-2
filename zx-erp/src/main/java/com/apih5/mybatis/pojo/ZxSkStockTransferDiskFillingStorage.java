...
public class ZxSkStockTransferDiskFillingStorage extends BasePojo {
    private String id;
    ...
    private List<ZxSkStockTransItemDiskFillingStorage> zxSkStockTransItemDiskFillingStorageList;
    ...
    public List<ZxSkStockTransItemDiskFillingStorage> getZxSkStockTransItemDiskFillingStorageList() {
        return zxSkStockTransItemDiskFillingStorageList;
    }

    public void setZxSkStockTransItemDiskFillingStorageList(List<ZxSkStockTransItemDiskFillingStorage> zxSkStockTransItemDiskFillingStorageList) {
        this.zxSkStockTransItemDiskFillingStorageList = zxSkStockTransItemDiskFillingStorageList;
    }
