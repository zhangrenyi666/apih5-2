...
public class ZxCtSuppliesContrReplenishLeaseDetail extends BasePojo {
    // 主键
    private String zxCtSuppliesContrReplenishLeaseDetailId;
    ...
    public String getZxCtSuppliesContrReplenishLeaseDetailId() {
        return zxCtSuppliesContrReplenishLeaseDetailId == null ? "" : zxCtSuppliesContrReplenishLeaseDetailId.trim();
    }

    public void setZxCtSuppliesContrReplenishLeaseDetailId(String zxCtSuppliesContrReplenishLeaseDetailId) {
        this.zxCtSuppliesContrReplenishLeaseDetailId = zxCtSuppliesContrReplenishLeaseDetailId == null ? null : zxCtSuppliesContrReplenishLeaseDetailId.trim();
    }
