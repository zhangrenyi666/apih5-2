...
public class ZxSkMonthPurItem extends BasePojo {
    private String id;

    private String monthPurID;
    ...
    public String getMonthPurID() {
        return monthPurID == null ? "" : monthPurID.trim();
    }

    public void setMonthPurID(String monthPurID) {
        this.monthPurID = monthPurID == null ? null : monthPurID.trim();
    }
    ...
    public String getQualityStand() {
        return qualityStand == null ? "" : qualityStand.trim();
    }
