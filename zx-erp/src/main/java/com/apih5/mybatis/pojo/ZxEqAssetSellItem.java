...
public class ZxEqAssetSellItem extends BasePojo {
    private String id;
	...
	public String getBusDateStr() {
		return busDateStr;
	}

	public void setBusDateStr(String busDateStr) {
		this.busDateStr = busDateStr;
	}
