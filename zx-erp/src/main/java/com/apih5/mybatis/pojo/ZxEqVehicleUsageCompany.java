...
public class ZxEqVehicleUsageCompany extends BasePojo {
    // 主键
    private String zxEqVehicleUsageCompanyId;
    ...
    public String getZxEqVehicleUsageCompanyId() {
        return zxEqVehicleUsageCompanyId == null ? "" : zxEqVehicleUsageCompanyId.trim();
    }

    public void setZxEqVehicleUsageCompanyId(String zxEqVehicleUsageCompanyId) {
        this.zxEqVehicleUsageCompanyId = zxEqVehicleUsageCompanyId == null ? null : zxEqVehicleUsageCompanyId.trim();
    }
