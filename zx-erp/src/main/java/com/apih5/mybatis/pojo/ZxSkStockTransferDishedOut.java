...
public class ZxSkStockTransferDishedOut extends BasePojo {
    private String id;
    ...
    private List<ZxSkStockTransItemDishedOut> zxSkStockTransItemDishedOutList;
    ...
    public List<ZxSkStockTransItemDishedOut> getZxSkStockTransItemDishedOutList() {
        return zxSkStockTransItemDishedOutList;
    }

    public void setZxSkStockTransItemDishedOutList(List<ZxSkStockTransItemDishedOut> zxSkStockTransItemDishedOutList) {
        this.zxSkStockTransItemDishedOutList = zxSkStockTransItemDishedOutList;
    }
