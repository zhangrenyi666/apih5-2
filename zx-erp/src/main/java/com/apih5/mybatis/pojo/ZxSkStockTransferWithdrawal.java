...
public class ZxSkStockTransferWithdrawal extends BasePojo {
    private String id;
    ...
    private List<ZxSkStockTransItemWithdrawal> zxSkStockTransItemWithdrawalList;
    ...
    public List<ZxSkStockTransItemWithdrawal> getZxSkStockTransItemWithdrawalList() {
        return zxSkStockTransItemWithdrawalList;
    }

    public void setZxSkStockTransItemWithdrawalList(List<ZxSkStockTransItemWithdrawal> zxSkStockTransItemWithdrawalList) {
        this.zxSkStockTransItemWithdrawalList = zxSkStockTransItemWithdrawalList;
    }
