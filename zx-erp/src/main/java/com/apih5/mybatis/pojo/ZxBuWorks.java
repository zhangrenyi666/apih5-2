...
public class ZxBuWorks extends BasePojo {
    // 主键
    private String zxBuWorksId;
    ...
    public String getZxBuWorksId() {
        return zxBuWorksId == null ? "" : zxBuWorksId.trim();
    }

    public void setZxBuWorksId(String zxBuWorksId) {
        this.zxBuWorksId = zxBuWorksId == null ? null : zxBuWorksId.trim();
    }
