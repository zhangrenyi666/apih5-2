...
public class ZjXmCqjxDisciplineAssessment extends BasePojo {
	...
	private List<ZjXmCqjxDisciplineAssessment> disciplineList;
	...
	public List<ZjXmCqjxDisciplineAssessment> getDisciplineList() {
		return disciplineList;
	}

	public void setDisciplineList(List<ZjXmCqjxDisciplineAssessment> disciplineList) {
	...
	public String getExecutiveLeaderOption() {
		return executiveLeaderOption;
	}

	public void setExecutiveLeaderOption(String executiveLeaderOption) {
		this.executiveLeaderOption = executiveLeaderOption;
	}
