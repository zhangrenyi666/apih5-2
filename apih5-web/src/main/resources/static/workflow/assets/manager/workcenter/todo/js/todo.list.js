...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery', 'horizonTable','horizonFlowtree'], factory);
    }else {
        factory(jQuery);
    }
}(function($) {
    ...
    var _height = {
        ...
        treeHeight: function() {
            var outerHeight = _height.outerHeight() + $('#horizon-modal .widget-box').outerHeight(true);
                ...
                table.mytable = $('#myDatatable').horizonTable({
                    settings: {
                        ...
                        columns: [
                            ...
                            {
                                name : 'sendSubjectionName',
                                title : horizon.lang['todo-common']['columnsSubjection'],
                                width : '100px',
                                columnClass :'center'
                            }
                        ],
                    ...
                    ajaxDataSource: horizon.tools.formatUrl('/workcenter/todo/list')
                });
            },
    ...
    return horizon.engine['todolist'] = {
