...
(function($ , undefined) {
	var Ace_Scroll = function(element , _settings) {
		...
		this.destroy = function() {
            ...
            //add by zhouwf
            this.$element.removeData('ace_scroll');
...
(function($ , undefined) {
	...
	Ace_File_Input.prototype.show_file_list = function($files , inner_call) {
        ...
        //add by zhouwf 添加即时上传  ----- BEGIN
        if(typeof this.settings.upload === 'function') {
            this.settings.upload.call(this.element, this.$element, files);
            return true;
        }
        //add by zhouwf 添加即时上传  ----- END
		//////////////////////////////////////////////////////////////////
