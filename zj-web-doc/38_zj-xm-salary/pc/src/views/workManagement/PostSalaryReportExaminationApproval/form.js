                        ...
                        <Form
                            ...
                            formConfig={
                                [
                                        ...
                                        Component: () => {
                                            return (
                                                <QnnForm
                                                    ...
                                                    //             }
                                                    //         } else {
                                                    //             return { workId: this.state.workId }
                                                    //         }
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            onChange: async (val, obj) => {
                                                                ...
                                                                if (success) {
                                                                    ...
                                                                    // obj.form.setFieldsValue(newData)
                                                                } else {
                                                                    Msg.error(message)
                                    ...
                                    {
                                        field: 'images',
                                        initialValue: flowData?.images,
                                        hide: true,
                                    },
                                    {
                                        field: 'birthday',
                                        type: 'date',
                                        initialValue: flowData?.birthday,
                                        hide: true,
                                    },
                                    {
                                        field: 'userType',
                                        initialValue: flowData?.userType,
                                        hide: true,
                                    },
                                    {
                                        field: 'professionalTitle',
                                        initialValue: flowData?.professionalTitle,
                                        hide: true,
                                    },
                                    {
                                        field: 'major',
                                        initialValue: flowData?.major,
                                        hide: true,
                                    },
                                    {
                                        field: 'graduateDate',
                                        type: 'date',
                                        initialValue: flowData?.graduateDate,
                                        hide: true,
                                    },
                                    {
                                        field: 'graduateSchool',
                                        initialValue: flowData?.graduateSchool,
                                        hide: true,
                                    },
                                    {
                                        field: 'orgName',
                                    ...
                                    {
                                        field: 'position',
                                        initialValue: flowData?.position,
                                        hide: true,
                                    },
                                    {
                                        field: 'levelSalaryId',
                                        initialValue: flowData?.levelSalaryId,
                                        hide: true,
                                    },
                                    {
                                        field: 'positionSalary',
                                        type: 'number',
                                        initialValue: flowData?.positionSalary,
                                        hide: true,
                                    },
                                    {
                                    ...
                                    {
                                        field: 'salaryCompanyApprovalId',
                                        initialValue: flowData?.salaryCompanyApprovalId,
                                        hide: true,
                                    },
                                ]
                            }
