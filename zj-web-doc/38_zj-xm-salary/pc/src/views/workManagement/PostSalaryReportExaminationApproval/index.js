...
import PersonColJson from '../comp/PersonColJson';
                    ...
                    actionBtns={[
                        ...
                        // },
                        {
                            ...
                            Component: (props) => {
                                ...
                                // } else {
                                //     return <div style={{ fontSize: '20px', padding: '10px' }}>{message}</div>
                                // }
                            }
                        },
                        {
                                ...
                                btns: [
                                    {
                                        ...
                                        disabled: (obj) => {
                                            const status = obj.rowData.apih5FlowStatus
                    ...
                    tabs={[
                        {
                            ...
                            content: {
                                ...
                                formConfig: [
                                    ...
                                    {
                                        field: "professionalTitle", //表格的唯一key
                                        label: "职称",
                                        type: "select",
                                        disabled: true,
                                        fetchConfig: {
