...
class index extends Component {
    ...
    componentDidMount() {
        this.props.myFetch('getZjXmJxQuarterlyAssessmentDeptList', { isClosed: '1' }).then(({ success, message, data }) => {
            if (success) {
                this.setState({
                    treeData: [
                        {
    ...
    render() {
        const { rowData, treeData } = this.state;
        return (
            <div className={s.root}>
                ...
                <div className={s.rootr}>
                    {rowData && rowData.deptId ? <QnnTable
                                    {...this.props}
                                    ...
                                    formConfig={[
                                        ...
                                        },
                                        {
                                            ...
                                            form: {
                                                field: 'projectStatus',
                                                type: 'string',
                                                initialValue: rowData.projectStatus,
                                                hide: true,
                                            }
                                        },
                                        {
