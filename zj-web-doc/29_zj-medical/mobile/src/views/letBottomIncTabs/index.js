...
class Tabs extends Component {
    ...
    tabs = [ //底部所有的切换项
        ...
        },
        {
            ...
            key: 'News',
            route: 'News',
            icon: <img className={s.tabsBtn} src={imgs.new} alt="" />,
            selectedIcon: <img className={s.tabsBtn} src={imgs.newed} alt="" />,
            click: () => { },
            style: {}
        },
        {
        ...
        },
        {
            ...
            key: 'AddressBook',
            route: 'AddressBook',
            icon: <img className={s.tabsBtn} src={imgs.addressBook} alt="" />,
            selectedIcon: <img className={s.tabsBtn} src={imgs.addressBooked} alt="" />,
            click: () => { },
            style: {}
        },
        {
