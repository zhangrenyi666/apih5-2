...
class Demo extends Component {
    ...
    loadTree = () => {
        ...
        myFetch("getSysDepartmentAllTree").then(({ success,data }) => {
            Msg.destroy();
            if (success) {
                this.gData = toggleExpandedForAll({
                    treeData: [data],
                    expanded: true,
                });
    ...
    setTreeContainerHeight = () => {
        let tableHeight = document.getElementsByTagName("table")[0]
            .offsetHeight;
    ...
    onSelect = (treeSelectedKeys,{ node }) => {
        ...
        if (
            this.visibleValue !== node.props.eventKey &&
    ...
    render() {
        ...
        //                     ];
        //                     myFetch(
        //                         "batchDeleteUpdateSysDepartment",
        //                         body
                    ...
                    <div className={styles.tree}
                        ...
                        <SortableTree
                            ...
                            onMoveNode={(e) => {
                                        ...
                                        if (item.value === node.value) {
                                            ...
                                            if (treeData.length > 1) {
                                                ...
                                                if (i > 0) {
                                                    ...
                                                    if (before) {
                                                        departmentBefore = before.value;
                                                    }
                                                    if (after) {
                                                        departmentAfter = after.value;
                                                    }
                                                } else {
                                                    //是第一个节点 只能后面有节点
                                                    departmentAfter = treeData[i + 1].value;
                                                }
                                ...
                                let params = {
                                    departmentParent: nextParentNode.value,
                                    departmentToMove: node.value,
                                    departmentAfter: departmentAfter,
                                    departmentBefore: departmentBefore,
                                };
                                // console.log(e);
                                // console.log('params',params);
                                myFetch("moveUpdateSysDepartment",params).then(
                                    ({ success,code,message,data }) => {
                                        if (!success) {
                                            Msg.error(message,1.2,() => {
                                                this.loadTree();
                    ...
                    {(() => {
                        ...
                        switch (rState) {
                            case "3": //新增
                                let _dataSource = {
                                    sysDepartmentList: [
                                        this.initSimpleData(this.gData)[
                                        this.endKey
                                        ]
                                ...
                                <Upload
                                    ...
                                    headers={{
                                        token: this.props.loginAndLogoutInfo
                                            ? this.props.loginAndLogoutInfo
                                                .loginInfo.token
                                            : ""
                                    }}
                                    action={
                                        this.props.myPublic.domain + "upload"
                                    }
                                >
                    ...
                    _item = (
                        ...
                        >
                            {getFieldDecorator(dataIndex,{
                                ...
                                <Upload.Dragger
                                    disabled={
                                        fileList.length >= maxLen ? true : false
                                    }
                                    name={"name"}
                                    headers={{
                                        token: this.props.loginAndLogoutInfo
    ...
    render() {
        ...
        return (
            <div className={styles.nestedTable}>
                <div className={styles.nestedTableTop}>
                    <div
                        style={{
