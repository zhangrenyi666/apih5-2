        ...
        const formList = columns.map((item,index) => {
            ...
            switch (type) {
                case "PullPersion":
                    ...
                    _item = (
                        // label={label} 
                        <FormItem key={index} {...formItemLayout}>
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                <Tabs defaultActiveKey="0" onChange={(key) => {
                    this.handle({ rState: key });
                }}>
                    <TabPane tab="人员选择" key="0">
                    </TabPane>
                    <TabPane tab="菜单选择" key="1">
                    </TabPane>
                </Tabs>
                ...
                <Button htmlType="submit" type="primary">{"保存人员修改"}</Button>
            </Form>
        );
    }
}
...
class MenuEdit extends Component {
    ...
    render() {
        ...
        const formList = columns.map((item,index) => {
            const { dataIndex,type,treeData } = item; //label,
            let _item;
            switch (type) {
                case "Menu":
                    _item = (
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                <div style={{ maxHeight: "65vh",overflowY: 'scroll',marginBottom:'30px' }}>
                    {formList}
                </div>

                <Button htmlType="submit" type="primary">{"保存菜单修改"}</Button>
