...
class PullPersionMobile extends Component {
    ...
    componentWillReceiveProps(newProps) {
        ...
        this.defaultValue = newProps.defaultValue
            ...
            const oFetchConfig = preProps.fetchConfig;
            const { fetchConfig } = newProps;
            if (
    ...
    render() {
        ...
        let listConStyle = this.props.listConStyle || {};
        //渲染列表
        const renderList = (
            <div>
                {
