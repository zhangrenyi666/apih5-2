...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onAdd: function (obj, _params) {
        l.ajax("zjXmCqjxProjectExecutiveAssistantLaunch", _params, function (_d, _m, _s) {
            if (_s) {
...
$("body").on("click", "button", function () {
    ...
    switch (name) {
        ...
        case "del":
            ...
            break;
        // case "submit":
        //     l.ajax("zjXmCqjxProjectExecutiveAssistantLaunch", { executiveId: id, assessmentType: assessmentType }, function (_d, _m, _s) {
        //         if (_s) {
        //             layer.alert(_m, { icon: 1, }, function (index) {
        //                 parent.pager.page('remote');
        //                 parent.layer.close(parent.myOpenLayerJH);
        ...
        case "submit":
            if(assessmentState === "2"){
                l.ajax("zjXmCqjxProjectExecutiveAssistantLaunch", { executiveId: id, assessmentType: assessmentType,assessmentState:assessmentState }, function (_d, _m, _s) {
                    if (_s) {
                        layer.alert(_m, { icon: 1, }, function (index) {
                            parent.pager.page('remote');
                            parent.layer.close(parent.myOpenLayerJH);
