    ...
    "columnDefs": [
        ...
        },
        {
            ...
            "render": function (data, index, row) {
                return '<a style="color:blue;" onclick="myOpenAdd(\'工作计划详情\',\'' + row.executiveId + '\',\'' + row.assessmentTitle + '\',\'' + row.position + '\',\'' + row.departmentName + '\',\'' + row.chargeLeaderOption + '\',\'' + row.executiveLeaderOption + '\',\'' + 'detail' + '\',\'' + 'DepartmentChiefPerson' + '\',\'' + row.managerId + '\',\'' + row.createUser + '\')">' + data + '</a>'
            }
        },
        {
            "targets": [3],
...
var pager = $("#pager").page({
    remote: {//ajax请求配置
        url: l.getApiUrl("getZjXmCqjxProjectDeptLeaderAssistantList"),
        params: {
            assessmentType:"2"
        },
        ...
        case "add":
            if (checkedData.length == 1) {
                if (checkedData[0].assessmentState === '0' || checkedData[0].assessmentState === '2') {
                    myOpenAdd('工作计划填报', checkedData[0].executiveId, checkedData[0].assessmentTitle, checkedData[0].position, checkedData[0].departmentName, checkedData[0].chargeLeaderOption, checkedData[0].executiveLeaderOption, 'add', 'DepartmentChiefPerson',checkedData[0].managerId,checkedData[0].createUser);
                } else {
                    ...
                    if (checkedData[0].assessmentState === '0' || checkedData[0].assessmentState === '2') {
                        l.ajax("checkZjXmCqjxProjectExecutiveAssistantLaunch",checkedData[0],function (_d, _m, _s) {
                            if(_s){
                                ...
                                myOpenJH('计划流程发起', checkedData[0].executiveId, checkedData[0].assessmentTitle, checkedData[0].position, checkedData[0].departmentName, checkedData[0].assessmentType,checkedData[0].assessmentState,'add', 'DepartmentChiefPersonJH');
                            }
                        })
