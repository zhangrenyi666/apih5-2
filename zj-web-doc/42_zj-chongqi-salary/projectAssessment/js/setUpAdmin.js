...
var pager = $("#pager").page({
    remote: {// ajax请求配置
        url: l.getApiUrl("getZjXmCqjxProjectSetupAdminList"),
        params: {
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onSave: function (obj, _params) {
        l.ajax('addZjXmCqjxProjectSetupAdmin', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    },
    ...
    switch (name) {
        ...
        case "del":
            if (checkedData.length == 0) {
				...
				l.ajax("batchDeleteUpdateZjXmCqjxProjectSetupAdmin", checkedData, function () {
					pager.page('remote')
				})
				layer.close(index);
            });
