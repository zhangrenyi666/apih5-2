...
var param = {
    ...
    assistantLeaderApprovalId:assistantLeaderApprovalId
}
                ...
                if (success) {
                    if (state === '3') {
                        ...
                        if (state === "4") {
                            ...
                            l.ajax("getZjXmCqjxProjectLeaderApprovalAllList", { executiveId: id, assessmentType: assessmentType, assessmentState:state}, function (data, message, success) {
                                if (success) {
                                    if (data.length && data.length === 1) {
                                        ...
                                        param.chargeLeaderOption = rowData.chargeLeaderOption;
...
function myblur(rowData, type, value) {
    ...
    if (type === 'assessmentScore') {
        if (rowData.assessmentScore !== parseFloat(value.val())) {
            rowData.assessmentScore = parseFloat(value.val());
