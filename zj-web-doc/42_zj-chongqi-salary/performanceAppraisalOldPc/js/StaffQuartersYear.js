    ...
    "columnDefs": [
        ...
        },
        {
            ...
            "render": function (data, index, row) {
                return '<a style="color:blue;" onclick="myOpenAdd(\'工作计划详情\',\'' + row.executiveId + '\',\'' + row.assessmentTitle + '\',\'' + row.position + '\',\'' + row.departmentName + '\',\'' + row.chargeLeaderOption + '\',\'' + row.executiveLeaderOption + '\',\'' + row.haveChangerLeader + '\',\'' + 'detail' + '\',\'' + 'StaffQuartersPerson' + '\')">' + data + '</a>'
            }
        },
        {
            "targets": [3],
