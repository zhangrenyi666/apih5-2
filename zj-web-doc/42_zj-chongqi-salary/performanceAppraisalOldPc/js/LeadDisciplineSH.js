...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onAdd: function (obj, _params) {
        ...
        l.ajax("zjXmCqjxDisciplineAssessmentDeptApproval", _params, function (_d, _m, _s) {
            if (_s) {
    ...
    switch (name) {
        case "submit":
                    if (state === '3') {
                        ...
                        l.ajax("zjXmCqjxDisciplineAssessmentDeptApproval", rowData, function (_d, _m, _s) {
                            if (_s) {
                                layer.alert(_m, { icon: 1, }, function (index) {
                                    parent.pager.page('remote');
                        ...
                        l.ajax("zjXmCqjxDisciplineAssessmentExecutiveApproval", rowData, function (_d, _m, _s) {
                            if (_s) {
                                layer.alert(_m, { icon: 1, }, function (index) {
                                    parent.pager.page('remote');
                                    parent.layer.close(parent.myOpenLayerSH);
        ...
        case "sendBack":
            if (state === '3') {
                ...
                l.ajax("zjXmCqjxDisciplineAssessmentDeptApproval", rowData, function (data, message, success) {
                    if (success) {
                        parent.pager.page('remote');
                ...
                l.ajax("zjXmCqjxDisciplineAssessmentExecutiveApproval", rowData, function (data, message, success) {
                    if (success) {
                        parent.pager.page('remote');
                        layer.alert(message, { icon: 1 }, function (index) {
                            parent.layer.close(parent.myOpenLayerSH);
