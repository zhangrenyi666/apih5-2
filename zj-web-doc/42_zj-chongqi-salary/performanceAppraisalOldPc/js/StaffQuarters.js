    ...
    "columnDefs": [
        ...
        },
        {
            ...
            "render": function (data, index, row) {
                return '<a style="color:blue;" onclick="myOpenDetail(\'工作计划详情\',\'' + row.assistantFlag + '\',\'' + row.executiveId + '\',\'' + row.assessmentTitle + '\',\'' + row.position + '\',\'' + row.departmentName + '\',\'' + row.chargeLeaderOption + '\',\'' + row.executiveLeaderOption + '\',\'' + row.haveChangerLeader + '\',\'' + 'detail' + '\',\'' + 'StaffQuartersPerson' + '\',\'' + row.assessmentYears + '\',\'' + row.quarterAverageScore + '\',\'' + row.yearFinalScore + '\')">' + data + '</a>'
            }
        },
        {
            "targets": [3],
...
var pager = $("#pager").page({
    remote: {//ajax请求配置
        url: l.getApiUrl("getZjXmCqjxStaffAssistantList"),
        params: {
            assessmentType:"3"
        },
...
var myOpenLayer;
function myOpenDetail(title,falg, id, biaoti, gangwei, bumen, chargeLeaderOption, executiveLeaderOption, haveChangerLeader,submitType, url,assessmentYears,quarterAverageScore,yearFinalScore) {
    ...
    var options = {
        ...
        closeBtn:false,
        area: ['100%', '100%'],
        content: url + ".html?code=" + code + '&id=' + id + '&biaoti=' + biaoti + '&gangwei=' + gangwei + '&bumen=' + bumen + '&chargeLeaderOption=' + chargeLeaderOption + '&executiveLeaderOption=' + executiveLeaderOption + '&submitType=' + submitType + '&haveChangerLeader=' + haveChangerLeader + '&assessmentYears=' + assessmentYears+ '&quarterAverageScore=' + quarterAverageScore+ '&yearFinalScore=' + yearFinalScore
    };
    myOpenLayer = layer.open(options);
}
function myOpenAdd(title, id, biaoti, gangwei, bumen, chargeLeaderOption, executiveLeaderOption, haveChangerLeader,submitType, url) {
    var chargeLeaderOption = chargeLeaderOption.replace(/<br>/g,"\r\n");
    var executiveLeaderOption = executiveLeaderOption.replace(/<br>/g,"\r\n");
    chargeLeaderOption = encodeURI(chargeLeaderOption);
    executiveLeaderOption = encodeURI(executiveLeaderOption);
    var options = {
        ...
        closeBtn:false,
        area: ['100%', '100%'],
        content: url + ".html?code=" + code + '&id=' + id + '&biaoti=' + biaoti + '&gangwei=' + gangwei + '&bumen=' + bumen + '&chargeLeaderOption=' + chargeLeaderOption + '&executiveLeaderOption=' + executiveLeaderOption + '&submitType=' + submitType + '&haveChangerLeader=' + haveChangerLeader
    };
    myOpenLayer = layer.open(options);
}
var myOpenLayerJH;
