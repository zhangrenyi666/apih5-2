...
var selectDataList = [
    {
        value:new Date(((new Date().getFullYear() - 2) + '/' + (new Date().getMonth() + 1) + '/' + new Date().getDay())).getTime(),
        text:(new Date().getFullYear() - 2).toString()
    },
    {
        value:new Date(((new Date().getFullYear() - 1) + '/' + (new Date().getMonth() + 1) + '/' + new Date().getDay())).getTime(),
        text:(new Date().getFullYear() - 1).toString()
    },
    {
        value:new Date(((new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + new Date().getDay())).getTime(),
    ...
    {
        value:new Date(((new Date().getFullYear() + 3) + '/' + (new Date().getMonth() + 1) + '/' + new Date().getDay())).getTime(),
    ...
    "columnDefs": [//表格列配置
        ...
        },
        {
            ...
            "render": function (data, _, rowData) {
                var html = '<a style="color:blue;" onclick="myOpen(\'考核详情\',\'' + encodeURI(JSON.stringify(rowData)) + '\',\'' + 'deptHeaderDetail' + '\')">' + data + '</a>';
                return html;
            }
        },
        {
...
var pager = $("#pager").page({
    remote: {//ajax请求配置
        url: l.getApiUrl("getZjXmCqjxAssessmentManageListByDeptHeader"),
        params: {
			// sarsType:"1"
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    conditions: [
        ...
        },
        {
            ...
            label: "年度",
            placeholder: "请选择",
            defaultValue:new Date(((new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + new Date().getDay())).getTime(),
