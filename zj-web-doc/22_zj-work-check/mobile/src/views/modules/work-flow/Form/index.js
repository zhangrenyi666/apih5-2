...
import $ from "jquery";
import Inspect from "../../../FlowByJDJH/Table";
import Execute from "../../../FlowByZXQK/Achieve";
        ...
        >
          ...
          {workId === "add" ? (
            ...
            >
              ...
              {
                this.props.flowId === "yearSupPlan" ? <TabPane tab="检查项" key="3">
                  <Inspect {...this.state.apiData} {...this.props} />
                </TabPane> : null
              }
               {
                this.props.flowId === "yearSupPlanExecutive" ? <TabPane tab="完成情况填写" key="4">
                  <Execute {...this.state.apiData} {...this.props} />
                </TabPane> : null
              }
              {renderFlowHistory}
            </Tabs>
