var flowId = l.getUrlParam('flowId') || "jointSupCheckIssue";//流程模版id
				...
				btns: type === 'detail' ? [] : [
				                                ...
				                                callback: function (dataName, obj) {
				                                	...
				                                	case 'add':
				                                		...
				                                		var apiName = checkIssueId ? 'updateZjLhddJointSupCheckIssue' : 'addZjLhddJointSupCheckIssue';
				                                		l.ajax(apiName, body, function (data, message, success) {
				                                			if (success) {
				                                				checkIssueId = data.checkIssueId;
