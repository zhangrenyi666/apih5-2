...
const config = {
	fetchConfig: {//表格的ajax配置
		apiName: 'getZjQuestionLevelList',
	...
	actionBtns: [
        ...
        },
        {
            ...
            label: '删除',
            fetchConfig: {//ajax配置
                apiName: 'batchDeleteUpdateZjQuestionLevel',
            },
        }
    ],
	formConfig: [
		...
		},
		{
			table: {
				title: '问题等级名称', //表头标题
				dataIndex: 'questionName', //表格里面的字段
				key: 'questionName',//表格的唯一key  
				onClick: "edit",
				btns:[
					{
						name: 'cancel', //关闭右边抽屉
