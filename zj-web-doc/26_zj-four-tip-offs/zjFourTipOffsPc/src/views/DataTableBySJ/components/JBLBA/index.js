...
class JBLBA extends Component {
    ...
    refresh = () => {
        ...
        myFetch('getAqyhReportDataStatistics', {type:'0',startDate,endDate}).then(({ data, success, message }) => {
            if (success) {
                this.setState({
                    data,
                    loading:false
            ...
            series: [
                {
                    ...
                    type: 'bar',
                    stack: 'aq',
                    data: data && data[0] ? [Number(data[0].reportTypeTotalNum)] : [],
                    itemStyle: {
                        color: '#1890ff'
                    }
                },
                {
                    ...
                    type: 'bar',
                    stack: 'aqs',
                    data: data && data[1] ? [Number(data[1].reportTypeTotalNum)] : [],
                    itemStyle: {
                        color: '#10cf9b'
                    }
                }
