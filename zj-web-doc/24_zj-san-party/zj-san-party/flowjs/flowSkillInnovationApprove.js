var flowId = l.getUrlParam('id') || "sanDjSkill";//流程模版id
		    	   ...
		    	   conditions: [
		    	                ...
		    	                },															
								{
		    	                	...
		    	                	children: {
		    	                		...
		    	                		placeholder: '请选择',
		    	                		ajax: {
		    	                			api: "getZjSanDjGradeStandardList4",
		    	                			valueName: "recordId",
		    	                			textName: "scoreName",
				       ...
				       callback: function (dataName, obj) {
				    	   ...
				    	   case "launch":
				    		   ...
				    		   for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
				    			   ...
				    			   //add by lny on 717
				    			   body["apiName"] = "addZjSanDjFlowSkillInnovation"//新增
				    				   //add by lny on 717
				    		   }
				    		   //流程发起特殊代码---开始
				    					   ...
				    					   loadFlow(_d.flowButtons, {
				    						   otherBody: {
				    							 title: body["title"],
				    							   ...
				    							   apiName: "updateZjSanDjFlowSkillInnovation",
