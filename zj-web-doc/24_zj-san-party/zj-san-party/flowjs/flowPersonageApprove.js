var flowId = l.getUrlParam('id') || "sanDjBusiness";//流程模版id
		...
		tabs: [
		       {
		    	   ...
		    	   type: "1",
		    	   isMain: "1",
		    	   tbName: "zjSanDjFlowPersonage",
		    	   tbIdName: "personageId",
		    	   conditions: [
		    	                {
		    	                ...
		    	                },										
		    	                {
		    	                	...
		    	                	children: {
		    	                		...
		    	                		placeholder: '请选择',
		    	                		ajax: {
		    	                			api: "getZjSanDjGradeStandardList1",
		    	                			valueName: "recordId",
		    	                			textName: "scoreName",
		    	                		...
		    	                		children: {
		    	                			...
		    	                			children: {
		    	                				...
		    	                				immutableAdd: true,  
		    	                				ajax: {
		    	                					api: "getZjSanDjGradeStandardSelectAllListThree",
		    	                					valueName: "recordId",
		    	                					textName: "scope",
				       ...
				       callback: function (dataName, obj) {
				    	   ...
				    	   case "launch":
				    		   ...
				    		   for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
				    			   ...
				    			   //add by lny on 717
				    			   body["apiName"] = "addZjSanDjFlowPersonage"//新增
				    				   //add by lny on 717
				    		   }
				    		   //流程发起特殊代码---开始
				    					   ...
				    					   loadFlow(_d.flowButtons, {
				    						   otherBody: {
												   title: body["title"],
													...
													apiName: "updateZjSanDjFlowPersonageAuditor",
