var flowId = l.getUrlParam('id') || "sanDjQcComprehensive";//流程模版id
...
$tabTitle.html("综合评价奖励申请")

switch (flowId) {
	case "sanDjQcComprehensive":
			...
			tabs: [
				{
					...
					type: "1",
					isMain: "1",
					tbName: "zjSanDjFlowComprehensive",
					tbIdName: "comprehensiveId",
					conditions: [
						{
							type: "hidden",//五种形式：text,select,date,hidden,textarea,
							name: "comprehensiveId",//输入字段名
						},
						{
							type: "text",//
							name: "proName",//
						...
						},					
						{
							...
							children: {
								...
								placeholder: '请选择',
								ajax: {
									api: "getZjSanDjGradeStandardList15",
									valueName: "recordId",
									textName: "scoreName",
				...
				switch (dataName) {
					case "launch":
						...
						for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
							...
							//add by lny on 717
							body["apiName"] = "addZjSanDjFlowComprehensive"//新增
							//add by lny on 717
						}
						//流程发起特殊代码---开始
								...
								if (_s) {//发起成功，返回workId
									loadFlow(_d.flowButtons, {
										otherBody: {
											...
											apiName: "updateZjSanDjFlowComprehensive",
