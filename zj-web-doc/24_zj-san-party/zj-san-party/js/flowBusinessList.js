...
var pager = $("#pager").page({
	remote: {//ajax请求配置
		url: l.getApiUrl("getZjSanDjFlowBusinessList"),
		params: {
...
$("body").on("click", "button", function () {
	...
	switch (name) {
	case "add":
		myOpen('业务评价奖励申请流程发起','','flowBusinessApprove')
		break;	
	case "del":
...
function myOpen1(index, type) {
	...
	case 'xq':
		params = {};
		params.businessId = rowData.businessId;
		l.ajax('getZjSanDjFlowBusinessDetail',params,function(res){
