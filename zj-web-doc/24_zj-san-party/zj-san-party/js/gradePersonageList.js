    ...
    "columnDefs": [//表格列配置
        ...
        },
		{
            ...
            "render": function (data) {
                ...
                html += '<a style="color:blue;" href="javascript:void(0);" onclick="myOpen(\'添加类别\',\'' + data.recordId + '\',\'' + data.scoreName + '\',\'' + 'gradePersonageTwoList' + '\')">添加类别</a>';
                html += '</ul></span>'
                return html;
            }
        }
...
var leading = $('#leading').detailLayer({
    ...
    onAdd: function (obj, _params){
        ...
        l.ajax('importZjSanDjGradeStandard', {"importFileList":_params.importFileList}, function (_params) {
            pager.page('remote')
            obj.close()
        })
    }
