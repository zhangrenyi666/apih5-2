        ...
        },
       {
        ...
        },
		{
            ...
            "render": function (data) {
                ...
                html += '<a style="color:blue;" href="javascript:void(0);" onclick="myOpen(\'添加奖励范围\',\'' + data.recordId + '\',\'' + data.scoreName + '\',\'' + data.className + '\',\'' + 'gradeSkillStandardThreeList' + '\')">添加奖励范围</a>';
                html += '</ul></span>'
                return html;
            }
        }
...
var detailLayer = $('#detailLayer').detailLayer({
    conditions: [
        ...
        },
		{
			...
			defaultValue:"JSBZ9-1",
        }, 		
		{
            type: "hidden",//五种形式：text,select,date,hidden,textarea,
            name: "gradeTypeName",//输入字段名
			defaultValue:"施工工法、技术标准奖励子集",
        }, 
		{
            type: "text",//
            name: "pName",//
