    ...
    "columnDefs": [//表格列配置
        ...
        },
		{
            ...
            "render": function (data) {
                ...
                html += '<a style="color:blue;" href="javascript:void(0);" onclick="myOpen(\'添加类别\',\'' + data.recordId + '\',\'' + data.scoreName + '\',\'' + 'gradeSkillInnovationTwoList' + '\')">添加类别</a>';
                html += '</ul></span>'
                return html;
            }
        }
...
var pager = $("#pager").page({
    remote: {//ajax请求配置
        url: l.getApiUrl("getZjSanDjGradeStandardList"),
        params: {
		gradeType:"JSCX4"
        },
...
var leading = $('#leading').detailLayer({
    ...
    onAdd: function (obj, _params){
        ...
        l.ajax('importZjSanDjGradeStandardForThree', {"importFileList":_params.importFileList}, function (_params) {
            pager.page('remote')
            obj.close()
        })
    }
