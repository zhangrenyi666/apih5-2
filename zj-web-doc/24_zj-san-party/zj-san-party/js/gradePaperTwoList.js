        ...
        },
       {
        ...
        },
		{
            ...
            "render": function (data) {
                ...
                html += '<a style="color:blue;" href="javascript:void(0);" onclick="myOpen(\'添加奖励范围\',\'' + data.recordId + '\',\'' + data.scoreName + '\',\'' + data.className + '\',\'' + 'gradePaperThreeList' + '\')">添加奖励范围</a>';
                html += '</ul></span>'
                return html;
            }
        }
