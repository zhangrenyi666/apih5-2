...
// 移动端首页（非移动端请删除 --删除结束）
// 服务指南
import serviceInformation from "./serviceInformation/index";
import serviceInformationList from "./serviceInformation/projectList";
import serviceInformationDetail from './serviceInformation/detail'
...
const pageComs = {
    ...
    serviceInformation:{
        mustLogin:true,
        Com:serviceInformation
    },
    serviceInformationDetail:{
        mustLogin:true,
        Com:serviceInformationDetail
    }
};
...
const routerInfo = [
    {
        ...
        children: [
            ...
            {
                label: "服务指南",
                defaultPath: "serviceInformation",
                pathName: "serviceInformation",
                comKey: "serviceInformation"
            },
            {
                label: "服务指南详情",
                defaultPath: "serviceInformationDetail/0/0",
                pathName: "serviceInformationDetail/:updateApiname/:keyData",
                comKey: "serviceInformationDetail"
            },
        ]
    },
    {
...
const actions = {
    saveNodes(allNode) {
        return { type: "saveNode", node: allNode };
    },
};
const sagas = [];
const MyViews = {
