...
const configs = {
    fetchConfig: {//表格的ajax配置
        apiName: 'getZjXmServerProjectOperationList',
    },
    antd: { //同步antd table组件配置 ***必传
        rowKey: function (row) {// ***必传
            return row.projectOperationId
        },
        size: 'small'
    },
    drawerConfig: {
    ...
    actionBtns: [
        {
            ...
            formBtns: [
                ...
                },
                {
                    ...
                    fetchConfig: {//ajax配置
                        apiName: 'addZjXmServerProjectOperation',
                    }
                }
            ]
        },
        {
            ...
            label: '删除',
            fetchConfig: {//ajax配置
                apiName: 'batchDeleteUpdateZjXmServerProjectOperation',
            },
        }
    ],
    formConfig: [
                ...
                btns: [
                    {
                        ...
                        formBtns: [
                            ...
                            },
                            {
                                ...
                                label: '提交',//提交数据并且关闭右边抽屉 
                                fetchConfig: {//ajax配置
                                    apiName: 'updateZjXmServerProjectOperation',
                                }
                            }
                        ]
                    }
