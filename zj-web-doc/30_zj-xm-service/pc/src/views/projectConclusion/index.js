...
const configs = {
    fetchConfig: {//表格的ajax配置
        apiName: 'getZjXmServerProjectConclusionList',
    },
    antd: { //同步antd table组件配置 ***必传
        rowKey: function (row) {// ***必传
            return row.projectConclusionId
        },
        size: 'small'
    },
    drawerConfig: {
    ...
    actionBtns: [
        {
            ...
            formBtns: [
                ...
                },
                {
                    ...
                    fetchConfig: {//ajax配置
                        apiName: 'addZjXmServerProjectConclusion',
                    }
                }
            ]
        },
        {
            ...
            label: '删除',
            fetchConfig: {//ajax配置
                apiName: 'batchDeleteUpdateZjXmServerProjectConclusion',
            },
        }
    ],
    formConfig: [
                ...
                btns: [
                    {
                        ...
                        formBtns: [
                            ...
                            },
                            {
                                ...
                                label: '提交',//提交数据并且关闭右边抽屉 
                                fetchConfig: {//ajax配置
                                    apiName: 'updateZjXmServerProjectConclusion',
                                }
                            }
                        ]
                    }
