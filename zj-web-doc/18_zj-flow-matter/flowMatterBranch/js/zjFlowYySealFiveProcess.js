    ...
    tabs: [
        {
            ...
            isMain: "1",//是否为主表
            tbName: "zjFlowYySealFive",//表名
            tbIdName: "sealFiveId",//表主键id
            conditions: [
                {
                    type: "hidden",//
                    name: "sealFiveId",//
...
var _body = {
    ...
    workId: workId,
    flowId: flowId,
    apiName: "getZjFlowYySealFiveDetail",
    ...
    if (_s) {
        loadFlow(_d.flowButtons, {
            otherBody: {
                ...
                apiName: "updateZjFlowYySealFive"
            },
            submitFn: function () {
                ...
                $.each(workFormJson.tabs, function (i, tabItem) {
                    ...
                    //操作历史end
                        ...
                        if (tabItem.isMain) {
                            ...
                            if (_d.flowNode != null) {
                                if (_d.flowNode.nodeName == "申请人" || _d.flowNode.nodeName == "结束" || _d.flowNode.nodeName == "结束1") {
                                    btns.push({
                                        name: "export",
                                        label: "导出"
                                    })
                                ...
                                callback: function (dataName, obj) {
                                    switch (dataName) {
                                        case "export"://导出
                                            ...
                                            window.location.href = 'http://weixin.fheb.cn:91/ureport/word?_u=file:zjSealFive.xml&url=' + l.domain + '&workId=' + params.workId;
                                            break;
                                        case "cancel":
                                            obj.close();
                                            break;
