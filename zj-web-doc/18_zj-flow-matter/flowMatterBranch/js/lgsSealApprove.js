var flowId = l.getUrlParam('id') || "lgsYongYin";//流程模版id
var flowIdAdd = l.getUrlParam('flowId') || "lgsYongYin";//流程模版id
                    ...
                    case "launch":
                        ...
                        for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
                            ...
                            if (tabItemj.isMain) {//如果是主表
                                ...
                                body["title"] = tabObjDatas.data['applyUserId'] + '  ' + formatDate + '  六公司用印申请';
