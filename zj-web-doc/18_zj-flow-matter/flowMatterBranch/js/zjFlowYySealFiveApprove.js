var flowId = l.getUrlParam('id') || "wgsYongYin";//流程模版id
                    ...
                    case "launch":
                        ...
                        for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
                            ...
                            if (tabItemj.isMain) {//如果是主表
                                ...
                                body["title"] = tabObjDatas.data['applyUserName'] + '  ' + formatDate + '  5公司用印申请';
                            ...
                            body["apiName"] = "addZjFlowYySealFive"//购置申请发起时调用
                        }
                        //流程发起特殊代码---开始
