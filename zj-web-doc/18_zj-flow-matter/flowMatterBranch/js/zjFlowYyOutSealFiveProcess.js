...
var _body = {
    ...
    workId: workId,
    flowId: flowId,
    apiName: "getZjFlowYyOutSealFiveDetail",
                ...
                $.each(workFormJson.tabs, function (i, tabItem) {
                    ...
                    //操作历史end
                        ...
                        if (tabItem.isMain) {
                            ...
                            if (_d.flowNode != null) {
                                if (_d.flowNode.nodeName == "经办人发起" || _d.flowNode.nodeName == "结束" || _d.flowNode.nodeName == "结束1") {
                                    btns.push({
                                        name: "export",
                                        label: "导出"
                                    })
                                ...
                                callback: function (dataName, obj) {
                                    switch (dataName) {
                                        case "export"://导出
                                            ...
                                            window.location.href = 'http://weixin.fheb.cn:91/ureport/word?_u=file:zjOutSealFive.xml&url=' + l.domain + '&workId=' + params.workId;
                                            break;
                                        case "cancel":
                                            obj.close();
                                            break;
