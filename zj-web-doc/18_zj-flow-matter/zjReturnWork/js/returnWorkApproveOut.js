var flowId = "hwfgApplyOut";
var sarsId = l.getUrlParam('sarsId');
...
l.ajax("getZjHwSarsDetails",{ sarsId: sarsId },function (data,message,success) {
    if (data) {
                    ...
                    tabs: [
                        {
                            ...
                            isMain: "1",//是否为主表
                            tbName: "hwfgApplyOut",//表名
                            tbIdName: "sarsId",//表主键id
                            conditions: [
                                {
                                    type: "hidden",//
                                    name: "sarsId",//
                                ...
                                {
                                    type: "text",//
                                    defaultValue:data.applyCompanyName,
                                ...
                                },
								{
									...
									label: "去往项目名称",//
									defaultValue:data.applyProjectName,
									placeholder: "请输入",
									must: true
								},
								{
									...
									label: "协助单位名称",//
									defaultValue:data.cooperationName,
									placeholder: "请输入",
									must: true
								}
                               /*  {
                                    type: "textarea",// 
                                    "name": "opinionField1",//接口对应字段
                                    "label": "外事管理处意见",//表头名
                                    placeholder: "请输入",
                                    defaultValue:data.opinionField1,
                                    must: true
                                },
                                {
                                    type: "textarea",// 
                                    "name": "opinionField2",//接口对应字段
                                    "label": "综合处意见",//表头名
                                    placeholder: "请输入",
                                    defaultValue:data.opinionField2,
                                    must: true
                                },
                                {
                                    type: "textarea",// 
                                    "name": "opinionField3",//接口对应字段
                                    "label": "海外事业部项目管理部总经理审核意见",//表头名 
                                    placeholder: "请输入",
                                    defaultValue:data.opinionField3,
                                    must: true
                                },
                                {
                                    type: "textarea",// 
                                    "name": "opinionField4",//接口对应字段
                                    "label": "公司分馆海外领导审批意见",//表头名 
                                    placeholder: "请输入",
                                    defaultValue:data.opinionField4,
                                    must: true
                                } */
                            ]
                        }
                        ...
                        switch (dataName) {
                            case "launch":
                                ...
                                for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
                                    ...
                                    //add by apih5 on 717
                                    body["apiName"] = "updateZjHwSarsByCreate"//购置申请发起时调用
                                    //add by apih5 on 717
                                }
                                //流程发起特殊代码---开始
