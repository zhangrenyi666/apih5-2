...
const config = {
	fetchConfig: {
		apiName: 'getZjFlowUnionMemberSolatiumList'
	},
	antd: {
		rowKey: function (row) {
			return row.workId;
    ...
    actionBtns: [
        {
            ...
            onClick:(obj) => {
                ...
                window.location.href = `${ureport}pdf?_u=file:zjFlowUnionMemberSolatiumTotalList.xml&url=${domain}&delFlag=0&_n=工会慰问金流程申请单-${moment(new Date()).format('YYYY-MM-DD')}`;
            }
        },
    ],
	formConfig: [
