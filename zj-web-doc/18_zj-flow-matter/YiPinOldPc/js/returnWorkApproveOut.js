var flowId = "zjypFlow";
var orderId = l.getUrlParam('orderId');
...
l.ajax("getZjWoaYipinOrderDetails", { "orderId": orderId }, function (data) {
                    ...
                    switch (dataName) {
                        case "launch":
                            ...
                            for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
                                ...
                                //add by apih5 on 717
                                body["apiName"] = "updateZjWoaYipinOrder"//购置申请发起时调用
                                //add by apih5 on 717
                            }
                            //流程发起特殊代码---开始
