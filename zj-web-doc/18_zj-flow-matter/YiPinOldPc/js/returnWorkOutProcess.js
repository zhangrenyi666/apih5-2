...
var orderId = l.getUrlParam("workId") || "";
...
var _body = {
	...
	workId: workId,
	flowId: flowId,
	apiName: "getZjWoaYipinOrderDetails",
				...
				$.each(workFormJson.tabs, function (i, tabItem) {
					...
					//操作历史end
						...
						var pager = pagerDom.page({
							remote: {
								//ajax请求配置
								url: l.getApiUrl("getZjWoaYipinInfoList"),
								params: {
									otherId: orderId
								},
