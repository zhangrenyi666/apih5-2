            ...
            tabs: [
                {
                    ...
                    type: "1",
                    isMain: "1",
                    tbName: "zjCorpPersonnellOuterTransfer",
                    tbIdName: "corpOuterId",
                    conditions: [
					    {
                ...
                },
                {
                    ...
                    conditions: [
                        {
                            type: "upload",//
                            name: "zjCorpPersonnellOuterTransferFile",//
                            label: "附件1",//
                            btnName: "添加附件",
                            projectName: "zjCorpPersonnellOuterTransfer", 
                    ...
                    case "launch":
                        ...
                        for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
                            ...
                            if (tabItemj.isMain) {//如果是主表
                                ...
                                body["title"] = tabObjDatas.data['needsTitle']; 
