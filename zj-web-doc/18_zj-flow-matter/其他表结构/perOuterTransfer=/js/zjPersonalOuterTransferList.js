...
var pager = $("#pager").page({
    remote: {//ajax请求配置
        url: l.getApiUrl("getZjPersonalOuterTransferList"),
        params: {
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onSave: function (obj, _params) {
        l.ajax('updateZjPersonalOuterTransfer', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    },
    onAdd: function (obj, _params) {
        l.ajax('addZjPersonalOuterTransfer', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    }
    ...
    switch (name) {
        ...
        case "del":
            if (checkedData.length == 0) {
                ...
                l.delTableRow("outerTransferId", 'sxAqJsonNodeList', 'batchDeleteZjPersonalOuterTransfer', checkedData, function (data) {
                    pager.page('remote')
                })//  删除url地址
            }
            break;
