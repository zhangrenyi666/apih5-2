...
$("body").on("click", "button", function () {
    ...
    switch (name) {
        ...
        case "sendToOffice"://发送给办公室
            ...
            break;
        case "approve":
            myOpen("用印发起", "zjYongYin", "approve")
            break;
		case "approve1":
            myOpen("外携用印发起", "zjYyOutSeal", "zjYyOutSealApplyApprove")
            break;
		case "approve2":
            myOpen("信息化需求确认流程", "flowIdZj1", "zjInfoNeedsConfirmApprove")
            break;
		case "approve3":
            myOpen("信息化立项申请流程", "flowId2", "zjInfoProjectApplyApprove")
            break;
        case "process4":
            myOpen("流程处理", "", "zjYyOutSealApplyProcess")            
            break;
    }
})
