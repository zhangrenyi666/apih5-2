var flowId = l.getUrlParam('id') || "zjYongYin";//流程模版id
...
switch (flowId) {
    case "zjYongYin":
        ...
        var cell0_3 = $th.clone().attr("data-cellName", "reportedTime")
        var cell0_2 = $td.clone().attr("colspan", "4").attr("data-cellName", "reportedTime")
        line0.append(cell0_0).append(cell0_1).append(cell0_3).append(cell0_2)
        $table.append(line0)
        var line1 = $tr.clone()
