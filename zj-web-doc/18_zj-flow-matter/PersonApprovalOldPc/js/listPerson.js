        ...
        success: function (result) {
            if (result.success) {
                ...
                if (result.data.length > 0) {
                    if (l.getUrlParam('apih5FlowStatus') == '1' || l.getUrlParam('apih5FlowStatus') == '2') {
                        $('#save').css('display', 'none');
                        $('#delete').css('display', 'none');
                        $('#update').css('display', 'none');
                    }
                ...
                if (data[0] && data[0].fileList) {
                    fujian.setOpenData({ fileList: data[0].fileList });
                }
            } else {
