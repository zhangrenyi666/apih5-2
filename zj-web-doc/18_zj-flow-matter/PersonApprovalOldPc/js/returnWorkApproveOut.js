var flowId = "sanPerson";
var personApproveId = l.getUrlParam('personApproveId');
                    ...
                    tabs: [
                        {
                            ...
                            isMain: "1",//是否为主表
                            tbName: "zjFlowPersonApprove",//表名
                            tbIdName: "personApproveId",//表主键id
                            conditions: [
                                {
                                    type: "hidden",//
                                    name: "personApproveId",//
                                    label: "主键id",//
									//defaultValue: personApproveId,
                                    placeholder: ""
                                },
                                {
                                    type: "text",//
                                ...
                                },
                                {
                                    ...
                                    label: "标题",//
                                  //  defaultValue:data.personApproveTitle,
                                    placeholder: "请输入",
                                    must: true,
                                    immutableAdd: true
                                },
...
l.ajax("getZjFlowPersonApproveDetail",{ "personApproveId": personApproveId },function (data) {
                            ...
                            case "launch":
                                ...
                                for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
                                    ...
                                    if (tabItemj.isMain) {//如果是主表
                                        ...
                                        //add by apih5 on 717 
                                        body["title"] = tabObjDatas.data['personApproveTitle']+tabObjDatas.data['proName'];
                                    ...
                                    //add by apih5 on 717
                                    body["apiName"] = "updateZjFlowPersonApproveForFlow"//购置申请发起时调用
                                    //add by apih5 on 717
                                }
                                //流程发起特殊代码---开始
                                        ...
                                        if (_s) {//发起成功，返回workId
                                            loadFlow(_d.flowButtons,{
                                                otherBody: {
                                                    ...
                                                    apiName: "updateZjFlowPersonApproveForFlow",//updateZjFlowPersonApproveForFlow
