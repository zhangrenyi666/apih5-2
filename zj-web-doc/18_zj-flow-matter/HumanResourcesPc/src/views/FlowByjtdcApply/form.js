...
class index extends Component {
    ...
    getConfig = () => {
        return {
            ...
            workFlowConfig: {
                title: ["name","createTimeq","集团公司调出申请"],
            ...
            formConfig: [
                {
                    ...
                    Component: obj => {
                        return (
                            <Divider style={{ fontSize: '22px',color: '#545456',height: '38px',lineHeight: '38px',margin: '16px 0 0 0',textAlign: 'center' }} orientation="middle">集团公司调出申请</Divider>
                        );
                    }
                },
                {
            ...
            <Form
                ...
                btnsCURD={({ btns,flowData }) => {
					...
					if (url === `${myPublic}todoByTran`) {
						...
						if (flowData && flowData.flowNode.nodeId === 'Node12' || flowData && flowData.flowNode.nodeId === 'Node2' || flowData && flowData.flowNode.nodeId === 'Node6') {
							var printUrl = `${ureport}excel?_u=file:reportZjFlowTranOuter.xml&url=${domain}&workId=${flowData.workId}`
							btns.push({ buttonClass: "exprot",buttonFun: null,buttonId: "exprot",buttonName: "导出",icon: null,printUrl: printUrl });
						}
					}
                    ...
                    var fields = fields.map((item) => {
                        ...
                        if (list.apih5FlowStatus === '0') {
                            if (item.children) {
                                ...
                                if (field === 'remarks' || field === 'opinionField7' || field === 'opinionField6' || field === 'opinionField5' || field === 'opinionField4' || field === 'opinionField3' || field === 'opinionField2' || field === 'opinionField1') {
                                    item.disabled = true;
                                } else {
                                    item.disabled = false;
                                }
