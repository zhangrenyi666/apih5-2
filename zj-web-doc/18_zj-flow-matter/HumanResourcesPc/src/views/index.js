...
const FlowBynbddApply = lazy(() => import("./FlowBynbddApply"));
const FlowByhuKouApply = lazy(() => import("./FlowByhuKouApply"));
...
const routerInfo = [
    {
        ...
        children: [
            {
                label: "待办流程",
                defaultPath: "todoByTran",
                pathName: "todoByTran",
                comKey: "FlowBynbddApply"
            },
            {
                label: "已办流程",
                defaultPath: "hasTodoByTran",
                pathName: "hasTodoByTran",
                comKey: "FlowBynbddApply"
            }
        ]
    },
    
    {
        ...
        children: [
            {
                label: "待办流程",
                defaultPath: "todoByhuKou",
                pathName: "todoByhuKou",
                comKey: "FlowByhuKouApply"
            },
            {
                label: "已办流程",
                defaultPath: "hasTodoByhuKou",
                pathName: "hasTodoByhuKou",
                comKey: "FlowByhuKouApply"
            }
        ]
    }
