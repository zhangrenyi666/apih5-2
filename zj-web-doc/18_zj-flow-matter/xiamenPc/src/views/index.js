...
// 流程
import FlowByXmFlowSeal from './FlowByXmFlowSeal';
...
const routerInfo = [
    {
        ...
        children: [
            {
                label: "待办流程",
                defaultPath: "todoByxmFlowSeal",
                pathName: "todoByxmFlowSeal",
                comKey: "FlowByXmFlowSeal"
            },
            {
                label: "已办流程",
                defaultPath: "hasTodoByxmFlowSeal",
                pathName: "hasTodoByxmFlowSeal",
                comKey: "FlowByXmFlowSeal"
            }
        ]
    }
