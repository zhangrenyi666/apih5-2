			...
			if (webCodeLoginType && !webCode) {
				...
				render(
					<div style={{ textAlign: "center" }}>
						<div style={{ color: "red", marginTop: "24px" }}>无权限登录！</div>
					</div>,
	...
	getApis() {
		return new Promise((resolve) => {
			...
			myFtch(
				"getSysWebBg",
				{
					bgId: window.configs.appInfo.mainModule.replace(/(\/)/gi, ""),
				},
				"1"
