var flowId = l.getUrlParam("id") || "zjAffairsApply"; //流程模版id
                    ...
                    case "launch":
                        ...
                        for (var j = 0; j < flowFormJson.tabs.length; j++) {
                            ...
                            if (tabItemj.isMain) {
								...
								body["apiTitle"] = "setZjFlowAffairsApplyTitle";
                            ...
                            //				    			   add by lny on 717
                            body["apiName"] = "addZjFlowAffairsApply"; //购置申请发起时调用
                            //				    				   add by lny on 717
                        } 
                        //流程发起特殊代码---开始
