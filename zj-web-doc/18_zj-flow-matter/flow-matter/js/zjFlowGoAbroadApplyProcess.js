...
var _body = {
	...
	workId: workId,
	flowId: flowId,
	apiName: "getZjFlowGoAbroadApplyDetail",
	...
	if (_s) {
		loadFlow(_d.flowButtons, {
			...
			callback: function (flowObj) {
				...
				goAbroadApplyId = apiDataObj.goAbroadApplyId;
								...
								callback: function (dataName, obj) {
									switch (dataName) {
										...
										case "export"://导出
											...
											window.location.href = 'http://weixin.fheb.cn:91/ureport/pdf?_u=file:zjGoAbroadApply.xml&url=' + l.domain + '&workId=' + params.workId;
											break;
											...
											for (
												...
												if (
													...
													if (tabItemj.isMain) {
														...
														//body["title"] = title;
														 body["title"] = tabObjDatas.data['name'] + '-  因私出国（各单位）申请';
														body["opinionContent"] =
															tabObjDatas.data[
															"opinionContent"
															];
