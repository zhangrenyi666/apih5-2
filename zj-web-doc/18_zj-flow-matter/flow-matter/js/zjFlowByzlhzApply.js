var flowId = l.getUrlParam('id') || "zlhzApply";//流程模版id
var draftAuthor = "";
...
$tabTitle.html("战略合作框架协议、联合体协议评审(局)申请")
                        ...
                        case "launch":
                            ...
                            for (var j = 0; j < flowFormJson.tabs.length; j++) {//第二次遍历flowFormJson.tabs，为了让return起作用所以不用$.each而采用for循环
                                ...
                                if (tabItemj.isMain) {//如果是主表
                                    ...
                                    body["title"] = tabObjDatas.data['reviewId'] + '  ' + formatDate + '  战略合作框架协议、联合体协议评审(局)';
