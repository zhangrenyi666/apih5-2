    ...
    tabs: [
        {
            ...
            conditions: [
                ...
                },
                {
                    ...
                    label: "注", //
                    defaultValue:
                        "1.涉及授权委托事宜的用印审批，须对口部门合法合规人员审批签字<br/>2.内容一栏需详细填写用印事由，准确反映用印具体用途。",
                    immutableAdd: true
                }
            ]
        },
...
var _body = {
    ...
    workId: workId,
    flowId: flowId,
    apiName: "getFlowSealDetailByWorkId",
                ...
                $.each(workFormJson.tabs, function (i, tabItem) {
                    ...
                    //操作历史end
                        ...
                        if (tabItem.isMain) {
                            ...
                            if (_d.flowNode != null) {
                                if (_d.flowNode.nodeName == "申请人" || _d.flowNode.nodeName == "办公室审核" || _d.flowNode.nodeName == "结束") {
                                    btns.push({
                                        name: "export",
                                        label: "导出"
                                    })
                            ...
                            customBtnGroup = {
                                ...
                                callback: function (dataName, obj) {
                                    switch (dataName) {
                                        ...
                                        window.location.href = 'http://weixin.fheb.cn:91/ureport/pdf?_u=file:zjSeal.xml&url=' + l.domain + '&workId=' + params.workId;
                                        break;
                                        case "cancel":
                                            obj.close();
                                            break;
