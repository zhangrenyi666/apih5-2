...
import Me from "./Me";
// 移动端首页（非移动端请删除 --删除结束）
import TabsListMobile from "./tabsListMobile";
import TabsListMobileDetail from "./tabsListMobile/todoMobileDetail";
...
const pageComs = {
    ...
    TabsListMobileDetail:{ 
        mustLogin: true,
        Com: TabsListMobileDetail
    }
    // Contacts: {
    //     mustLogin: true,
    //     Com: ContactsPage
...
const routerInfo = [
    {
        label: "代办待办列表",
        pathName: "TabsListMobile/:type/:status",
        defaultPath: "TabsListMobile/0/await",
        comKey: "TabsListMobile"
    },
    {
        label: "代办待办列表",
        pathName: "TabsListMobileDetail/:trackId/:workId/:flowId",
        defaultPath: "TabsListMobileDetail/0/0",
        comKey: "TabsListMobileDetail"
    },
