...
var personApproveId = l.getUrlParam("workId") || "";
...
var _body = {
	...
	workId: workId,
	flowId: flowId,
	apiName: "getZjFlowPersonApproveDetail",
	...
	if (_s) {
		loadFlow(_d.flowButtons, {
			otherBody: {
				...
				apiName: "updateZjFlowPersonApproveForFlow"
			},
			submitFn: function () {
			...
			callback: function (flowObj) {
				...
				personApproveId = apiDataObj.personApproveId;
				//该条件满足就可以编辑
					...
					//操作历史end
						...
						var pager = pagerDom.page({
							remote: {
								...
								params: {
									personApproveId: personApproveId
								},
