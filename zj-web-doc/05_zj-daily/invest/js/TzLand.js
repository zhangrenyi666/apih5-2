var tableTzLand = $('#tableTzLand').DataTable({
    "info": false,
    "lengthChange": false,
    ...
    "columnDefs": [
        {
            ...
            "render": function (rowData) {
                ...
                var data = rowData[getKeyName("TzLand", "Id")]
                var html = '';
                ...
                if (checkState == 0) {
                    html += '<li><a href="#" onclick="openDetail(\'TzLand\',\'1\',\'' + data + '\')">编辑</a></li>';
                } else {
                    html += '<li><a href="#" onclick="openDetail2(\'TzLand\',\'' + data + '\')">查看</a></li>';
                }
                html += '<li><a href="#" onclick="openDetail(\'TzLand\',\'2\',\'' + data + '\')">复制新增</a></li>';
                //html += '<li><a href="#" onclick="review(\'TzLand\',\'' + data + '\')">审核</a></li>';
                html += '<li><a href="#" onclick="del(\'TzLand\',\'' + data + '\')">删除</a></li>';
                html += '</ul></span>';
                return html;
            }
        }
...
var pagerTzLand = $("#pagerTzLand").page({
    remote: {
        url: l.getApiUrl("getTzLandList"),
        ...
        success: function (result) {
            if (result.success) {
                ...
                tableTzLand.clear().rows.add(data).draw();
            } else {
