var tableTzLand = $('#tableTzLand').DataTable({
    ...
    "columnDefs": [
        {
            "targets": [0],
            "data": getKeyName("TzLand", "Id"),
            "width": 13,
            "title": '',
            "render": function (data) {
                return '<input type="checkbox" name="' + getKeyName("TzLand", "Id") + '" data-id="' + data + '">';
            }
        }, {
            "targets": [1],
            "data": "progressDesc",
            ...
            "render": function (data) {
                ...
                html += '<li><a href="#" onclick="openDetail(\'TzLand\',\'2\',\'' + data + '\')">详情</a></li>';
                //html += '<li><a href="#" onclick="restReview(\'TzLand\',\'' + data + '\')">反审核</a></li>';
                html += '</ul></span>';
                return html;
            }
        }
...
var pagerTzLand = $("#pagerTzLand").page({
    remote: {
        url: l.getApiUrl("getTzLandList2"),
        params: { companyId: companyId, startDate: startDate, endDate: endDate },
        success: function (result) {
            if (result.success) {
                tableTzLand.clear().rows.add(result.data).draw();
            } else {
