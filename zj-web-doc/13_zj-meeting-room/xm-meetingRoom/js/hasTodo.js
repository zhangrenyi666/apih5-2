...
function myOpen(title, data, url) {
   if(data.flowId == 'xmMeetingRoom'){//会议室
    ...
    var options = {
        type: 2,
        title: title,
        content: url + ".html?workId=" + data.workId + "&trackId=" + data.trackId + "&nodeId=" + data.nodeId + "&title=" + data.title+ "&state=" + data.flowStatus+ "&code=" + code
    }
