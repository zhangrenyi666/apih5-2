...
$(function(){
	$("select[name='meetingRoomId']").change(function () {
		var meetingRoomId = $(this).val();
		alert($("input[name='meetingStartTime']").val());
		console.log($("input[name='meetingStartTime']").val());
		var meetingStartTime = new Date($("input[name='meetingStartTime']").val()).getTime();
		var meetingEndTime = new Date($("input[name='meetingEndTime']").val()).getTime();
		var checkedData={
			meetingRoomId:meetingRoomId,
			meetingStartTime:meetingStartTime,
			meetingEndTime:meetingEndTime			
		}
		l.ajax("getZjMeetingApplyFlowConflictByReservationsTime", checkedData, function (data) {
			if(data){
