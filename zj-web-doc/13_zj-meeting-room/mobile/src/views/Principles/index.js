                                        ...
                                        return (
                                            <div className={s.center} style={{borderLeft:'3px solid red'}} key={index} onClick={() => {
                                                if(item.personnelState == 0){
                                                    this.props.dispatch(push(`/xmMeetingRoomMobile/largeSignIns/${item.reservationsId}/${item.loginMobile}/0`))
                                                }else if(item.personnelState == 1){
                                                    this.props.dispatch(push(`/xmMeetingRoomMobile/signInss/${item.reservationsId}/${item.loginMobile}/0`))
                                                }else if(item.personnelState == 2){
                                                    this.props.dispatch(push(`/xmMeetingRoomMobile/signInDetail/${item.reservationsId}/${item.loginMobile}/0`))
                                                }else if(item.personnelState == 3){
                                                    this.props.dispatch(push(`/xmMeetingRoomMobile/signInsDetail/${item.reservationsId}/${item.loginMobile}/0`))
                                                }                                        
                                            }}>
