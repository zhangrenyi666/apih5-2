...
var flowId = l.getUrlParam('id') || "qsZcCheck";//流程模版id
...
l.ajax("getZjCheckFlowDetail", { "sszcid": l.getUrlParam('sszcid') }, function (data) {
