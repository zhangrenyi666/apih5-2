        ...
        return (
            <div style={{ height: '100vh' }}>
                ...
                <QnnForm
                    ...
                    fetchConfig={() => {
                        return {
                            apiName: 'getZjLzehMonthPlanProgressDetail',
                            otherParams: { zjLzehMonthPlanProgressId: this.props.match.params.zjLzehMonthPlanProgressId }
                        }
                    }}
                    formConfig={[
                        {
