window.configs = {
    dev: false,
    debugConsole: false,
    domain: "http://114.115.200.165:99/apiZjLzehDemo/",
    ...
    appInfo: {
        ...
        mainModule: "/lzehMobile/",
        helpHref: ""
    },
    loginPageConfig: {
        bgImgUrl: ["img1.png", "img2.png"], //背景图片
        rowText: ["泸州市二环路高新区AB段工程项目信息化系统"], //文字描述 一项即一行
    ...
    apis: {
        ...
        //安全质量表格
        getDangerCountInfoList: 'getDangerCountInfoList',
        getTroubleCountInfoList: 'getTroubleCountInfoList',
