...
import ImportCom from '../ZjLzehObjectivetaskplanImport'
                    ...
                    importOrAdd ?
                        <div>
                            ...
                            <QnnTable
                                ...
                                antd={
                                    {
                                        rowKey: 'zjLzehProduceTaskPlanId',
                                        size: 'small'
                                    }
                                }
                                ...
                                formConfig={[
                                    ...
                                    },
                                    {
                                        table: {
                                            ...
                                            onClick: (obj) => {
                                                this.primaryKey = obj.rowData.zjLzehProduceTaskPlanId
                                                this.setState({
                                                    importOrAdd: false
                                                })
                                            },
                                ...
                                method={{
                                    updateZjLzehProduceTaskPlanFunc: (obj) => {
                                        const zjLzehProduceTaskPlanId = obj.btnCallbackFn.getSelectedRows()[0].zjLzehProduceTaskPlanId
                                        return {
                                            apiName: 'updateZjLzehProduceTaskPlan',
                                            otherParams: {
                                                zjLzehProduceTaskPlanId
                                            }
                                        }
                                    }
                                }}
                                actionBtns={[
                                    {
                                        ...
                                        formBtns: [
                                            ...
                                            },
                                            {
                                                ...
                                                label: '保存',
                                                fetchConfig: {
                                                    apiName: 'addZjLzehProduceTaskPlan'
                                                }
                                            }
                                        ]
                                    },
                                    {
                                        ...
                                        formBtns: [
                                            ...
                                            },
                                            {
                                                ...
                                                type: 'primary',
                                                label: '保存',
                                                fetchConfig: 'bind:updateZjLzehProduceTaskPlanFunc'
                                    ...
                                    },
                                    {
                                        ...
                                        label: '删除',
                                        fetchConfig: {
                                            apiName: 'batchDeleteUpdateZjLzehProduceTaskPlan'
                                        },
                                    }
                                ]}
                            /> </div> :
                        <ImportCom parent={this}></ImportCom>}
            </div>
        );
    }
}
