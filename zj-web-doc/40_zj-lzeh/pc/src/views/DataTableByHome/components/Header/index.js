...
export default class Header extends Component {
    ...
    refresh = () => {
        ...
        myFetch("getZjLzehWeather", {}).then(({ data, success, message }) => {
        ...
        return (
            <Spin spinning={loading}>
                ...
                <div className={s.header}>
                    ...
                    {/* <div className={s.left} style={{ position: 'relative' }}>
                        <div style={{ position: 'absolute', zIndex: 88888, width: '100%', height: '100%', background: 'white', opacity: 0 }}></div>
                        <iframe id='iframe' src="http://i.tianqi.com/index.php?c=code&id=11&color=%2300B0F0&icon=1&site=14" width="500" height="25" frameBorder="0" marginWidth="0" marginHeight="0" scrolling="no"></iframe>
                    </div> */}
