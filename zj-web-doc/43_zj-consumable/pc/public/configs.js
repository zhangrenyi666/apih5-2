...
window.configs = {
    ...
    language: (function () {
        var locd = localStorage.getItem('zj_qyh_tz_id_language') || '{}';
        return JSON.parse(locd).d || "zh_CN"
    })(),

    // domain: "http://test.bjtoone.com/apiZjerp/",
    ...
    appInfo: {
        ureport: 'http://192.168.1.119:17777/ureport/',
        id: "zj_erp",
    ...
    apis: {
        ...
        getZjConsumableSetList: "getZjConsumableSetList",
        addZjConsumableSet: "addZjConsumableSet",
        updateZjConsumableSet: "updateZjConsumableSet",
        batchDeleteUpdateZjConsumableSet: "batchDeleteUpdateZjConsumableSet",
        getZjConsumableInventoryList: "getZjConsumableInventoryList",
        getZjConsumablePutList: "getZjConsumablePutList",
        addZjConsumablePut: "addZjConsumablePut",
        updateZjConsumablePut: "updateZjConsumablePut",
        batchDeleteUpdateZjConsumablePut: "batchDeleteUpdateZjConsumablePut",
        getZjConsumableApplyBookList: "getZjConsumableApplyBookList"
    }
};
