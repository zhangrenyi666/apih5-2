...
var pager = $("#pager").page({
    remote: {//ajax请求配置
        url: l.getApiUrl("getTotalCandidateListForFraction"),
        params: {
        ...
        success: function (result) {
            if (result.success) {
                ...
                columnDefs.push({
                    ...
                    "defaultContent": "-",//默认显示
                    "render": function (data) {
                        return '<a href="javascript:void(0);" class="dropDown_A" onclick="myOpen(\'得分统计详情列表\',\'' + data + '\',\'' + 'totalCandidateDetailsListForFraction' + '\')">查看</a>'
                    }
                })
				if(table){
					table.destroy()
