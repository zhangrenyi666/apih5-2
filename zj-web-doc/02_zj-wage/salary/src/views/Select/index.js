...
import { WingBlank, NavBar, WhiteSpace, DatePicker } from "antd-mobile"; //SegmentedControl, Grid,
...
export class Select extends Component {
    ...
    onClick(i) {
        ...
        push(`Detail/${year}/${month}/0`); //0工资详情  1绩效详情
    }
    render() {
        return (
            <div>
          ...
          <NavBar mode="light">{new Date().getFullYear()}年</NavBar>
                ...
                <DatePicker
                    ...
                    locale={{
                        DatePickerLocale: {year:"年", month:"月", day:"日", hour:"时", minute:"分"}, okText:"确定", dismissText:"取消" 
                    }}
                >
                        ...
                        <ul>
                            {Array.from(new Array(12)).map((v, i) => {
                                return (
                                    ...
                                    >
                                        {i + 1}
                                        <span className={s["mothon"]}>月</span>
                                    </li>
                                );
                            })}
                        </ul>
