            ...
            if (isHide !== "none") {
              return (
                <li key={i} style={{ display: isHide }}>
                  ...
                  <div className="right">{newValue}</div>
                </li>
              );
            } else {
              return "";
  ...
  refresh(selectedIndex) {
    getUserInfo(({ userId }) => {
      ...
      if (selectedIndex === 0) {
        ...
        if (_p === '2018/1') {
          //一月的工资需要这段代码
          MyFetch("getZjWageDetail", body, res => {
          ...
          //正常情况
          MyFetch("getZjWageDetail", body, ({ data, success, message }) => {
            if (success) {
        ...
        //说明是绩效详情  
        MyFetch("getZjPerformDetail", body, res => {
        ...
        {this.state.error === 0 ? (
          ...
          <Result
            img={
              <Icon
                type="cross-circle-o"
                style={{ fill: "#F13642", width: "1rem", height: "1rem" }}
              />
            }
              ...
              <div>
                ...
                >
                  ...
                  <WingBlank>
                      ...
                      this.state.selectedIndex === 0 ? (
                        ...
                        this.state.error === 3
                          ...
                          <div>
                            ...
                            {/* 备注 */}
                            <div className="model" style={{ fontSize: ".24rem", color: "#999" }}>
                    ...
                    <div ref={(me) => this.footer = me} className="footer" style={{ display: this.state.footer ? 'block' : 'none' }}>
                      <div onClick={this.clickFn.bind(this)}>阅后即焚</div>
                    </div>
                  </WingBlank>
                  <WhiteSpace />
