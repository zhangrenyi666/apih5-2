    ...
    columnDefs: [
        ...
        // }
        {
            ...
            render: function (data) {
                ...
                html +=
                    "<li><a href=\"javascript:void(0);\" onclick=\"openReview('zjZpEvaluationList', '题库设置','" +
                    data.assessmentId +
                    "')\">题库设置</a></li>";
                html +=
                    "<li><a href=\"javascript:void(0);\" onclick=\"openReview('userCountListByReviewer', '复评及统计','" +
                    data.assessmentId +
                    "')\">复评及统计</a></li>";
                html +=
                    "<li><a href=\"javascript:void(0);\" onclick=\"openReview('evaluationModuleSetting', '工作模块分类设置','" +
                    data.assessmentId +
                    "')\">工作模块分类设置</a></li>";
                html += "</ul></span>";
                return html;
