                    ...
                    {CustomItem ? (
                        CustomItem({ rowData: { ...rowData }, ...this.props })
                            ...
                            <div>
                                ...
                                {flowId === 'zjLabourUnionFlowApplication' ? <div>
                                    <Divider style={{ margin: "12.5px 0px" }} />
                                    <Flex>
                                        <Flex.Item style={{ fontSize: "13px", textAlign: 'right' }}>
                                            <Button type="primary" inline size="small" onClick={(e) => {
                                                e.stopPropagation();
                                                dispatch(push(`${mainModule}CaseListOfTheGroup/${workId}/${rowData.status === 'Done' ? 'FlowByApplicationOver' : 'FlowByApplicationAwait'}`));
                                            }}>立案明细</Button>
                                        </Flex.Item>
                                    </Flex>
                                </div> : null}
