            ...
            <div className={styles.container}>
                <div className={styles.header}>
                    <NavBar
                        ...
                        rightContent={!_searchFroms.length ? null : <span style={{ fontSize: 15,color: JSON.stringify(mobileSearchParams) === "{}" ? 'white' : "orange" }} className={styles.btn} onClick={() => { this.setState({ open: true }) }}>更多<Icon type="filter" /></span>}
