...
import getPropTypes from "./propTypes"
...
class index extends PureComponent {
    ...
    constructor(...args) {
        ...
        this.deepCopy = deepCopy.bind(this);
        ...
        formConfig = this.bind(formConfig);
        ...
        this.getSelectedRows = () => this.state.selectedRows;
        ...
        //获取搜索参数 
        this.getSearchParams = (cb) => { this.getFromParams("search",cb) };
        ...
        this.btnCallbackFn = {
            ...
            getSelectedRows: this.getSelectedRows, //获取选择的数据
            formatData: this.sFormatData,
            qnnForm: this.qnnForm,
            getQnnForm: () => this.qnnForm,
