...
const formConfigClass = function () {
        ...
        if (isInTable) {
            if (table.btns) {
                ...
                table.render = (data,rows,index) => {
                    ...
                    table.btns = this.bind(table.btns);
                    ...
                    if (showType === "tile") {
                        ...
                        domArr = domArr.map((item,i) => {
                            return <span key={i}>
                                {i === 0 ? null : <Divider type="vertical" />}{item}
                            </span>
                        })
            ...
            if (onClick) {
                table.render = (data,rows,index) => {
                    ...
                    isCanClick = this.bind(isCanClick);
                    if (isCanClick) {
                        let _isCanClick = "";
    ...
    if (this.props.isNeedClassifyDataCb) {
        this.props.isNeedClassifyDataCb({
            props: this.props,
            state: this.state,
            btnCallbackFn: this.btnCallbackFn,
            tableData: this.state.data
