        ...
        return (
            <div>
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'getZjTzSafetyEmergencyPlanList',
                        otherParams: {
                            projectId: projectId
                        }
                    }}
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            table: {
                                ...
                                width: 300,
                                tooltip: 53,
                                dataIndex: 'emergencyPlanTitle',
                                key: 'emergencyPlanTitle',
                                filter: true,
                            },
                            form: {
                                type: 'string',
                        ...
                        },
                        {
                            table: {
                                title: '预案内容简介',
                                dataIndex: 'emergencyPlanContent',
                                width: 200,
                                tooltip: 23,
                                key: 'emergencyPlanContent'
                            },
                            form: {
                                type: 'textarea',
                                autoSize: {
                        ...
                        },
                        {
                            table: {
                                title: '登记日期',
                                width: 100,
                                dataIndex: 'emergencyPlanDate',
                                format: 'YYYY-MM-DD',
                                key: 'emergencyPlanDate'
                            },
                            form: {
                                type: 'date',
                        ...
                        },
                        {
                            table: {
                                title: '登记用户',
                                width: 100,
                                dataIndex: 'emergencyPlanUser',
                                key: 'emergencyPlanUser'
                            },
                            form: {
                                type: 'string',
