        ...
        return (
            <div>
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'getZjTzSafetyManagementOrganList',
                        otherParams: {
                            projectId: projectId
                        }
                    }}
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            table: {
                                ...
                                width: 300,
                                tooltip: 53,
                                dataIndex: 'safetyOrganTitle',
                                key: 'safetyOrganTitle',
                                filter: true,
                            },
                            form: {
                                type: 'string',
                        ...
                        },
                        {
                            table: {
                                ...
                                width: 300,
                                tooltip: 80,
                                dataIndex: 'safetyOrganContent',
                                key: 'safetyOrganContent'
                            },
                            form: {
                                type: 'textarea',
                                autoSize: {
