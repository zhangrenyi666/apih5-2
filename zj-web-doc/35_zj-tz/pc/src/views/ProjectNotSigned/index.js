...
class index extends Component {
    ...
    render() {
        const { loadingSend,visibleSend,selectProName,selectProId } = this.state;
            ...
            <div className={s.root}>
                <QnnTable
                    ...
                    method={{
                        ...
                        projectMoveClick: (obj) => {
                            this.setState({
                                visibleSend: true,
                                selectProName: obj.selectedRows[0].projectName,
                                selectProId: obj.selectedRows[0].projectId
                            })
                        },
                        addSaveClick: (obj) => {
                ...
                >
                    <Spin spinning={loadingSend}>
                        {/* <div style={{ marginLeft: '15px',fontWeight:'bold',fontSize:'17px',width:'100%',textAlign:'center' }}>{selectProName}</div> */}
                        <QnnForm
                            {...this.props}
                            ...
                            formConfig={[
                                {
                                    ...
                                    field: 'projectName',
                                    disabled:true,
                                    initialValue:selectProName,
                                    type: 'string'
                                },
                                {
                                    label: '',
                                    field: 'projectId',
                                    initialValue:selectProId,
                                    type: 'string',
                                    hide:true
                                },
                                {
                            ...
                            btns={[
                                ...
                                },
                                {
                                    ...
                                    onClick: (obj) => {
                                        ...
                                        this.props.myFetch('changeZjTzProManageToSign', obj.values).then(
                                            ({ success, message }) => {
                                                if (success) {
                                                    Msg.success('移动成功！');
                                                    this.table.refresh();
