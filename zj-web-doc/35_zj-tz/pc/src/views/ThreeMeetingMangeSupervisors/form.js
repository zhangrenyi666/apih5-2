...
let config = {
    ...
    workFlowConfig: {
        //后台定的字段
        title: ["","",'监事会'], 
        apiNameByAdd: "updateZjTzThreeSupervisorForFlow",
        apiNameByUpdate: "updateZjTzThreeSupervisorForFlow",
        apiNameByGet: "getZjTzThreeSupervisorDetails",
        flowId: "zjTzThreeSupervisor",
        todo: "TodoHasTo",
        hasTodo: "TodoHasToq"
    }
};
                    ...
                    formConfig={[
                        {
                            ...
                            type: 'string',
                            placeholder: '请输入',
                            initialValue: flowData.threeSupervisorId ? flowData.threeSupervisorId : '',
                            hide: true,
                        },
                        // {
                        //     field: 'projectId',
