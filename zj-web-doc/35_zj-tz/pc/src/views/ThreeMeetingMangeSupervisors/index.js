        ...
        return (
            <div className={s.root}>
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'getZjTzThreeSupervisorList',
                        otherParams: {
                            projectId:proNameId
                        }
                    }}
                                ...
                                btns: [
                                    {
                                        ...
                                        onClick: (obj) => {
                                            ...
                                            const { threeSupervisorId, apih5FlowStatus } = obj.rowData;
                                            let apiFlow = '';
                                            if (apih5FlowStatus === '') {
                                                apiFlow = '99';
                                            } else {
                                            ...
                                            obj.props.dispatch(
                                                push(`${mainModule}ThreeMeetingMangeSupervisorsDetail/${threeSupervisorId}/${apiFlow}/${0}`)
                                            )
                                        },
                                    }
                                ]
                            ...
                            if (obj.selectedRows.length>0) {
                                ...
                                if (apih5FlowStatusArry.length>0) {
                                    ...
                                    confirm({
                                        ...
                                        cancelText: "取消",
                                        onOk: () => {
                                            myFetch('batchDeleteUpdateZjTzThreeSupervisor',obj.selectedRows).then(
                                                ({ success,message }) => {
                                                    if (success) {
                                                        Msg.success(message);
                                                        this.table.refresh();
