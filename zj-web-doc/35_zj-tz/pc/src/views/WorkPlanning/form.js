...
let config = {
    ...
    workFlowConfig: {
        //后台定的字段
        title: ["", "projectName", '运营方案'],
        apiNameByAdd: "updateZjTzRunSchemeForFlow",
        apiNameByUpdate: "updateZjTzRunSchemeForFlow",
        apiNameByGet: "getZjTzRunSchemeDetails",
        apiTitle: "getZjTzFlowTitle",
        // flowId: "zjTzRunScheme",
        todo: "TodoHasTo",
        hasTodo: "TodoHasToq"
    }
};
class index extends Component {
    render() {
        ...
        let zjTzRunScheme = '';
        if (ext1 === '3') {
            zjTzRunScheme = 'zjTzRunScheme3';
        }
        if (ext1 === '4') {
            zjTzRunScheme = 'zjTzRunScheme';
        }
        return (
                    ...
                    formConfig={[
                        {
                            ...
                            type: 'string',
                            placeholder: '请输入',
                            initialValue: flowData.runSchemeId ? flowData.runSchemeId : '',
                            hide: true,
                        },
                        {
                            field: 'flowId',
                    ...
                    fieldsCURD={(fields, flowData, props) => {
                        var fieldsnew = fields.map((item) => {
                            ...
                            if (url === `${myPublic}TodoHasTo`) {//待办
                                ...
                                } else if (field === 'remark' || field === 'zjTzFileList') {
                                    item.disabled = false;
                                } else {
