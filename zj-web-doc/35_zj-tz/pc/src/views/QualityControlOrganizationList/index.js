        ...
        return (
            <div>
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'getZjTzQualityManagementOrganList',
                        otherParams: {
                            projectId: projectId
                        }
                    }}
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            table: {
                                ...
                                width: 300,
                                tooltip: 53,
                                dataIndex: 'qualityOrganTitle',
                                key: 'qualityOrganTitle',
                                filter: true,
                            },
                            form: {
                                type: 'string',
                        ...
                        },
                        {
                            table: {
                                ...
                                width: 300,
                                tooltip: 80,
                                dataIndex: 'qualityOrganContent',
                                key: 'qualityOrganContent'
                            },
                            form: {
                                type: 'textarea',
                                autoSize: {
                        ...
                        },
                        {
                            table: {
                                title: '登记日期',
                                width: 100,
                                dataIndex: 'qualityOrganDate',
                                format: 'YYYY-MM-DD',
                                key: 'qualityOrganDate'
                            },
                            form: {
                                type: 'date',
                        ...
                        },
                        {
                            table: {
                                title: '登记用户',
                                width: 100,
                                dataIndex: 'qualityOrganUser',
                                key: 'qualityOrganUser'
                            },
                            form: {
                                type: 'string',
