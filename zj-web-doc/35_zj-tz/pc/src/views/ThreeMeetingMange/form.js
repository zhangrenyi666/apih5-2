...
let config = {
    ...
    workFlowConfig: {
        //后台定的字段
        title: ["","",'股东会'], 
        apiNameByAdd: "updateZjTzThreeShareholderForFlow",
        apiNameByUpdate: "updateZjTzThreeShareholderForFlow",
        apiNameByGet: "getZjTzThreeShareholderDetails",
        flowId: "zjTzThreeShareholder",
        todo: "TodoHasTo",
        hasTodo: "TodoHasToq"
    }
};
                    ...
                    formConfig={[
                        {
                            ...
                            type: 'string',
                            placeholder: '请输入',
                            initialValue: flowData.threeShareholderId ? flowData.threeShareholderId : '',
                            hide: true,
                        },
                        // {
                        //     field: 'projectId',
                        ...
                        },
                        {
                            ...
                            qnnDisabled: true,
                            placeholder: '请输入',
                            initialValue: flowData.yearDate ? flowData.yearDate : '',
                            span: 6,
                            formItemLayout: {
                                labelCol: {
                                    xs: { span: 24 },
