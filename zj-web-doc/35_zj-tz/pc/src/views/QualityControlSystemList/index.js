        ...
        return (
            <div>
                <QnnTable
                    ...
                    {...config}
                    fetchConfig={{
                        apiName: 'getZjTzQualityManagementSystemList',
                        otherParams: {
                            projectId: projectId
                        }
                    }}
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            table: {
                                title: '登记日期',
                                width: 100,
                                dataIndex: 'qualityRegisterDate',
                                format: 'YYYY-MM-DD',
                                key: 'qualityRegisterDate'
                            },
                            form: {
                                type: 'date',
                        ...
                        },
                        {
                            table: {
                                title: '登记用户',
                                width: 100,
                                dataIndex: 'qualityRegisterUser',
                                key: 'qualityRegisterUser'
                            },
                            form: {
                                type: 'string',
