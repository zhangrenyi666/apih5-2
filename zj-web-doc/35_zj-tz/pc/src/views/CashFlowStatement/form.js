...
let config = {
    ...
    workFlowConfig: {
        //后台定的字段
        title: ["", "registerPerson", '现金流量表'],
        apiNameByAdd: "updateZjTzCash",
        apiNameByUpdate: "updateZjTzCash",
        apiNameByGet: "getZjTzCashDetails",
                    ...
                    formConfig={[
                        {
                            ...
                            type: 'string',
                            placeholder: '请输入',
                            initialValue: flowData.cashId ? flowData.cashId : '',
                            hide: true,
                        },
                        {
                            field: 'flowId',
