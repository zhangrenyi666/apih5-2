            ...
            <div className={s.root}>
                <QnnTable
                    ...
                    formConfig={[
                        ...
                        {
                            table: {
                                title: '<div>经营活动产生的现金流量净额<br/>（元）</div>',
                                width:240,
                                dataIndex: 'total1',
                                key: 'total1'
                            },
                        ...
                        {
                            table: {
                                title: '<div>投资活动产生的现金流量净额<br/>（元）</div>',
                                width:240,
                                dataIndex: 'total2',
                                key: 'total2'
                            },
                        ...
                        {
                            table: {
                                title: '<div>筹资活动产生的现金流量净额<br/>（元）</div>',
                                width:240,
                                dataIndex: 'total3',
                                key: 'total3'
                            },
                        ...
                        {
                            table: {
                                title: '<div>现金及现金等价物净增加额<br/>（元）</div>',
                                width:220,
                                dataIndex: 'total5',
                                key: 'total5'
                            },
                        ...
                        {
                            table: {
                                title: '<div>期末现金及现金等价物余额<br/>（元）</div>',
                                width:200,
                                dataIndex: 'total6',
                                key: 'total6'
                            },
                                ...
                                btns: [
                                    {
                                        ...
                                        onClick: (obj) => {
                                            ...
                                            const { cashId,apih5FlowStatus } = obj.rowData;
                                            let apiFlow = '';
                                            if (apih5FlowStatus === '') {
                                                apiFlow = '99';
                                            } else {
                                            ...
                                            obj.props.dispatch(
                                                push(`${mainModule}CashFlowStatementDetail/${cashId}/${apiFlow}/${0}`)
                                            )
                                        },
                                    }
                                ]
                            ...
                            if (obj.selectedRows.length>0) {
                                ...
                                if (apih5FlowStatusArry.length>0) {
                                    ...
                                    confirm({
                                        ...
                                        cancelText: "取消",
                                        onOk: () => {
                                            myFetch('batchDeleteUpdateZjTzCash',obj.selectedRows).then(
                                                ({ success,message }) => {
                                                    if (success) {
                                                        Msg.success(message);
                                                        this.table.refresh();
