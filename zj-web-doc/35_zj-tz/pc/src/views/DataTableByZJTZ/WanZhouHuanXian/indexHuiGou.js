...
import s from './styleHuiGou.less';
...
class index extends Component {
    ...
    Middle() {//中间6个饼图
        ...
        this.props.myFetch('getHgPageHgStatus', {
            projectId: projectId,
            ...
            <div className={s.root}>
                ...
                <div className={s.left}>
                    ...
                    <div className={s.leftMiddle} style={leftMiddle}>
                        ...
                        <div className={s.dangqianshiqi}>
                            <YiBiaoPan {...this.props} clickRouter={'HuiGou'} />
                        </div>
                    </div>
                    {/* 预警 */}
                ...
                <div className={s.right}>
                    ...
                    <div className={s.rightMiddle} style={rightMiddle}>
                        <div className={s.rightMiddleTop}>
                            {pieMiddleData?.length ? <CenterPIETop {...this.props} type={'huigou'} pieMiddleData={pieMiddleData} /> : null}
                        </div>
                        <div className={s.rightMiddleBottom}>
                            {pieMiddleData?.length ? <CenterPIEBottom {...this.props} type={'huigou'} pieMiddleData={pieMiddleData} /> : null}
                        </div>
                    </div>
                ...
                <div className={s.last}>
                    ...
                    <div className={s.lastBottom} style={lastBottom}>
                        <QuShi {...this.props} clickRoter={'huigou'} />
                    </div>
                </div>
            </div>
        );
