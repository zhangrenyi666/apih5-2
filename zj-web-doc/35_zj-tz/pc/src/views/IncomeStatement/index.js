                                ...
                                btns: [
                                    {
                                        ...
                                        onClick: (obj) => {
                                            ...
                                            const { profitId,apih5FlowStatus } = obj.rowData;
                                            let apiFlow = '';
                                            if (apih5FlowStatus === '') {
                                                apiFlow = '99';
                                            } else {
                                            ...
                                            obj.props.dispatch(
                                                push(`${mainModule}IncomeStatementDetail/${profitId}/${apiFlow}/${0}`)
                                            )
                                        },
                                    }
                                ]
                            ...
                            if (obj.selectedRows.length>0) {
                                ...
                                if (apih5FlowStatusArry.length>0) {
                                    ...
                                    confirm({
                                        ...
                                        cancelText: "取消",
                                        onOk: () => {
                                            myFetch('batchDeleteUpdateZjTzProfit',obj.selectedRows).then(
                                                ({ success,message }) => {
                                                    if (success) {
                                                        Msg.success(message);
                                                        this.table.refresh();
