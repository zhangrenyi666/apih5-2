                            ...
                            if (obj.selectedRows.length > 0) {
                                ...
                                if (aa.length > 0) {
                                    ...
                                    confirm({
                                        ...
                                        cancelText: "取消",
                                        onOk: () => {
                                            myFetch('batchDeleteReleaseZjTzImportDoc',obj.selectedRows).then(
                                                ({ success,message }) => {
                                                    if (success) {
                                                        Msg.success(message);
                                                        this.table.refresh();
                            ...
                            if (obj.selectedRows.length > 0) {
                                ...
                                if (aa.length > 0) {
                                    ...
                                    confirm({
                                        ...
                                        cancelText: "取消",
                                        onOk: () => {
                                            myFetch('batchDeleteRecallZjTzImportDoc',obj.selectedRows).then(
                                                ({ success,message }) => {
                                                    if (success) {
                                                        Msg.success(message);
                                                        this.table.refresh();
                                ...
                                if ((obj.selectedRows.length === 1)) {
                                    if (obj.selectedRows[0].releaseId === '1') {
                                        ...
                                        confirm({
                                            ...
                                            cancelText: "取消",
                                            onOk: () => {
                                                this.props.myFetch('toHomeShowZjTzImportDoc', obj.selectedRows[0]).then(
                            ...
                            if (obj.selectedRows.length > 0) { 
                                ...
                                if (aa.length>0) {
                                    ...
                                    confirm({
                                        ...
                                        cancelText: "取消",
                                        onOk: () => {
                                            myFetch('batchDeleteUpdateZjTzImportDoc',obj.selectedRows).then(
                                                ({ success,message }) => {
                                                    if (success) {
                                                        Msg.success(message);
                                                        this.table.refresh();
                        ...
                        filestExport:  (obj) => {
                            ...
                            if (obj.selectedRows.length > 0) {
                                confirm({
                                    ...
                                    cancelText: "取消",
                                    onOk: () => {
                                        myFetch('batchExportZjTzImportDocFile', obj.selectedRows).then(
                                            ({ success, message,data }) => {
                                                if (success) {
                                                    Msg.success(message);
