...
if (browserMatch && "chrome" === browserMatch.browser) {
    var img;
    img = new Image();
...
var ntkoBrowser = {
        ...
        if ('/' !== strURL.charAt(0)) {
            ...
            if (("http://" === strLowser.substr(0,7)) || ("https://" === strLowser.substr(0,8))) { }
                ...
                if (strURL.indexOf("../") === -1) {
                    ...
                    let varLength = pathName.lastIndexOf("/");
    ...
    openWindow: function (strURL,IsShowOnExtendMonitor,ProductCaption,ntkoBrowserProductKey,ntkoBrowserNoExpireKey,ntkoBrowserOptions) {
        ...
        if (window.top !== window.self) {
            ...
            let winend = winTopHref.length;
            let wint = winTopHref.substring(winend - 1,winend);
            if (wint.indexOf("#") === -1) {
            } else {
