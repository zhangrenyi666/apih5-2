...
export default props => {
  ...
  let commProps = {
    ...
    ...antdProps,
    ...formItemLayout,
    className: isMobile ? (disabled ? 'disabled mobileItem' : 'mobileItem') : '',
    style: {
      ..._style
    }
  };
    ...
    case "textarea":
      ...
      return (
        ...
        <FormItem {...commProps}>
          ...
          })(<Input.TextArea autosize={{ minRows: 3, maxRows: 8 }}{...inputProps} />)}
        </FormItem>
      );
    case "number":
    case "integer":
    ...
    case "time":
      if (isMobile) {  
        ...
        if (type === 'datetime') {
          ...
          return <div>暂不支持该格式：{type}。支持格式有：date、time、datetime</div>
        }
