...
class index extends PureComponent {
    ...
    render() {
        ...
        return (
            <div className={s.QnnForm} style={this.props.style}>
                <Form>
                    {
                        <Row gutter={24}>
                            {
                                formConfig.map((item, index) => {
                                    if (item.hide) {
                                        ...
                                        return <Col className={item.type === 'Component' ? 'ComponentCol' : ''} key={index} span={item.span || '24'} >
                    ...
                    }
                    {
                        btns.length > 0 ? <Row gutter={24}>
                            <FormItem {...this.tailFormItemLayout}>
                                {this.isMobile() ? <div className={s.btnCon}>
                                    {btnsDom}
                                </div> : btnsDom}
                            </FormItem>
                        </Row>
