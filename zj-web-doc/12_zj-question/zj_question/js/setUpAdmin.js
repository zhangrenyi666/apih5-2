...
var pager = $("#pager").page({
    remote: {// ajax请求配置
        url: l.getApiUrl("getZjXmQuestionSetupMemberList"),
        params: {
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onAdd: function (obj, _params) {
        l.ajax('addZjXmQuestionSetupMember', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    }
        ...
        case "del":
            if (checkedData.length == 0) {
                ...
                layer.confirm("确定删除？", { icon: 0, }, function (index) {
                    l.ajax("batchDeleteUpdateZjXmQuestionSetupMember", checkedData, function () {
                        pager.page('remote')
                    })
                    layer.close(index);
                });
