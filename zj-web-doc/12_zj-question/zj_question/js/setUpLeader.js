...
var pager = $("#pager").page({
    remote: {// ajax请求配置
        url: l.getApiUrl("getZjXmQuestionOfficeLeaderList"),
        params: {
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onAdd: function (obj, _params) {
        l.ajax('addZjXmQuestionOfficeLeaderByPc', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    }
        ...
        case "del":
            if (checkedData.length == 0) {
                ...
                layer.confirm("确定删除？", { icon: 3, }, function (index) {
                    l.ajax("batchDeleteUpdateZjXmQuestionOfficeLeader", checkedData, function () {
                        pager.page('remote')
                    })
                    layer.close(index);
                });
