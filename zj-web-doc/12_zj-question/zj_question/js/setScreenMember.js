...
var pager = $("#pager").page({
    remote: {// ajax请求配置
        url: l.getApiUrl("getZjXmQuestionScreenMemberList"),
        params: {
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onSave: function (obj, _params) {
        l.ajax('updateZjXmQuestionScreenMember', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    },
    onAdd: function (obj, _params) {
        l.ajax('addZjXmQuestionScreenMember', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    }
        ...
        case "del":
            if (checkedData.length == 0) {
                ...
                layer.confirm("确定删除？", { icon: 0, }, function (index) {
                    l.ajax("batchDeleteUpdateZjXmQuestionScreenMember", checkedData, function () {
                        pager.page('remote')
                    })
                    layer.close(index);
                });
