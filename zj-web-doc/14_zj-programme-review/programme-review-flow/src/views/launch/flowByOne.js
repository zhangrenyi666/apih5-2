...
let config = {
    ...
    workFlowConfig: {
        ...
        formLink: {
            zjProLaunchFlowByOne: "FlowByzjPartyFeeUse"
                ...
                <Form
                    ...
                    formConfig={[
                        ...
                        },
                        {
                            ...
                            hide: true,
                            // hide: nodeName === '事业部技术部负责人' || nodeName === '事业部施工部负责人' || nodeName === '公司专家（三位）' || nodeName === '总承包部（如果有）' ? false : true
                        },
                        {
                            type: "textarea",
                            label: "事业部技术部负责人审查意见",
                        ...
                        // },
                        {
                            ...
                            field: "opinionField4",
                            placeholder: "请输入", //占位符
                            // required: nodeName === '公司专家（三位）',
                            help: "（主要审查方案的技术性、图纸、计算书、工艺工法的实用性等）",
                            addShow: false,
                            opinionField: true,
                            formItemLayout: {
                                labelCol: {
