...
import detailByFlowOne from "../launch/detailByFlowOneAddHistory";
import detailByFlowTwo from "../launch/detailByFlowTwoAddHistory";
import detailByFlowThree from "../launch/detailByFlowThreeAddHistory";
import moment from 'moment';
const zjPrReviewStatePage = {//珠海大屏项目进度数据
	...
	actionBtns: [
		{
			...
			onClick: (obj) => {
				let userId;
				let flowCreatTimeStart;
				let flowCreatTimeEnd;
				let startTime;
				let endTime;
				let adoptStartTime;
				let adoptEndTime;
				let programmingScore;
				let programmingScoreTo;
				let compilingSubject;
				let reviewState;
				let schemeType;
				let projectClass;
				let projectName;
				let schemeLevel;
				let schemeNumber;
				// moment(obj.props.form.getFieldsValue().search__flowCreatTimeArr[0]._d).valueOf();
				// console.log(obj.props.form.getFieldsValue().search__flowCreatTimeArr);
				// console.log(new Date(obj.props.form.getFieldsValue().search__flowCreatTimeArr[1]._d).valueOf());
				// return;
				...
				// if (obj.props.form.getFieldsValue().search__implementationTime) {
					// implementationTime = new Date(obj.props.form.getFieldsValue().search__implementationTime._d).valueOf();
					// console.log(implementationTime);
					...
					// 	+ "&schemeLevel=" + schemeLevel + "&schemeNumber=" + schemeNumber + "&implementationTime=" + implementationTime;
					window.location.href = "http://weixin.fheb.cn:91/ureport/excel?_u=file:schemeReviewList.ureport.xml&url=http://weixin.fheb.cn:98/apifangan/&userKey=" + userId
						+ "&compilingSubject=" + compilingSubject + "&reviewState=" + reviewState + "&schemeType=" + schemeType + "&projectClass=" + projectClass + "&projectName=" + projectName
				...
				// } else {
					// console.log("http://weixin.fheb.cn:91/ureport/excel?_u=file:schemeReviewList.ureport.xml&url=http://test.apih5.com:9091/web/&userKey=" + userId
					// +"&compilingSubject=" + compilingSubject+"&reviewState=" + reviewState+"&schemeType=" + schemeType+"&projectClass=" + projectClass+"&projectName=" + projectName
					// +"&schemeLevel=" + schemeLevel+"&schemeNumber=" + schemeNumber);
					// window.location.href = "http://weixin.fheb.cn:91/ureport/excel?_u=file:schemeReviewList.ureport.xml&url=http://weixin.fheb.cn:98/apifangan/&userKey=" + userId
					// 	+ "&compilingSubject=" + compilingSubject + "&reviewState=" + reviewState + "&schemeType=" + schemeType + "&projectClass=" + projectClass + "&projectName=" + projectName
					// 	+ "&schemeLevel=" + schemeLevel + "&schemeNumber=" + schemeNumber;
					// window.location.href = "http://weixin.fheb.cn:91/ureport/excel?_u=file:schemeReviewList.ureport.xml&url=http://weixin.fheb.cn:98/apifangan/&userKey=" + userId
