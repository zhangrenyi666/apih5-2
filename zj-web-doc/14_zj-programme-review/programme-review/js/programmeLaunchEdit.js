...
var detailForm = $('#detailForm').detailLayer({
    ...
    onSave: function (obj, _params) {
        if (launchId) {
            ...
            l.ajax("updateZjPrProgrammeLaunch", _params, function (data, message, success) {
                if (success) {
            ...
            l.ajax("addZjPrProgrammeLaunch", _params, function (data, message, success) {
                if (success) {
