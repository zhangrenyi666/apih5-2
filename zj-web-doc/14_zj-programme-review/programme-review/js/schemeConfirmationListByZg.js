    ...
    "columnDefs": [//表格列配置
        ...
        },
        {
            ...
            "render": function (data, index, row) {
                var a;
                if (data) {
                    a = '<a style="color:blue;"  onclick="myOpen(\'方案等级确认\',\'' + data.recordid + '\',\'' + 'schemeConfirmationDetailByZg' + '\')" href="javascript:void(0);">' + data.projectName + '</a>'
                }
                return a;
            }
        },
        {
            "targets": [4],//第几列
            "data": "chiefEngineerExamineType",//接口对应字段
            "title": "处理状态",//表头名
            "defaultContent": "-",//默认显示
    ...
    switch (name) {
        case "approve":
            if (checkedData.length == 1) {
                myOpen('方案等级确认', checkedData[0].recordid, 'schemeConfirmationDetailByZg')
