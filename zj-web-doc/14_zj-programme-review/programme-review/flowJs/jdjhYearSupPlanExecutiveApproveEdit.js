			             ...
			             },						 
			             {
			            	 ...
			            	 "render": function (data) {
			            		 ...
			            		 for (var i = 0; i < data.length; i++) {
			            			 ...
			            			 dom += '<a style="width:80px;"  href="' + fileUrl + '">' + fileName + '</a>'; 
			            			 dom += '</li>'; 
			            		 } 
			            		 return dom;
			            	 }
			            	 ...
			            	 render: function(data, index, row) {
			            		 ...
			            		 html += '<span class="dropDown">'
			            			 if(row.replyFlag == '2'){
			            				 ...
			            				 html += "<a style=\"color:blue;\"  onclick=\"myOpen1('详情','" + data.yearSupMatterId + '\',\'' + 'reply' + '\',\'' + row.rowIndex + '\',\'' + data.yearSupPlanId + '\')"  href="javascript:void(0);">' + '完成情况填写' + "</a>";
			            			 }			            			
			            		 html += '</span>'	
			            			 return html;
			            	 }          	
...
if (launchId) {
	l.ajax("getZjJdjhSupPlanExecutiveDetail", { supPlanExecutiveConditionId: launchId }, function(
			data,
			message,
			success
	) {
		if (success) {
			...
			.prepend(
					$(
							'<div class="row cl"><label class="form-label col-2 f-l"><i style="color:red;">* </i>监督责任部门：</label><div class="col-4 f-l"><input disabled="true" type="text" class="input-text SearchSelect" onfocus="SearchSelect({ apiName: \'getZjJdjhYearSupPlanState2List\', otherKey: \'projectState\' })" value="' +
							data.supDutyDepName +
	...
	.prepend(
			$(
					'<div class="row cl"><label class="form-label col-2 f-l"><i style="color:red;">* </i>监督责任部门：</label><div class="col-4 f-l"><input  disabled="true" type="text" class="input-text SearchSelect" onfocus="SearchSelect({ apiName: \'getZjJdjhYearSupPlanState2List\', otherKey: \'projectState\' })" value="" name="supDutyDepName"></div></div>'
			)
	);
	detailForm.setOpenData({ memberList: { oaMemberList: [] } });
} 
