var apiNames = {  	
	...
	getManufacturerSelectAllList:"getManufacturerSelectAllList",
	  ...
	  getzjPrProgrammeLaunchDetail: "getzjPrProgrammeLaunchDetail", //执行情况汇总统计查详情
  getZjSchemeDetailedListSelectAllList: "getZjSchemeDetailedListSelectAllList", //执行情况汇总统计查详情
  getZjSchemeConfirmationListBySelect: "getZjSchemeConfirmationListBySelect", //执行情况汇总统计查详情	
  getZjPrProgrammeLaunchFlowList: "getZjPrProgrammeLaunchFlowList", //执行情况汇总统计查详情	
  addZjPrProgrammeLaunchFlow: "addZjPrProgrammeLaunchFlow", //执行情况汇总统计查详情	
  updateZjPrProgrammeLaunchFlow: "updateZjPrProgrammeLaunchFlow", //执行情况汇总统计查详情	
  batchDeleteUpdateZjPrProgrammeLaunchFlow: "batchDeleteUpdateZjPrProgrammeLaunchFlow", //执行情况汇总统计查详情	
	
	
	addCheckByFlow:"addCheckByFlow",//验收新增
	//updateZcztdm:"updateZcztdm",//修改资产状态的接口==
	...
	addFlowAssetsInLaunch:"addFlowAssetsInLaunch",//购置申请  --发起-- 时调用该接口===走自己的inset不要流程的insert===0718
	updateFlowAssetsAfterSubmit:"updateFlowAssetsAfterSubmit",//购置申请--发起-提交-- 时调用该接口===传workID或sszcid 都可以== 更新资产管理表的flow_status 由0待提交变成1审核中==0718
	updateZjHwzcZCGLApih5FlowStatus:"updateZjHwzcZCGLApih5FlowStatus",//发起页面调用的接口----只是更改流程状态---0121
	getDetailByWorkId:"getFlowAssetsDetailsByWorkId",//购置申请---查看待办、已办的详情===传workID=======根据workId查询资产详情==0718	
	
	
	addFlowCheckAndUpdateAssetsBySszcid:"addFlowCheckAndUpdateAssetsBySszcid",//验收申请--- 发起时---调用该接口===传Sszcid==更新管理表===验收表insert====0719
	updateFlowCheckAfterSubmit:"updateFlowCheckAfterSubmit",//验收申请--发起-提交-- 时调用该接口===传workID或sszcid 都可以== 更新验收表的flow_status 由0待提交变成1审核中==0719	
	updateZjHwzcZCYSApih5FlowStatus:"updateZjHwzcZCYSApih5FlowStatus",//
	getFlowCheckDetailBySszcid:"getFlowCheckDetailBySszcid",//验收申请---查看待办、已办的详情===传workID=========关联查询====0719
		
	
	addFlowTranAndUpdateAssetsBySszcid:"addFlowTranAndUpdateAssetsBySszcid",//调拨申请--- 发起时---调用该接口===传Sszcid==更新管理表-资产状态代码变成6调拨中===调拨表insert====0719
    updateFlowTranAfterSubmit:"updateFlowTranAfterSubmit",//调拨申请--发起-提交-- 时调用该接口===传workID或sszcid 都可以== 更新调拨表的flow_status 由0待提交变成1审核中==0719	
	getFlowTranDetailBySszcid:"getFlowTranDetailBySszcid",//调拨申请==待办、已办查详情接口====传sszcid ==关联查询
	
	addFlowScrapAndUpdateAssetsBySszcid:"addFlowScrapAndUpdateAssetsBySszcid",//报废申请--- 发起时---调用该接口===传Sszcid==更新管理表资产状态代码为 7 报废中 ===报废表insert====0719
	updateFlowScrapAfterSubmit:"updateFlowScrapAfterSubmit",//报废申请--发起-提交-- 时调用该接口===传workID或sszcid 都可以== 更新报废表的flow_status 由0待提交变成1审核中==0719
	getFlowScrapDetailBySszcid:"getFlowScrapDetailBySszcid",//报废申请---查看待办、已办的详情===传workID=========关联查询====0719
	
	
	
	
	//报废、调拨申请发起后和审批同意结束后 都调用
	...
	getHwAssetsFlowTitle:"getHwAssetsFlowTitle",//
