...
var pager = $("#pager").page({
	remote: {//ajax请求配置
		url: l.getApiUrl("getWeChatDiscountList"),
		params: { },
    ...
    switch (name) {
        case "derive"://导出
            if (checkedData.length == 0) {
                ...
                window.location.href = 'http://wechat.zjyjhw.com:88/ureport/excel?_u=file:zjHwzcZczj.xml&url=' + l.domain + '&recordid=' + checkedData[0].recordid;
