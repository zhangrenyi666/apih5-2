...
var _body = {
	...
	workId: workId,
	flowId: flowId,
	apiName: "getZjHwzcZcbfReportDetails",
								...
								callback: function (dataName, obj) {
									switch (dataName) {
										case "export"://导出
											...
											window.location.href = 'http://192.168.1.223:89/ureport/preview?_u=file:zjXmzcZcbfReport.xml&url=' + l.domain + '&workId=' + params.workId;
											break;
										case "cancel":
											obj.close();
											break;
