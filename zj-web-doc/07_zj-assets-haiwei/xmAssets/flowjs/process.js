    ...
    if (_s) {
        loadFlow(_d.flowButtons, {
            otherBody: {
                ...
                apiName: "updateZjHwzcZcglForUpdate"
            },
            submitFn: function () {
                ...
                $.each(workFormJson.tabs, function (i, tabItem) {
                    ...
                    //操作历史end
                        ...
                        if (tabItem.isMain) {
                            ...
                            if (_d.flowNode != null) {
                                if (_d.flowNode.nodeName == "主管部门经办" || _d.flowNode.nodeName == "申请人") {
                                    btns.push({
                                        name: "export",
                                        label: "导出"
                                    })
                                ...
                                callback: function (dataName, obj) {
                                    switch (dataName) {
                                        case "export"://导出
                                            ...
                                            window.location.href = 'http://192.168.1.223:89/ureport/preview?_u=file:zjXmzcZcgl.xml&url=' + l.domain + '&workId=' + params.workId;
                                            break;
                                        case "cancel":
                                            obj.close();
                                            break;
