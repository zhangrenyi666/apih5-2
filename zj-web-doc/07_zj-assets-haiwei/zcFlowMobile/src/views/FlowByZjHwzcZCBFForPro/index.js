...
const flowConfig = {
  //流程专属配置
   workFlowConfig: {
    ...
    //待办已办切换路由
    todo: "todoByprojectScrap",
    hasTodo: "hasTodoByprojectScrap"
  ...
  fetchConfig: {
    apiName: props => {
      ...
      if (url === `${myPublic}FlowByZjHwzcZCBFForProAwait`) {
        //待办
        return "getTodoList";
      } else {
        //已办
  ...
  actionBtns: [
    {
      name: "Component",
      Component: FlowFormByZjHwzcZCBFForPro,
      icon: "plus",
      type: "primary",
      label: "海威资产项目报废"
    }
  ...
  formConfig: [
    {
      ...
      table: {
        ...
        Component: {
          flowId: {
			projectScrap:FlowFormByZjHwzcZCBFForPro
          }
        }
      }
    },
