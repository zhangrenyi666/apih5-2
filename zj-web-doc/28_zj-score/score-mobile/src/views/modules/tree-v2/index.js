            ...
            <div onContextMenu={(e) => e.preventDefault()} className={s.SortableTreeContainer}>
                {treeData && treeData.length ? (
                    ...
                    <SortableTree
                        ...
                        onMoveNode={(e) => {
                            ...
                            if (this.props.onDrop) {
                                let { nextParentNode,treeIndex,treeData } = e;
                                ...
                                this.props.onDrop({
                                    ...
                                    allDatas: [...treeData],
                                    //移动后的节点的后一个兄弟节点
                                    afterNode: _nextParentNodeChildren[treeIndex + 1] ? _nextParentNodeChildren[treeIndex + 1][this.keys.value] : null,
                                    //移动后的节点的前一个兄弟节点
                                    beforeNode: _nextParentNodeChildren[treeIndex - 1] ? _nextParentNodeChildren[treeIndex - 1][this.keys.value] : null,
                                    //移动后的节点的父节点
                                    parentNode: nextParentNode && nextParentNode[this.keys.value],
                                    //移动的节点
                    ...
                    />
                        ...
                        <div className={s.noData}>{loading ? null : '暂无数据，右键新增一个吧！'}</div>
                    )}
            </div>
        );
