window.configs = {
    ...
    appInfo: {
        ...
        copyright: "信息化系统打分列表",
        name: "zjScore",
        loginType: "3", // 1:普通账号密码；2：手机验证码快捷登录；3:企业号授权（也可以在app登录）；4:服务号授权；5、扫码登录  6、app登录  31、会弹出授权窗口的授权
        //code登录方式 给后台的 loginType token错误或者网址为携带code将跳转到提示页面
        // webCodeLoginType:"6",
        mainModule: "/zjScoreMoblie/",
        helpHref: ""
    },
    ...
    apis: {
        ...
        getZjScoreCompanyDetailListByAuditor:"getZjScoreCompanyDetailListByAuditor",
        batchUpdateZjScoreCompanyDetail:"batchUpdateZjScoreCompanyDetail"
    }
};
