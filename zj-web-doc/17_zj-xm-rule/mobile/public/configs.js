...
window.configs = {
    ...
    //不配置这个地址将不会发送bug到服务器
    bugDomain: "http://test.apih5.com:9090/web/addZxWtQuestionByWeb",
    //是否开启登录 验证码 默认true
    ...
    apis: {
        ...
        getZjXmOaDepartmentListForWeChat:"getZjXmOaDepartmentListForWeChat",//部门列表
        getRulesListByObjectUserKeyForWeChat:"getRulesListByObjectUserKeyForWeChat", //制度列表
        getTwoLinkAllList:"getTwoLinkAllList",//发文部门
        getZjXmRulesDetail:"getZjXmRulesDetail", //制度详情
        getZjXmReferenceNumberList:"getZjXmReferenceNumberList" //分制度查询
    }
};
