    ...
    "columnDefs": [//表格列配置
        ...
        },
		{
            ...
            "render": function (data) {
                ...
                html += '<li><a href="javascript:void(0);" onclick="myOpen(\'下发部门文号\',\'' + data.recordId + '\',\'' + data.referenceNumberName + '\',\'' + 'twoReferenceNumberList' + '\')">下发部门文号</a></li>';
                html += '</ul></span>'
                return html;
            }
        }
    ...
    conditions: [//表单项配置
        {
            ...
            name: "referenceNumberName",//输入字段名
            label: "局文号名称",//输入字段对杨的中文名称
            placeholder: "请输入局文号名称",
        }
    ],
...
var pager = $("#pager").page({
    remote: {//ajax请求配置
        url: l.getApiUrl("getZjXmReferenceNumberList"),
        params: {
            meetingRoomTypeName: "",
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onAdd: function (obj, _params) {     
            l.ajax('addZjXmReferenceNumber', _params, function (data) {
                pager.page('remote')
                obj.close()
            })
    }
