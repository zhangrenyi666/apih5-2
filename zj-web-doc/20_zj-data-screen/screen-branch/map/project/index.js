$(function () {
    ...
    var refresh = function () {
        ...
        //第一块的数据
        getData.getProjectOneBlankData('getProjectDetailedInformationList', { orgName: global.orgName }, function (data) {
            indexFn.renderProjectOneBlankData(data);
        })
        //第二块的数据
        getData.getDataIndexData(render.ins['dataIndex'], 'getProjectOperatingIndicatorsList', { orgName: global.orgName });
        // for (var i = 0; i < quanIdArr.length; i++) {
        //     var _id = quanIdArr[i];
        ...
        //     getPoint(data[index]);
        // })
        getData.getMonthTrendDiagramData('getMonthlyTrendList',{ orgName: global.orgName }, function (data) {//月趋势图
        ...
        }, 'getProjectResourceAllocation', { orgName: global.orgName });
