...
var pager = $("#pager").page({
    remote: {// ajax请求配置
        url: l.getApiUrl("getZjInvestmentOaMemberList"),
        params: {
        },
...
var detailLayer = $('#detailLayer').detailLayer({
    ...
    onSave: function (obj, _params) {
        l.ajax('updateZjInvestmentOaMember', _params, function (data) {
            pager.page('remote')
            obj.close()
        })
    },
    onAdd: function (obj, _params) {
        l.ajax('addZjInvestmentOaMember', _params, function (data) {
                pager.page('remote')
                obj.close()
            })
    }
    ...
    switch (name) {
        ...
        case "del":
            if (checkedData.length == 0) {
				...
				l.ajax("batchDeleteZjInvestmentOaMember", checkedData, function () {
					pager.page('remote')
				})
				layer.close(index);
            });
