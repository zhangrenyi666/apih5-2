$(function () {
        ...
        addMarker: function (point) {
            ...
            marker.addEventListener("mouseover", function (e) {
                ...
                geoc.getLocation(pt, function (rs) {
                    ...
                    window.getData.getMarkerProjectList('getProjectListByCityName', { cityName: city }, function (data) {
    ...
    var refresh = function () {
        ...
        //echarts数据
        getData.getDataIndexData(render.ins['dataIndex'], 'getProvinceOperatingIndicatorsList', { provinceName: global.province });
        for (var i = 0; i < quanIdArr.length; i++) {
            var _id = quanIdArr[i];
        ...
        //地图标注
        getData.getMarkData('getProvinceMap', { provinceName: global.province }, function (data) {
        ...
        }, 'getProvinceResourceAllocation', { provinceName: global.province });
