    ...
    render() {
        ...
        return (
            <div className={styles["lny-filterBox"]}>
                <div className={curValue ?`${styles["lny-filter"]} ${styles["cur"]}`:`${styles["lny-filter"]}`} style={{ position: fixed ? "fixed" : "relative" }}>
                    {
                        data.map((item, index) =>
                            <div
                                key={index}
                                className={curValue === item["value"] ? `${styles['lny-filter-btn']} ${styles['cur']}` : ((value === item["value"]) ? `${styles['lny-filter-btn']} ${styles['on']}` : `${styles['lny-filter-btn']}`)}
...
class FilterDialog extends Component {
    ...
    render() {
        ...
        return (
            <div className={show ? `${styles['lny-filter-dialog']} ${styles['show']}` : `${styles['lny-filter-dialog']}`}>
