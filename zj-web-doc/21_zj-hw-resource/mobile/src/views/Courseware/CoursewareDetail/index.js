...
const config = {
    fetchConfig: {
        apiName: "getZjHwZyResourceCoursewareDetail",
        params: {
    ...
    formConfig: [
        ...
        },
        {
            type: "select",
            label: "类别",
            field: "coursewareClass", //唯一的字段名 ***必传
        ...
        },
        {
            type: "string",
            label: "名称",
            field: "coursewareName", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
            type: "string",
            label: "关键词",
            field: "coursewareKeyword", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
            type: "string",
            label: "管理部门",
            field: "coursewareDepName", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
            type: 'files',
            label: '附件',
            field: 'coursewareFileList', //唯一的字段名 ***必传
            disabled: true,
            fetchConfig: {
