...
const config = {
    fetchConfig: {
        apiName: "getZjHwZyResourcePriceTempDetail",
        params: {
            tempPriceId: "tempPriceId",
        },
    },
    formConfig: [
        {
        ...
        },
        {
            type: "string",
            label: "合同额",
            field: "contractAmount", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
