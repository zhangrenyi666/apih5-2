...
const config = {
    fetchConfig: {
        apiName: "getZjHwZyResourceOrganizationDetail",
        params: {
    ...
    formConfig: [
        {
            type: "string",
            label: "主键ID",
            field: "organizationId", //唯一的字段名 ***必传
        ...
        },
        {
            type: "select",
            label: "类别",
            field: "organizationClass", //唯一的字段名 ***必传
        ...
        },
        {
            type: "string",
            label: "供应商",
            field: "fullSupplierName", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
            type: "string",
            label: "提供产品",
            field: "supplyProducts", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
            type: "string",
            label: "管理部门",
            field: "organizationDepName", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
            type: "string",
            label: "业务特长",
            field: "supplierBusinessExpertise", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
            type: "string",
            label: "产品情况",
            field: "productConditions", //唯一的字段名 ***必传
            placeholder:'无',
            disabled: true
        },
        {
        ...
        },
        {
            type: 'files',
            label: '附件',
            field: 'organizationFileList', //唯一的字段名 ***必传
            disabled: true,
            fetchConfig: {
