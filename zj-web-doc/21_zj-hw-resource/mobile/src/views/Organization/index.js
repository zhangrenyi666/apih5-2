            ...
            <div className={s.root}>
                ...
                >
                    <MyList
                        ...
                        fetchConfig={{
                            apiName: 'getZjHwZyResourceOrganizationList', //后台api
                        }}
                        Item={props => {
                            //列表模板 props里有所有数据
                            ...
                            const item = rowData;
                            const index = rowID;
                            if(item.organizationClass === '0'){
                                item.organizationClass = "评价评估机构";
                            }else if(item.organizationClass === '1'){
                                item.organizationClass = "服务机构";
                            }else if(item.organizationClass === '2'){
                                item.organizationClass = "金融机构";
                            }else{
                            ...
                            return (
                                ...
                                >
                                    <div className={s.top}>
                                         <div className={s.topl}>{item.organizationDepName}</div>
										  <div className={s.topr}>{item.organizationClass}</div>
                                    </div>
                                    <Divider style={{ margin: "8px 0px",backgroundColor:'#1890ff' }} />
                                    <div style={{ paddingLeft: '3%' }}>
                                        名称:{item.fullSupplierName}
                                    </div>
