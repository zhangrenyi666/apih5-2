...
public class ZjLzehProduceTaskPlanItem extends BasePojo {
    // 主键
    private String zjLzehProduceTaskPlanItemId;
    ...
    public String getZjLzehProduceTaskPlanItemId() {
        return zjLzehProduceTaskPlanItemId == null ? "" : zjLzehProduceTaskPlanItemId.trim();
    }

    public void setZjLzehProduceTaskPlanItemId(String zjLzehProduceTaskPlanItemId) {
        this.zjLzehProduceTaskPlanItemId = zjLzehProduceTaskPlanItemId == null ? null : zjLzehProduceTaskPlanItemId.trim();
    }
