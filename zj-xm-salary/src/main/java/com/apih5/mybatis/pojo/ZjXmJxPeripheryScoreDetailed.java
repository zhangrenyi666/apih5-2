...
public class ZjXmJxPeripheryScoreDetailed extends BasePojo {
	...
	// 周边考核列标题
	private List<ZjXmJxPeripheryScoreDetailed> columnTitleList;

	public List<ZjXmJxPeripheryScoreDetailed> getColumnTitleList() {
		return columnTitleList;
	}

	public void setColumnTitleList(List<ZjXmJxPeripheryScoreDetailed> columnTitleList) {
	...
	public String getScoringType() {
		return scoringType == null ? "" : scoringType.trim();
	}
