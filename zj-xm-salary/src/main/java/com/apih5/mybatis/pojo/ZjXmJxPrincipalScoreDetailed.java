...
public class ZjXmJxPrincipalScoreDetailed extends BasePojo {
	...
	public String getSecretaryScore() {
		return secretaryScore;
	}

	public void setSecretaryScore(String secretaryScore) {
	...
	public void setManagerScore(String managerScore) {
