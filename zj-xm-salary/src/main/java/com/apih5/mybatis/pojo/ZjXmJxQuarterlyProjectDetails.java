...
public class ZjXmJxQuarterlyProjectDetails extends BasePojo {
	// 主键ID
	...
	// 业务扩展字段
	// 集合
	private List<ZjXmJxQuarterlyProjectDetails> projectDetailsList;

	public List<ZjXmJxQuarterlyProjectDetails> getProjectDetailsList() {
		return projectDetailsList;
	}

	public void setProjectDetailsList(List<ZjXmJxQuarterlyProjectDetails> projectDetailsList) {
