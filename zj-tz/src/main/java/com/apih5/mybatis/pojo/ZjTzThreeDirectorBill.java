...
public class ZjTzThreeDirectorBill extends BasePojo {
    private String threeDirectorBillId;
    ...
    public String getThreeDirectorBillId() {
        return threeDirectorBillId == null ? "" : threeDirectorBillId.trim();
    }

    public void setThreeDirectorBillId(String threeDirectorBillId) {
        this.threeDirectorBillId = threeDirectorBillId == null ? null : threeDirectorBillId.trim();
    }
