...
public class ZjTzThreeShareholderBill extends BasePojo {
    private String threeShareholderBillId;

    private String threeShareholderId;
    ...
    public String getThreeShareholderBillId() {
        return threeShareholderBillId == null ? "" : threeShareholderBillId.trim();
    }

    public void setThreeShareholderBillId(String threeShareholderBillId) {
        this.threeShareholderBillId = threeShareholderBillId == null ? null : threeShareholderBillId.trim();
    }

    public String getThreeShareholderId() {
        return threeShareholderId == null ? "" : threeShareholderId.trim();
    }

    public void setThreeShareholderId(String threeShareholderId) {
        this.threeShareholderId = threeShareholderId == null ? null : threeShareholderId.trim();
    }
