...
public class ZjTzThreeSupervisor extends BasePojo {
    ...
    private List<ZjTzThreeSupervisorBill> billList;
    ...
    public List<ZjTzThreeSupervisorBill> getBillList() {
        return billList;
    }

    public void setBillList(List<ZjTzThreeSupervisorBill> billList) {
