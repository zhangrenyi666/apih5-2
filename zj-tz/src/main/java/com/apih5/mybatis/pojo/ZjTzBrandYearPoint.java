...
public class ZjTzBrandYearPoint extends BasePojo {
    ...
    private ZjTzSpecialYearPoint zjTzSpecialYearPoint;
    
    private ZjTzBrandImplementPoint zjTzBrandImplementPoint;
    
    private String typeName;
    
    
    public ZjTzSpecialYearPoint getZjTzSpecialYearPoint() {
		return zjTzSpecialYearPoint;
	}

	public void setZjTzSpecialYearPoint(ZjTzSpecialYearPoint zjTzSpecialYearPoint) {
		this.zjTzSpecialYearPoint = zjTzSpecialYearPoint;
	}

	public ZjTzBrandImplementPoint getZjTzBrandImplementPoint() {
		return zjTzBrandImplementPoint;
	}

	public void setZjTzBrandImplementPoint(ZjTzBrandImplementPoint zjTzBrandImplementPoint) {
		this.zjTzBrandImplementPoint = zjTzBrandImplementPoint;
	}
