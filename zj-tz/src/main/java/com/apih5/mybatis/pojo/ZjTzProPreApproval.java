...
public class ZjTzProPreApproval extends BasePojo {
    private String proPreApprovalId;
    ...
    public String getProPreApprovalId() {
        return proPreApprovalId == null ? "" : proPreApprovalId.trim();
    }

    public void setProPreApprovalId(String proPreApprovalId) {
        this.proPreApprovalId = proPreApprovalId == null ? null : proPreApprovalId.trim();
    }
