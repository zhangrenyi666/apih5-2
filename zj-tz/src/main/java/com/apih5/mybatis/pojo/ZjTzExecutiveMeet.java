...
public class ZjTzExecutiveMeet extends BasePojo {
    ...
    private List<Date> businessDateList;
    ...
    public List<Date> getBusinessDateList() {
        return businessDateList;
    }

    public void setBusinessDateList(List<Date> businessDateList) {
        this.businessDateList = businessDateList;
    }
