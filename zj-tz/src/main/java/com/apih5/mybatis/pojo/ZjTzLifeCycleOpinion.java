...
public class ZjTzLifeCycleOpinion extends BasePojo {
    private String lifeCycleOpinionId;
    ...
    public String getLifeCycleOpinionId() {
        return lifeCycleOpinionId == null ? "" : lifeCycleOpinionId.trim();
    }

    public void setLifeCycleOpinionId(String lifeCycleOpinionId) {
        this.lifeCycleOpinionId = lifeCycleOpinionId == null ? null : lifeCycleOpinionId.trim();
    }
