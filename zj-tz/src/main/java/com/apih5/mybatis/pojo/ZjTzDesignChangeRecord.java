...
public class ZjTzDesignChangeRecord extends BasePojo {
    private String designChangeRecordId;
    ...
    public String getDesignChangeRecordId() {
        return designChangeRecordId == null ? "" : designChangeRecordId.trim();
    }

    public void setDesignChangeRecordId(String designChangeRecordId) {
        this.designChangeRecordId = designChangeRecordId == null ? null : designChangeRecordId.trim();
    }
