...
public class ZjTzCash extends BasePojoFlow{
    ...
    public String getCashId() {
        return cashId == null ? "" : cashId.trim();
    }
    ...
    public String getTotal1() {
        return total1 == null ? "" : total1.trim();
    }

    public void setTotal1(String total1) {
        this.total1 = total1 == null ? null : total1.trim();
    }

    public String getTotal2() {
        return total2 == null ? "" : total2.trim();
    }

    public void setTotal2(String total2) {
        this.total2 = total2 == null ? null : total2.trim();
    }

    public String getTotal3() {
        return total3 == null ? "" : total3.trim();
    }

    public void setTotal3(String total3) {
        this.total3 = total3 == null ? null : total3.trim();
    }

    public String getTotal4() {
        return total4 == null ? "" : total4.trim();
    }

    public void setTotal4(String total4) {
        this.total4 = total4 == null ? null : total4.trim();
    }

    public String getTotal5() {
        return total5 == null ? "" : total5.trim();
    }

    public void setTotal5(String total5) {
        this.total5 = total5 == null ? null : total5.trim();
    }

    public String getTotal6() {
        return total6 == null ? "" : total6.trim();
    }

    public void setTotal6(String total6) {
        this.total6 = total6 == null ? null : total6.trim();
    }
