...
public class ZjTzCashExcel extends BasePojo {
    private String cashExcelId;
    ...
    public String getCashExcelId() {
        return cashExcelId == null ? "" : cashExcelId.trim();
    }

    public void setCashExcelId(String cashExcelId) {
        this.cashExcelId = cashExcelId == null ? null : cashExcelId.trim();
    }
