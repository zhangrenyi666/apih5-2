...
public class ZjTzThreeShareholder extends BasePojo {
    ...
    private List<ZjTzThreeShareholderBill> billList;
    ...
    public List<ZjTzThreeShareholderBill> getBillList() {
        return billList;
    }

    public void setBillList(List<ZjTzThreeShareholderBill> billList) {
