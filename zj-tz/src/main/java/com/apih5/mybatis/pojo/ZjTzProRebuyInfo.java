...
public class ZjTzProRebuyInfo extends BasePojo {
    private String rebuyInfoId;
    ...
    public String getRebuyInfoId() {
        return rebuyInfoId == null ? "" : rebuyInfoId.trim();
    }

    public void setRebuyInfoId(String rebuyInfoId) {
        this.rebuyInfoId = rebuyInfoId == null ? null : rebuyInfoId.trim();
    }
