...
public class ZjTzPolicyCountryReply extends BasePojo {
    ...
    private List<ZjTzFile> zjTzPolicyCountryReplyFileList;

    private String replyFlag;//查看回复页面的flag
	...
	public List<ZjTzFile> getZjTzPolicyCountryReplyFileList() {
		return zjTzPolicyCountryReplyFileList;
	}

	public void setZjTzPolicyCountryReplyFileList(List<ZjTzFile> zjTzPolicyCountryReplyFileList) {
		this.zjTzPolicyCountryReplyFileList = zjTzPolicyCountryReplyFileList;
	}
