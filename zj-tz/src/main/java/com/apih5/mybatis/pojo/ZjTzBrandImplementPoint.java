...
public class ZjTzBrandImplementPoint extends BasePojo {
    private String implementPointId;
    ...
    public String getImplementPointId() {
        return implementPointId == null ? "" : implementPointId.trim();
    }

    public void setImplementPointId(String implementPointId) {
        this.implementPointId = implementPointId == null ? null : implementPointId.trim();
    }
