...
public class ZjTzRunSchemeOpinion extends BasePojo {
    private String runSchemeOpinionId;

    private String runSchemeId;
    ...
    public String getRunSchemeOpinionId() {
        return runSchemeOpinionId == null ? "" : runSchemeOpinionId.trim();
    }

    public void setRunSchemeOpinionId(String runSchemeOpinionId) {
        this.runSchemeOpinionId = runSchemeOpinionId == null ? null : runSchemeOpinionId.trim();
    }

    public String getRunSchemeId() {
        return runSchemeId == null ? "" : runSchemeId.trim();
    }

    public void setRunSchemeId(String runSchemeId) {
        this.runSchemeId = runSchemeId == null ? null : runSchemeId.trim();
    }
